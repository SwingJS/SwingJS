...
//    g.clearRect(r.x, r.y, r.width, r.height);
    ...
    // Display Axis Labels
    g.drawString("A Boltzmann Simulation",r.x+110,r.y+10);
    g.drawString("E",r.x+5,r.y+145);
    g.drawString("No. of Particles",r.x+110,r.y+286);

    Rectangle graphRec = new Rectangle(r.x+20, r.y+20, r.width - 40, r.height - 40);
    ...
    Point bottomRight = new Point(graphRec.x+graphRec.width,
                                  graphRec.y+graphRec.height);
...
//    double a,b;
    ...
    for (i=0;i<=maxEnergy;i++)     {
      ...
      if (energyLevels[i] > 0)
        g.drawLine(graphRec.x,curY,graphRec.x+((int) (xScale * energyLevels[i])),curY);
    }
  }
