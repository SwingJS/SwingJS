...
public class HTML5LookAndFeel extends LookAndFeel {
	...
	protected void initClassDefaults(UIDefaults table) {
		...
		Object[] uiDefaults = { "ButtonUI", packageName + "JSButtonUI",
				"CheckBoxUI", packageName + "JSCheckBoxUI", "ColorChooserUI",
				packageName + "JSColorChooserUI", "FormattedTextFieldUI",
				packageName + "JSFormattedTextFieldUI", "MenuBarUI",
				packageName + "JSMenuBarUI", "MenuUI", packageName + "JSMenuUI",
				"MenuItemUI", packageName + "JSMenuItemUI", "CheckBoxMenuItemUI",
				packageName + "JSCheckBoxMenuItemUI", "RadioButtonMenuItemUI",
				packageName + "JSRadioButtonMenuItemUI", "RadioButtonUI",
				packageName + "JSRadioButtonUI", "ToggleButtonUI",
				packageName + "JSToggleButtonUI", "PopupMenuUI",
				packageName + "JSPopupMenuUI", "ProgressBarUI",
				packageName + "JSProgressBarUI", "ScrollBarUI",
				packageName + "JSScrollBarUI", "ScrollPaneUI",
				packageName + "JSScrollPaneUI", "SplitPaneUI",
				packageName + "JSSplitPaneUI", "SliderUI", packageName + "JSSliderUI",
				"SeparatorUI", packageName + "JSSeparatorUI", "SpinnerUI",
				packageName + "JSSpinnerUI", "ToolBarSeparatorUI",
				packageName + "JSToolBarSeparatorUI", "PopupMenuSeparatorUI",
				packageName + "JSPopupMenuSeparatorUI", "TabbedPaneUI",
				packageName + "JSTabbedPaneUI", "TextAreaUI",
				packageName + "JSTextAreaUI", "TextFieldUI",
				packageName + "JSTextFieldUI", "PasswordFieldUI",
				packageName + "JSPasswordFieldUI", "TextPaneUI",
				packageName + "JSTextPaneUI", "EditorPaneUI",
				packageName + "JSEditorPaneUI", "TreeUI", packageName + "JSTreeUI",
				"LabelUI", packageName + "JSLabelUI", "ListUI",
				packageName + "JSListUI", "ToolBarUI", packageName + "JSToolBarUI",
				"ToolTipUI", packageName + "JSToolTipUI", "ComboBoxUI",
				packageName + "JSComboBoxUI", "TableUI", packageName + "JSTableUI",
				"TableHeaderUI", packageName + "JSTableHeaderUI", "InternalFrameUI",
				packageName + "JSInternalFrameUI", "DesktopPaneUI",
				packageName + "JSDesktopPaneUI", "DesktopIconUI",
				packageName + "JSDesktopIconUI", "OptionPaneUI",
				packageName + "JSOptionPaneUI", "PanelUI", packageName + "JSPanelUI",
				"ViewportUI", packageName + "JSViewportUI", "RootPaneUI",
				packageName + "JSRootPaneUI", };
