...
import jssun.awt.image.BytePackedRaster;
...
@J2SRequireImport({ jsjava.awt.image.MultiPixelPackedSampleModel.class, jsjava.awt.image.SinglePixelPackedSampleModel.class })
public class Raster {
...
//        case DataBuffer.TYPE_USHORT:
        ...
        default:
      	...
      	WritableRaster r = (WritableRaster) Interface.getInstance("jssun.awt.image." + (dataType == DataBuffer.TYPE_BYTE ? "Byte" : "Integer") + "InterleavedRaster", true);
