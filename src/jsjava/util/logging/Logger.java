...
@J2SRequireImport({LogRecord.class})
public class Logger {
...
//    private ArrayList<Logger> kids;   // WeakReferences to loggers that have us as parent
...
static {
	loggers.put(GLOBAL_LOGGER_NAME, global);
}
...
//    @CallerSensitive
    public static synchronized Logger getLogger(String name) {
    	...
    	if (log == null)
    		loggers.put(name,  log = new Logger(name));
    	return log;
