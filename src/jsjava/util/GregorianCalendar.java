...
//                // Make sure the same thing for the max week
//                fd += 7 * (max - woy);
//                cal = gcal;//(fd >= gregorianCutoverDate) ? gcal : getJulianCalendarSystem();
...
//                fd = month1 + value * 7 + x;
//                BaseCalendar cal = gcal;//(fd >= gregorianCutoverDate) ? gcal : getJulianCalendarSystem();
