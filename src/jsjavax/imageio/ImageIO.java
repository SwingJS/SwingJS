...
//import jsjavax.imageio.spi.ImageReaderSpi;
//import jsjavax.imageio.spi.ImageReaderWriterSpi;
//import jsjavax.imageio.spi.ImageWriterSpi;
//import jsjavax.imageio.spi.ImageInputStreamSpi;
//import jsjavax.imageio.spi.ImageOutputStreamSpi;
//import jsjavax.imageio.spi.ImageTranscoderSpi;
//import jsjavax.imageio.spi.ServiceRegistry;
...
//
    ...
    private static int BMP = 3;
		...
		private static String[] readerTypes = { "image/png", "image/jpeg", "image/x-png", "image/vnd.wap.wbmp", "image/gif", "image/bmp" };
		private static int[] readerMap = {PNG, JPG, PNG, BMP, GIF, BMP };
		private static String[] readerFormatNames = {"jpg", "BMP", "bmp", "JPG", "wbmp", "jpeg", "png", "PNG", "JPEG", "WBMP", "GIF", "gif" };
		private static String[] readerSuffixes = {"jpg", "bmp", "jpeg", "wbmp", "png", "gif"};
...
//
    ...
    public static BufferedImage read(InputStream input) throws IOException {
        return read(createImageInputStream(input));
    }

    private static ImageInputStream createImageInputStream(InputStream input) {
    	byte[] data = JSToolkit.getSignedStreamBytes(new BufferedInputStream(input));
    	return new ImageInputStream(data);
		}
    ...
    public static BufferedImage read(URL input) throws IOException {
    	return read(createImageInputStream(input.openStream()));
    }
    ...
    public static BufferedImage read(ImageInputStream stream)
        throws IOException {
    	return (BufferedImage) Toolkit.getDefaultToolkit().createImage(stream.getBuf());
    }
