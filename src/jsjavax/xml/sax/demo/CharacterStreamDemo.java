...
import jsjavax.xml.sax.helpers.ParserFactory;
...
/**
  ...
  *
  * <p>Usage: java -Djsjavax.xml.sax.parser=<var>CLASSNAME</var>
  ...
  *
  * @see DemoHandler
  * @see org.xml.jsjavax.xml.sax.parser
  * @see jsjavax.xml.sax.InputSource
  * @see jsjavax.xml.sax.helpers.ParserFactory
    ...
    throws Exception
  {
    ...
    if (args.length != 0) {
      ...
      System.exit(2);
				...
				// jsjavax.xml.sax.parser property (you could
