...
/**
  ...
  *
  * <p>Usage: java -Djsjavax.xml.sax.parser=<var>classname</var> EntityDemo
  * <var>systemId</var></p>
  *
...
public class EntityDemo extends DemoHandler {
    ...
    throws Exception
  {
    ...
    if (args.length != 1) {
      System.err.println("Usage: java -Djsjavax.xml.sax.parser=<classname> " +
			 "EntityDemo <document>");
      System.exit(2);
    }

				// Make the parser, using the value
				// provided in the jsjavax.xml.sax.parser property.
