 ...
 * </blockquote>
 *
 * <p>This class wraps a SAX1 {@link jsjavax.xml.sax.Parser Parser}
 * and makes it act as a SAX2 {@link jsjavax.xml.sax.XMLReader XMLReader},
 * with feature, property, and Namespace support.  Note
 * that it is not possible to report {@link jsjavax.xml.sax.ContentHandler#skippedEntity
 ...
 * @see jsjavax.xml.sax.helpers.XMLReaderAdapter
...

     ...
     *
     * <p>Use the "jsjavax.xml.sax.parser" property to locate the
     * embedded SAX1 driver.</p>
     *
     * @exception SAXException If the embedded driver
     *            cannot be instantiated or if the
     *            jsjavax.xml.sax.parser property is not specified.
     */
	...
	String driver = System.getProperty("jsjavax.xml.sax.parser");
	...
	try {
		...
		SAXException("SAX1 driver class " +
			     driver +
			     " does not implement jsjavax.xml.sax.Parser");
	} catch (NullPointerException e5) {
	    throw new 
		SAXException("System property jsjavax.xml.sax.parser not specified");
	}
    }
...

     ...
     * @see jsjavax.xml.sax.XMLReader#getProperty
     */
    @Override
     ...
     * @see jsjavax.xml.sax.XMLReader#setEntityResolver
     */
    @Override
     ...
     * @see jsjavax.xml.sax.XMLReader#getEntityResolver
     */
    @Override
    ...
    ////////////////////////////////////////////////////////////////////
    // Implementation of jsjavax.xml.sax.DocumentHandler.
    ////////////////////////////////////////////////////////////////////
     ...
     * @see jsjavax.xml.sax.DocumentHandler#startDocument
     */
    @Override
     ...
     * @exception SAXException The client may raise a
     *            processing exception.
     * @see jsjavax.xml.sax.DocumentHandler#endDocument
     */
    @Override
     ...
     * @exception SAXException The client may raise a
     *            processing exception.
     * @see jsjavax.xml.sax.DocumentHandler#endElement
     */
    @Override
     ...
     * @exception SAXException The client may raise a
     *            processing exception.
     * @see jsjavax.xml.sax.DocumentHandler#characters
     */
    @Override
     ...
     * @exception SAXException The client may raise a
     *            processing exception.
     * @see jsjavax.xml.sax.DocumentHandler#ignorableWhitespace
     */
    @Override
     ...
     * @exception SAXException The client may raise a
     *            processing exception.
     * @see jsjavax.xml.sax.DocumentHandler#processingInstruction
     */
    @Override
...

	 ...
	 * @see jsjavax.xml.sax.Attributes#getLength
	 */
	@Override
	 ...
	 * @see jsjavax.xml.sax.Attributes#getURI
	 */
	@Override
	 ...
	 * @param The attribute's index.
	 * @return Always the empty string.
	 * @see jsjavax.xml.sax.Attributes#getLocalName
	 */
	@Override
	 ...
	 * @see jsjavax.xml.sax.Attributes#getIndex(java.lang.String,java.lang.String)
	 */
	@Override
	 ...
	 * @return The attributes index, or -1 if none was found.
	 * @see jsjavax.xml.sax.Attributes#getIndex(java.lang.String)
	 */
	@Override
