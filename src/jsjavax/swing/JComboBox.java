...
//            if (a instanceof jsjavax.swing.plaf.basic.ComboPopup) {
//                // Listen for changes to the popup menu selection.
//                popupList = ((jsjavax.swing.plaf.basic.ComboPopup)a).getList();
...
//            if (a != null &&
//                a instanceof jsjavax.swing.plaf.basic.ComboPopup) {
//
//                // get the popup list
//                JList list = ((jsjavax.swing.plaf.basic.ComboPopup)a).getList();
//
