 ...
 * manager set on it.
 * Refer to {@link jsjavax.swing.RootPaneContainer}
 ...
 * on a different screen device than its owner.  See {@link jsjava.awt.Frame} for
 * more information.
 * <p>
                                               ...
                                               RootPaneContainer//,                               TransferHandler.HasGetTransferHandler
{
     ...
     * @see jsjava.awt.Dialog.ModalityType#MODELESS
     * @see jsjava.awt.Dialog#DEFAULT_MODALITY_TYPE
     * @see jsjava.awt.Dialog#setModal
     ...
     * @exception jsjava.awt.HeadlessException when
     *     <code>GraphicsEnvironment.isHeadless()</code> returns <code>true</code>
     *
     * @see jsjava.awt.GraphicsEnvironment#isHeadless
     * @see JComponent#getDefaultLocale
    ...
    */
     ...
     * @see jsjava.awt.Component#setDropTarget
     * @since 1.6
     *
     * @beaninfo
     *        bound: true
    ...
    */
     ...
     * <code>contentPane</code>.
     * Refer to {@link jsjavax.swing.RootPaneContainer} for
     * more information.
     *
   ...
   /**
     ...
     *
     * @exception jsjava.awt.IllegalComponentStateException (a runtime
     ...
     * @see jsjavax.swing.LookAndFeel#getSupportsWindowDecorations
     * @since 1.4
     */
