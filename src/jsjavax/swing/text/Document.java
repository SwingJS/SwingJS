 ...
 * <li><a href="#getText(int, int, jsjavax.swing.text.Segment)">getText(int, int, Segment)</a>
 * </ul>
 ...
 * document content:
 * <ul>
 * <li><a href="#insertString(int, java.lang.String, jsjavax.swing.text.AttributeSet)">insertString(int, String, AttributeSet)</a>
 ...
 * <ul>
 * <li><a href="#addDocumentListener(jsjavax.swing.event.DocumentListener)">addDocumentListener(DocumentListener)</a>
 * <li><a href="#removeDocumentListener(jsjavax.swing.event.DocumentListener)">removeDocumentListener(DocumentListener)</a>
 * <li><a href="#addUndoableEditListener(jsjavax.swing.event.UndoableEditListener)">addUndoableEditListener(UndoableEditListener)</a>
 * <li><a href="#removeUndoableEditListener(jsjavax.swing.event.UndoableEditListener)">removeUndoableEditListener(UndoableEditListener)</a>
 * </ul>
 *
 ...
 *
 * @see jsjavax.swing.event.DocumentEvent
 * @see jsjavax.swing.event.DocumentListener
 * @see jsjavax.swing.event.UndoableEditEvent
 * @see jsjavax.swing.event.UndoableEditListener
 * @see Element
 * @see Position
 * @see AttributeSet
 */
