...
A view has the following responsibilities:
  <dl>
    ...
    <li><a href="#preferenceChanged(jsjavax.swing.text.View, boolean, boolean)">preferenceChanged</a>
  ...
  <p>The <code>setSize</code> method should be prepared to be called a number of times
    ...
    <ul>
    <li><a href="#paint(jsjava.awt.Graphics, jsjava.awt.Shape)">paint</a>
    </ul>
    <p>
    ...
    <ul>
    <li><a href="#modelToView(int, jsjavax.swing.text.Position.Bias, int, jsjavax.swing.text.Position.Bias, jsjava.awt.Shape)">modelToView</a>
    <li><a href="#viewToModel(float, float, jsjava.awt.Shape, jsjavax.swing.text.Position.Bias[])">viewToModel</a>
...
public abstract class View implements SwingConstants {
     ...
     * @see jsjavax.swing.JComponent#revalidate
     */
