 ...
 * Class rootClass = jsjavax.swing.JList.class;
 ...
 * {@code jsjavax.swing.event.ListDataListener}s that have been added to it, each
 * time a change occurs. These changes are characterized by a
 * {@code jsjavax.swing.event.ListDataEvent}, which identifies the range of list
 ...
 * {@code jsjavax.swing.event.ListSelectionListener}s that have been added to it
 * each time a change to the selection occurs. These changes are characterized
 * by a {@code jsjavax.swing.event.ListSelectionEvent}, which identifies the range
 ...
 * The renderer provides a {@code jsjava.awt.Component} that is used
...
//    }
     ...
     * @see jsjavax.swing.event.ListSelectionEvent
     ...
     * {@link jsjavax.swing.ListSelectionModel#setValueIsAdjusting} for
     * more details.
     *
     * @param b the new value for the property
     * @see ListSelectionModel#setValueIsAdjusting
     * @see jsjavax.swing.event.ListSelectionEvent#getValueIsAdjusting
