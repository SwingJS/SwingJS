...
public class JSlider extends JComponent implements SwingConstants {
     ...
     * @see #changeListener
     * @see #fireStateChanged
     * @see jsjavax.swing.event.ChangeListener
     * @see jsjavax.swing.BoundedRangeModel
     */
...
//        }
    ...
    public void setMinimum(int minimum) {
        ...
        firePropertyChangeObject( "minimum", new Integer( oldMin ), new Integer( minimum ) );
    }
    ...
    public void setMaximum(int maximum) {
        ...
        firePropertyChangeObject( "maximum", new Integer( oldMax ), new Integer( maximum ) );
    }
