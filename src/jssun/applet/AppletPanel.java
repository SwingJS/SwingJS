 ...
 */
public
abstract class AppletPanel extends Panel implements AppletStub {
...
//
    ...
    protected void showAppletStatus(String status, Object arg) {
        getAppletContext().showStatus(status + " " + arg);
    }
    protected void showAppletStatus(String status, Object arg1, Object arg2) {
        getAppletContext().showStatus(status + " " + arg1 + " " + arg2);
    }
...
//                Vector<Window> windowList = (Vector<Window>)oldAppContext.get(Window.class);
//                if (windowList != null) {
