...
As SwingJS is developed, more classes can be added here. The general procedure is:
...
4. Change their package root jssun. Imports generally do not have to be changed; that is optional.
...
Note that all files in the jssun package will be moved to j2s/sun, as the build script will drop the "js" from all references to "jssun" anywhere in the project.
