...
public abstract class SunToolkit extends Toolkit implements
	...
	// GetBooleanAction("jssun.awt.nativedebug"))) {
	// DebugSettings.init();
	// }
	// };
	...
	/**
	 * Returns the value of "jssun.awt.noerasebackground" property. Default value
	 * is {@code false}.
	 */
	public static boolean getSunAwtNoerasebackground() {
		return false;
		// return AccessController.doPrivileged(new
		// GetBooleanAction("jssun.awt.noerasebackground"));
	}
	...
	public static boolean getSunAwtErasebackgroundonresize() {
		return true;
		// return AccessController.doPrivileged(new
		// GetBooleanAction("jssun.awt.erasebackgroundonresize"));
	}
...
//
	...
	// return AccessController.doPrivileged(new
	// GetBooleanAction("jssun.awt.xembedserver"));
	// }
...
//	protected abstract boolean syncNativeQueue(final long timeout);
	...
	// * component is
	// * {@link com.jssun.awt.AWTUtilities.Translucency#PERPIXEL_TRANSLUCENT
	...
	// return w != null && com.jssun.awt.AWTUtilities.getWindowOpacity((Window)w)
	// < 1.0f;
	// }
