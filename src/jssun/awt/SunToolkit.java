...
//        throws HeadlessException;
//
//    public abstract ListPeer createList(jsjava.awt.List target)
//        throws HeadlessException;
//
...
//            if (policyName.startsWith("jsjava.awt.")) {
//                // AWT
//                if (isSwingCont) {
...
//                    // New awt policy.
//                }
//            } else if (policyName.startsWith("jsjavax.swing.")) {
//                if (isSwingCont) {
//                    // New Swing's policy
//                } else {
...
//                Class.forName("jsjavax.swing.LayoutFocusTraversalPolicy");
...
//    }
    ...
    /**
     * Returns the value of "jssun.awt.noerasebackground" property. Default
     * value is {@code false}.
     */
    public static boolean getSunAwtNoerasebackground() {
    	return false;
//        return AccessController.doPrivileged(new GetBooleanAction("jssun.awt.noerasebackground"));
    }

    /**
     * Returns the value of "jssun.awt.erasebackgroundonresize" property. Default
     * value is {@code false}.
     */
    public static boolean getSunAwtErasebackgroundonresize() {
    	return true;
        //return AccessController.doPrivileged(new GetBooleanAction("jssun.awt.erasebackgroundonresize"));
    }
...
//     * jssun.awt.im.InputMethodWindow.
//     * <p>
...
//        return new jssun.awt.im.SimpleInputMethodWindow(title, context);
//    }
...
//            doPrivileged(new GetPropertyAction("jssun.awt.noxembed", "false"));
...
//        return AccessController.doPrivileged(new GetBooleanAction("jssun.awt.xembedserver"));
//    }
...
//     * @see jssun.awt.SunToolkit#isModalExcluded(jsjava.awt.Window)
//     *
//     * @since 1.5
//     */
...
//     *
//     * @see jssun.awt.windows.WToolkit#isModalExcludeSupportedImpl
//     * @see jssun.awt.X11.XToolkit#isModalExcludeSupportedImpl
//     *
//     * @since 1.5
//     */
...
//     * by modal dialog, see {@link jsjava.awt.Dialog}.
...
//     * @see jsjava.awt.Dialog#setModal(boolean)
...
//                        new GetBooleanAction("jssun.awt.disableMixing")));
//        }
...
//     * component is
//     * {@link com.jssun.awt.AWTUtilities.Translucency#PERPIXEL_TRANSLUCENT PERPIXEL_TRANSLUCENT}.
//     *
...
//     * @see com.jssun.awt.AWTUtilities.Translucency#PERPIXEL_TRANSLUCENT
//     * @see com.jssun.awt.AWTUtilities#isWindowOpaque(Window)
//     */
//    public static boolean isContainingTopLevelOpaque(Component c) {
//        Window w = getContainingWindow(c);
//        // return w != null && (w).isOpaque();
//        return w != null && com.jssun.awt.AWTUtilities.isWindowOpaque(w);
//    }
//
//    /**
//     * Returns whether or not a containing top level window for the passed
//     * component is
//     * {@link com.jssun.awt.AWTUtilities.Translucency#TRANSLUCENT TRANSLUCENT}.
//     *
//     * @param c a Component which toplevel's to check
//     * @return {@code true} if the passed component is not null and has a
//     * containing toplevel window which has opacity less than
//     * 1.0f (which means that it is translucent), {@code false} otherwise
//     * @see com.jssun.awt.AWTUtilities.Translucency#TRANSLUCENT
//     * @see com.jssun.awt.AWTUtilities#getWindowOpacity(Window)
//     */
//    public static boolean isContainingTopLevelTranslucent(Component c) {
//        Window w = getContainingWindow(c);
//        // return w != null && (w).getOpacity() < 1.0f;
//        return w != null && com.jssun.awt.AWTUtilities.getWindowOpacity((Window)w) < 1.0f;
//    }
