...
public interface PathConsumer2D {
    /**
     * @see jsjava.awt.geom.Path2D.Float.moveTo
     */
    public void moveTo(float x, float y);

    /**
     * @see jsjava.awt.geom.Path2D.Float.lineTo
     */
    public void lineTo(float x, float y);

    /**
     * @see jsjava.awt.geom.Path2D.Float.quadTo
     */
    public void quadTo(float x1, float y1,
                       float x2, float y2);

    /**
     * @see jsjava.awt.geom.Path2D.Float.curveTo
     */
    ...
    /**
     * @see jsjava.awt.geom.Path2D.Float.closePath
     */
     ...
     * {@link jsjava.awt.geom.PathIterator PathIterator}
