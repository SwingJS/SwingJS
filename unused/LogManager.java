 ...
 * jsjava.util.logging.manager system property.
 * <p>
 ...
 * <ul>
 * <li>"jsjava.util.logging.config.class"
 * <li>"jsjava.util.logging.config.file"
 * </ul>
 ...
 * <p>
 * If the "jsjava.util.logging.config.class" property is set, then the
 ...
 * <p>
 * If "jsjava.util.logging.config.class" property is <b>not</b> set,
 * then the "jsjava.util.logging.config.file" system property can be used
 * to specify a properties file (in jsjava.util.Properties format). The
...
public class LogManager {
    ...
    static {
        AccessController.doPrivileged(new PrivilegedAction<Object>() {
                public Object run() {
                    String cname = null;
                    try {
                        cname = System.getProperty("jsjava.util.logging.manager");
                        if (cname != null) {
                            try {
    ...
    public void readConfiguration() throws IOException, SecurityException {
        ...
        String cname = System.getProperty("jsjava.util.logging.config.class");
        if (cname != null) {
            try {
        ...
        String fname = System.getProperty("jsjava.util.logging.config.file");
        if (fname == null) {
    ...
    /**
     * Reinitialize the logging properties and reread the logging configuration
     * from the given stream, which should be in jsjava.util.Properties format.
     * A PropertyChangeEvent will be fired after the properties are read.
     * <p>
     * Any log level definitions in the new configuration file will be
     * applied using Logger.setLevel(), if the target Logger exists.
    ...
    public final static String LOGGING_MXBEAN_NAME
        = "jsjava.util.logging:type=Logging";
