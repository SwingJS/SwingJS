 ...
 * <ul>
 * <li>   jsjava.util.logging.MemoryHandler.level
 *        specifies the level for the <tt>Handler</tt>
 *        (defaults to <tt>Level.ALL</tt>).
 * <li>   jsjava.util.logging.MemoryHandler.filter
 *        specifies the name of a <tt>Filter</tt> class to use
 *        (defaults to no <tt>Filter</tt>).
 * <li>   jsjava.util.logging.MemoryHandler.size
 *        defines the buffer size (defaults to 1000).
 * <li>   jsjava.util.logging.MemoryHandler.push
 *        defines the <tt>pushLevel</tt> (defaults to <tt>level.SEVERE</tt>).
 * <li>   jsjava.util.logging.MemoryHandler.target
...
public class MemoryHandler extends Handler {
    ...
    public MemoryHandler() {
        ...
        try {
            LogManager manager = LogManager.getLogManager();
            name = manager.getProperty("jsjava.util.logging.MemoryHandler.target");
