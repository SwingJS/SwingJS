 ...
 * <ul>
 * <li>   jsjava.util.logging.StreamHandler.level
 *        specifies the default level for the <tt>Handler</tt>
 *        (defaults to <tt>Level.INFO</tt>).
 * <li>   jsjava.util.logging.StreamHandler.filter
 *        specifies the name of a <tt>Filter</tt> class to use
 *         (defaults to no <tt>Filter</tt>).
 * <li>   jsjava.util.logging.StreamHandler.formatter
 *        specifies the name of a <tt>Formatter</tt> class to use
 *        (defaults to <tt>jsjava.util.logging.SimpleFormatter</tt>).
 * <li>   jsjava.util.logging.StreamHandler.encoding
