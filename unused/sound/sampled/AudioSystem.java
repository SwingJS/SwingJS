...
import jsjavax.sound.sampled.AudioFileFormat;
//import jsjavax.sound.sampled.AudioPermission;
import jsjavax.sound.sampled.Clip;
import jsjavax.sound.sampled.DataLine;
import jsjavax.sound.sampled.Line;
import jsjavax.sound.sampled.LineUnavailableException;
import jsjavax.sound.sampled.Mixer;
import jsjavax.sound.sampled.Port;
import jsjavax.sound.sampled.SourceDataLine;
import jsjavax.sound.sampled.TargetDataLine;
import jsjavax.sound.sampled.UnsupportedAudioFileException;
import jsjavax.sound.sampled.spi.AudioFileReader;
//import jsjavax.sound.sampled.spi.AudioFileWriter;
import jsjavax.sound.sampled.spi.FormatConversionProvider;
import jsjavax.sound.sampled.spi.MixerProvider;
...
//        }
    ...
    private static List getAudioFileWriters() {
        return getProviders(null);//AudioFileWriter.class);
    }
