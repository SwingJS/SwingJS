 ...
 * <ul>
 * <li>   jsjava.util.logging.SocketHandler.level
 *        specifies the default level for the <tt>Handler</tt>
 *        (defaults to <tt>Level.ALL</tt>).
 * <li>   jsjava.util.logging.SocketHandler.filter
 *        specifies the name of a <tt>Filter</tt> class to use
 *        (defaults to no <tt>Filter</tt>).
 * <li>   jsjava.util.logging.SocketHandler.formatter
 *        specifies the name of a <tt>Formatter</tt> class to use
 *        (defaults to <tt>jsjava.util.logging.XMLFormatter</tt>).
 * <li>   jsjava.util.logging.SocketHandler.encoding
 *        the name of the character set encoding to use (defaults to
 *        the default platform encoding).
 * <li>   jsjava.util.logging.SocketHandler.host
 *        specifies the target host name to connect to (no default).
 * <li>   jsjava.util.logging.SocketHandler.port
