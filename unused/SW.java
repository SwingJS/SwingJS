...
public class SW extends Applet implements ComponentListener {
	...
	class StringWaveFrame extends Frame implements ComponentListener,
		...
		public void init() {
			...
			main.add(tensionBar = new Scrollbar(Scrollbar.HORIZONTAL,
		...
		public void updateStringWave(Graphics realg) {
			...
			if (displayChooser.getSelectedIndex() == DISP_PHASE
				...
				g.setColor(gray2);
				g.drawLine(winSize.width / 2, midy - (int) ymult, winSize.width / 2,
						midy + (int) ymult);
				ox = -1;
				int oy2 = -1;
				int subsamples = 4;
