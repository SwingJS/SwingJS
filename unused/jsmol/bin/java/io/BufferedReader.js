Clazz.load (["java.io.Reader"], "java.io.BufferedReader", ["java.io.IOException", "java.lang.IllegalArgumentException", "$.IndexOutOfBoundsException", "javajs.util.SB"], function () {
...
}if (s == null) s = javajs.util.SB.newN (80);
s.appendCB (this.cb, startChar, i - startChar);
}
