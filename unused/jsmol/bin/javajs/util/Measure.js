...
var vAB =  new javajs.util.V3 ();
var d = javajs.util.Measure.getNormalThroughPoints (ptA, ptB, ptC, normal, vAB);
var isReversed = (javajs.util.Measure.distanceToPlaneV (normal, d, ptCenter) > 0);
if (isReversed == isOutward) normal.scale (-1.0);
return !isReversed;
}, "javajs.util.P3,javajs.util.P3,javajs.util.P3,javajs.util.P3,~B,javajs.util.V3");
