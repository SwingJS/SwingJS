...
Clazz.load (["java.util.EventObject"], "jsjavax.swing.event.TreeSelectionEvent", ["java.lang.IllegalArgumentException"], function () {
...
}, jsjavax.swing.event, "TreeSelectionEvent", java.util.EventObject);
Clazz.makeConstructor (c$, 
function (source, paths, areNew, oldLeadSelectionPath, newLeadSelectionPath) {
Clazz.superConstructor (this, jsjavax.swing.event.TreeSelectionEvent, [source]);
this.paths = paths;
this.areNew = areNew;
this.oldLeadSelectionPath = oldLeadSelectionPath;
this.newLeadSelectionPath = newLeadSelectionPath;
}, "~O,~A,~A,jsjavax.swing.tree.TreePath,jsjavax.swing.tree.TreePath");
Clazz.makeConstructor (c$, 
...
this.oldLeadSelectionPath = oldLeadSelectionPath;
this.newLeadSelectionPath = newLeadSelectionPath;
}, "~O,jsjavax.swing.tree.TreePath,~B,jsjavax.swing.tree.TreePath,jsjavax.swing.tree.TreePath");
...
function (newSource) {
return  new jsjavax.swing.event.TreeSelectionEvent (newSource, this.paths, this.areNew, this.oldLeadSelectionPath, this.newLeadSelectionPath);
}, "~O");
});
