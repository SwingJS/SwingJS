...
Clazz.load (null, "jsjavax.swing.LayoutComparator", ["java.lang.ClassCastException", "java.util.LinkedList", "jsjava.awt.Window"], function () {
c$ = Clazz.decorateAsClass (function () {
this.horizontal = true;
this.leftToRight = true;
Clazz.instantialize (this, arguments);
}, jsjavax.swing, "LayoutComparator", null, [java.util.Comparator, java.io.Serializable]);
...
aAncestory.add (a);
if (Clazz.instanceOf (a, jsjava.awt.Window)) {
break;
}}
if (a == null) {
...
bAncestory.add (b);
if (Clazz.instanceOf (b, jsjava.awt.Window)) {
break;
}}
if (b == null) {
throw  new ClassCastException ();
