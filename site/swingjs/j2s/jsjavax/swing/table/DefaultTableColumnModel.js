...
Clazz.load (["jsjava.beans.PropertyChangeListener", "jsjavax.swing.event.ListSelectionListener", "jsjavax.swing.table.TableColumnModel", "jsjavax.swing.event.EventListenerList"], "jsjavax.swing.table.DefaultTableColumnModel", ["java.lang.IllegalArgumentException", "java.util.Vector", "jsjavax.swing.DefaultListSelectionModel", "jsjavax.swing.event.ChangeEvent", "$.TableColumnModelEvent", "$.TableColumnModelListener"], function () {
...
}, jsjavax.swing.table, "DefaultTableColumnModel", null, [jsjavax.swing.table.TableColumnModel, jsjava.beans.PropertyChangeListener, jsjavax.swing.event.ListSelectionListener]);
...
this.invalidateWidthCache ();
this.fireColumnAdded ( new jsjavax.swing.event.TableColumnModelEvent (this, 0, this.getColumnCount () - 1));
...
this.invalidateWidthCache ();
this.fireColumnRemoved ( new jsjavax.swing.event.TableColumnModelEvent (this, columnIndex, 0));
}}, "jsjavax.swing.table.TableColumn");
...
this.fireColumnMoved ( new jsjavax.swing.event.TableColumnModelEvent (this, columnIndex, newIndex));
return;
...
function (x) {
this.listenerList.add (jsjavax.swing.event.TableColumnModelListener, x);
}, "jsjavax.swing.event.TableColumnModelListener");
Clazz.overrideMethod (c$, "removeColumnModelListener", 
function (x) {
this.listenerList.remove (jsjavax.swing.event.TableColumnModelListener, x);
}, "jsjavax.swing.event.TableColumnModelListener");
Clazz.defineMethod (c$, "getColumnModelListeners", 
function () {
return this.listenerList.getListeners (jsjavax.swing.event.TableColumnModelListener);
});
Clazz.defineMethod (c$, "fireColumnAdded", 
function (e) {
var listeners = this.listenerList.getListenerList ();
for (var i = listeners.length - 2; i >= 0; i -= 2) {
if (listeners[i] === jsjavax.swing.event.TableColumnModelListener) {
