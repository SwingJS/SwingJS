...
Clazz.load (["jsjavax.swing.JComponent"], "jsjavax.swing.JSplitPane", ["java.lang.Boolean", "$.IllegalArgumentException", "jsjavax.swing.JButton", "$.UIManager"], function () {
...
}, jsjavax.swing, "JSplitPane", jsjavax.swing.JComponent);
Clazz.makeConstructor (c$, 
function () {
this.construct (1, false,  new jsjavax.swing.JButton (jsjavax.swing.UIManager.getString ("SplitPane.leftButtonText")),  new jsjavax.swing.JButton (jsjavax.swing.UIManager.getString ("SplitPane.rightButtonText")));
});
Clazz.makeConstructor (c$, 
...
}, "~N,jsjava.awt.Component,jsjava.awt.Component");
Clazz.makeConstructor (c$, 
function (newOrientation, newContinuousLayout, newLeftComponent, newRightComponent) {
Clazz.superConstructor (this, jsjavax.swing.JSplitPane);
...
this.updateUI ();
}, "~N,~B,jsjava.awt.Component,jsjava.awt.Component");
Clazz.defineMethod (c$, "setUI", 
function (ui) {
if (this.ui !== ui) {
Clazz.superCall (this, jsjavax.swing.JSplitPane, "setUI", [ui]);
this.revalidate ();
}}, "jsjavax.swing.plaf.SplitPaneUI");
...
this.firePropertyChange ("dividerSize", oldSize, newSize);
}}, "~N");
...
this.firePropertyChange ("oneTouchExpandable", oldValue, newValue);
this.repaint ();
}, "~B");
...
this.firePropertyChange ("lastDividerLocation", oldLocation, newLastLocation);
}, "~N");
...
this.continuousLayout = newContinuousLayout;
this.firePropertyChange ("continuousLayout", oldCD, newContinuousLayout);
}, "~B");
...
this.firePropertyChange ("resizeWeight", oldWeight, value);
}, "~N");
...
}this.firePropertyChange ("dividerLocation", oldValue, location);
...
this.rightComponent = null;
}Clazz.superCall (this, jsjavax.swing.JSplitPane, "remove", [component]);
this.revalidate ();
this.repaint ();
}, "jsjava.awt.Component");
Clazz.defineMethod (c$, "remove", 
...
this.rightComponent = null;
}Clazz.superCall (this, jsjavax.swing.JSplitPane, "remove", [index]);
this.revalidate ();
this.repaint ();
}, "~N");
...
Clazz.superCall (this, jsjavax.swing.JSplitPane, "removeAll", []);
this.revalidate ();
this.repaint ();
});
...
index = -1;
}Clazz.superCall (this, jsjavax.swing.JSplitPane, "addImpl", [comp, constraints, index]);
this.revalidate ();
this.repaint ();
}, "jsjava.awt.Component,~O,~N");
Clazz.defineMethod (c$, "paintChildren", 
function (g) {
Clazz.superCall (this, jsjavax.swing.JSplitPane, "paintChildren", [g]);
var ui = this.getUI ();
if (ui != null) {
var tempG = g.create ();
...
Clazz.superCall (this, jsjavax.swing.JSplitPane, "setUIProperty", [propertyName, value]);
}}, "~S,~O");
...
return Clazz.superCall (this, jsjavax.swing.JSplitPane, "paramString", []) + ",continuousLayout=" + continuousLayoutString + ",dividerSize=" + this.dividerSize + ",lastDividerLocation=" + this.lastDividerLocation + ",oneTouchExpandable=" + oneTouchExpandableString + ",orientation=" + orientationString;
});
