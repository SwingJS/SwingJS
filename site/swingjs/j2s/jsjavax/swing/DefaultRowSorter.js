...
Clazz.load (["jsjavax.swing.RowFilter", "$.RowSorter"], "jsjavax.swing.DefaultRowSorter", ["java.lang.IllegalArgumentException", "$.IndexOutOfBoundsException", "java.util.ArrayList", "$.Arrays", "$.Collections", "jsjavax.swing.SortOrder"], function () {
...
if (!Clazz.isClassDefined ("jsjavax.swing.DefaultRowSorter.FilterEntry")) {
jsjavax.swing.DefaultRowSorter.$DefaultRowSorter$FilterEntry$ ();
}
Clazz.instantialize (this, arguments);
}, jsjavax.swing, "DefaultRowSorter", jsjavax.swing.RowSorter);
Clazz.makeConstructor (c$, 
function () {
Clazz.superConstructor (this, jsjavax.swing.DefaultRowSorter, []);
...
}}, "jsjavax.swing.DefaultRowSorter.ModelWrapper");
...
if (sortIndex == -1) {
sortKey =  new jsjavax.swing.RowSorter.SortKey (column, jsjavax.swing.SortOrder.ASCENDING);
keys.add (0, sortKey);
} else if (sortIndex == 0) {
keys.set (0, this.toggle (keys.get (0)));
} else {
keys.remove (sortIndex);
keys.add (0,  new jsjavax.swing.RowSorter.SortKey (column, jsjavax.swing.SortOrder.ASCENDING));
...
($fz = function (key) {
if (key.getSortOrder () === jsjavax.swing.SortOrder.ASCENDING) {
return  new jsjavax.swing.RowSorter.SortKey (key.getColumn (), jsjavax.swing.SortOrder.DESCENDING);
}return  new jsjavax.swing.RowSorter.SortKey (key.getColumn (), jsjavax.swing.SortOrder.ASCENDING);
}, $fz.isPrivate = true, $fz), "jsjavax.swing.RowSorter.SortKey");
...
return (keySize == 0 || keys.get (0).getSortOrder () === jsjavax.swing.SortOrder.UNSORTED);
...
this.viewToModel[i] =  new jsjavax.swing.DefaultRowSorter.Row (this, i);
}
}, $fz.isPrivate = true, $fz), "~N");
...
this.filterEntry = Clazz.innerTypeInstance (jsjavax.swing.DefaultRowSorter.FilterEntry, this, null);
...
if (this.include (i)) {
added.add ( new jsjavax.swing.DefaultRowSorter.Row (this, i));
}}
var viewIndex;
...
if (this.modelToView[i] == -1) {
if (this.include (i)) {
updated.add ( new jsjavax.swing.DefaultRowSorter.Row (this, i));
newlyVisible++;
}} else {
if (!this.include (i)) {
newlyHidden++;
...
this.modelIndex = 0;
Clazz.instantialize (this, arguments);
}, jsjavax.swing.DefaultRowSorter, "FilterEntry", jsjavax.swing.RowFilter.Entry);
Clazz.overrideMethod (c$, "getModel", 
function () {
return this.b$["jsjavax.swing.DefaultRowSorter"].getModelWrapper ().getModel ();
});
Clazz.overrideMethod (c$, "getValueCount", 
function () {
return this.b$["jsjavax.swing.DefaultRowSorter"].getModelWrapper ().getColumnCount ();
});
Clazz.overrideMethod (c$, "getValue", 
function (a) {
return this.b$["jsjavax.swing.DefaultRowSorter"].getModelWrapper ().getValueAt (this.modelIndex, a);
}, "~N");
Clazz.overrideMethod (c$, "getStringValue", 
function (a) {
return this.b$["jsjavax.swing.DefaultRowSorter"].getModelWrapper ().getStringValueAt (this.modelIndex, a);
}, "~N");
Clazz.overrideMethod (c$, "getIdentifier", 
function () {
return this.b$["jsjavax.swing.DefaultRowSorter"].getModelWrapper ().getIdentifier (this.modelIndex);
});
c$ = Clazz.p0p ();
};
Clazz.pu$h ();
c$ = Clazz.declareType (jsjavax.swing.DefaultRowSorter, "ModelWrapper");
Clazz.makeConstructor (c$, 
function () {
});
...
this.modelIndex = 0;
Clazz.instantialize (this, arguments);
}, jsjavax.swing.DefaultRowSorter, "Row", null, Comparable);
Clazz.makeConstructor (c$, 
function (a, b) {
this.sorter = a;
this.modelIndex = b;
}, "jsjavax.swing.DefaultRowSorter,~N");
Clazz.overrideMethod (c$, "compareTo", 
function (a) {
return this.sorter.compare (this.modelIndex, a.modelIndex);
}, "jsjavax.swing.DefaultRowSorter.Row");
c$ = Clazz.p0p ();
});
