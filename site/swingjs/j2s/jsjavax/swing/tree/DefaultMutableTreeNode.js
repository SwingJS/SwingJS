...
Clazz.load (["java.util.Enumeration", "jsjavax.swing.tree.MutableTreeNode", "java.util.NoSuchElementException"], "jsjavax.swing.tree.DefaultMutableTreeNode", ["java.lang.ArrayIndexOutOfBoundsException", "$.Error", "$.IllegalArgumentException", "$.IllegalStateException", "java.util.Stack", "$.Vector"], function () {
c$ = Clazz.decorateAsClass (function () {
this.parent = null;
this.$children = null;
this.userObject = null;
this.allowsChildren = false;
if (!Clazz.isClassDefined ("jsjavax.swing.tree.DefaultMutableTreeNode.PreorderEnumeration")) {
jsjavax.swing.tree.DefaultMutableTreeNode.$DefaultMutableTreeNode$PreorderEnumeration$ ();
}
if (!Clazz.isClassDefined ("jsjavax.swing.tree.DefaultMutableTreeNode.PostorderEnumeration")) {
jsjavax.swing.tree.DefaultMutableTreeNode.$DefaultMutableTreeNode$PostorderEnumeration$ ();
}
if (!Clazz.isClassDefined ("jsjavax.swing.tree.DefaultMutableTreeNode.BreadthFirstEnumeration")) {
jsjavax.swing.tree.DefaultMutableTreeNode.$DefaultMutableTreeNode$BreadthFirstEnumeration$ ();
}
if (!Clazz.isClassDefined ("jsjavax.swing.tree.DefaultMutableTreeNode.PathBetweenNodesEnumeration")) {
jsjavax.swing.tree.DefaultMutableTreeNode.$DefaultMutableTreeNode$PathBetweenNodesEnumeration$ ();
}
Clazz.instantialize (this, arguments);
}, jsjavax.swing.tree, "DefaultMutableTreeNode", null, [Cloneable, jsjavax.swing.tree.MutableTreeNode]);
...
}, "jsjavax.swing.tree.MutableTreeNode,~N");
...
}, "jsjavax.swing.tree.MutableTreeNode");
...
function () {
if (this.$children == null) {
return jsjavax.swing.tree.DefaultMutableTreeNode.EMPTY_ENUMERATION;
} else {
...
}, "jsjavax.swing.tree.DefaultMutableTreeNode");
...
function () {
return Clazz.innerTypeInstance (jsjavax.swing.tree.DefaultMutableTreeNode.PreorderEnumeration, this, null, this);
});
Clazz.defineMethod (c$, "postorderEnumeration", 
function () {
return Clazz.innerTypeInstance (jsjavax.swing.tree.DefaultMutableTreeNode.PostorderEnumeration, this, null, this);
});
Clazz.defineMethod (c$, "breadthFirstEnumeration", 
function () {
return Clazz.innerTypeInstance (jsjavax.swing.tree.DefaultMutableTreeNode.BreadthFirstEnumeration, this, null, this);
});
...
function (ancestor) {
return Clazz.innerTypeInstance (jsjavax.swing.tree.DefaultMutableTreeNode.PathBetweenNodesEnumeration, this, null, ancestor, this);
}, "jsjavax.swing.tree.TreeNode");
...
var newNode = null;
try {
newNode = Clazz.superCall (this, jsjavax.swing.tree.DefaultMutableTreeNode, "clone", []);
...
this.stack = null;
Clazz.instantialize (this, arguments);
}, jsjavax.swing.tree.DefaultMutableTreeNode, "PreorderEnumeration", null, java.util.Enumeration);
Clazz.makeConstructor (c$, 
function (a) {
...
this.subtree = null;
Clazz.instantialize (this, arguments);
}, jsjavax.swing.tree.DefaultMutableTreeNode, "PostorderEnumeration", null, java.util.Enumeration);
Clazz.makeConstructor (c$, 
function (a) {
this.root = a;
this.children = this.root.children ();
this.subtree = jsjavax.swing.tree.DefaultMutableTreeNode.EMPTY_ENUMERATION;
}, "jsjavax.swing.tree.TreeNode");
...
this.subtree = Clazz.innerTypeInstance (jsjavax.swing.tree.DefaultMutableTreeNode.PostorderEnumeration, this, null, this.children.nextElement ());
a = this.subtree.nextElement ();
} else {
a = this.root;
this.root = null;
...
Clazz.prepareCallback (this, arguments);
this.queue = null;
if (!Clazz.isClassDefined ("jsjavax.swing.tree.DefaultMutableTreeNode.BreadthFirstEnumeration.Queue")) {
jsjavax.swing.tree.DefaultMutableTreeNode.BreadthFirstEnumeration.$DefaultMutableTreeNode$BreadthFirstEnumeration$Queue$ ();
}
Clazz.instantialize (this, arguments);
}, jsjavax.swing.tree.DefaultMutableTreeNode, "BreadthFirstEnumeration", null, java.util.Enumeration);
Clazz.makeConstructor (c$, 
function (a) {
var b =  new java.util.Vector (1);
b.addElement (a);
this.queue = Clazz.innerTypeInstance (jsjavax.swing.tree.DefaultMutableTreeNode.BreadthFirstEnumeration.Queue, this, null);
...
this.head = null;
this.tail = null;
if (!Clazz.isClassDefined ("jsjavax.swing.tree.DefaultMutableTreeNode.BreadthFirstEnumeration.Queue.QNode")) {
jsjavax.swing.tree.DefaultMutableTreeNode.BreadthFirstEnumeration.Queue.$DefaultMutableTreeNode$BreadthFirstEnumeration$Queue$QNode$ ();
}
Clazz.instantialize (this, arguments);
}, jsjavax.swing.tree.DefaultMutableTreeNode.BreadthFirstEnumeration, "Queue");
Clazz.defineMethod (c$, "enqueue", 
function (a) {
if (this.head == null) {
this.head = this.tail = Clazz.innerTypeInstance (jsjavax.swing.tree.DefaultMutableTreeNode.BreadthFirstEnumeration.Queue.QNode, this, null, a, null);
} else {
this.tail.next = Clazz.innerTypeInstance (jsjavax.swing.tree.DefaultMutableTreeNode.BreadthFirstEnumeration.Queue.QNode, this, null, a, null);
...
this.next = null;
Clazz.instantialize (this, arguments);
}, jsjavax.swing.tree.DefaultMutableTreeNode.BreadthFirstEnumeration.Queue, "QNode");
Clazz.makeConstructor (c$, 
function (a, b) {
this.object = a;
this.next = b;
}, "~O,jsjavax.swing.tree.DefaultMutableTreeNode.BreadthFirstEnumeration.Queue.QNode");
c$ = Clazz.p0p ();
};
c$ = Clazz.p0p ();
};
...
this.stack = null;
Clazz.instantialize (this, arguments);
}, jsjavax.swing.tree.DefaultMutableTreeNode, "PathBetweenNodesEnumeration", null, java.util.Enumeration);
Clazz.makeConstructor (c$, 
function (a, b) {
if (a == null || b == null) {
throw  new IllegalArgumentException ("argument is null");
...
}, "jsjavax.swing.tree.TreeNode,jsjavax.swing.tree.TreeNode");
Clazz.overrideMethod (c$, "hasMoreElements", 
function () {
...
Clazz.pu$h ();
c$ = Clazz.declareAnonymous (jsjavax.swing.tree, "DefaultMutableTreeNode$1", null, java.util.Enumeration);
Clazz.defineMethod (c$, "hasMoreElements", 
function () {
return false;
});
...
c$.EMPTY_ENUMERATION = c$.prototype.EMPTY_ENUMERATION = ((Clazz.isClassDefined ("jsjavax.swing.tree.DefaultMutableTreeNode$1") ? 0 : jsjavax.swing.tree.DefaultMutableTreeNode.$DefaultMutableTreeNode$1$ ()), Clazz.innerTypeInstance (jsjavax.swing.tree.DefaultMutableTreeNode$1, this, null));
});
