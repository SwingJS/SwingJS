...
Clazz.load (["jsjavax.swing.tree.TreeModel", "jsjavax.swing.event.EventListenerList"], "jsjavax.swing.tree.DefaultTreeModel", ["java.lang.IllegalArgumentException", "jsjavax.swing.event.TreeModelEvent", "$.TreeModelListener"], function () {
c$ = Clazz.decorateAsClass (function () {
this.root = null;
this.listenerList = null;
this.$asksAllowsChildren = false;
Clazz.instantialize (this, arguments);
}, jsjavax.swing.tree, "DefaultTreeModel", null, jsjavax.swing.tree.TreeModel);
...
}, "jsjavax.swing.tree.MutableTreeNode,jsjavax.swing.tree.MutableTreeNode,~N");
...
}}, "jsjavax.swing.tree.TreeNode,~A,~A");
...
function (l) {
this.listenerList.add (jsjavax.swing.event.TreeModelListener, l);
}, "jsjavax.swing.event.TreeModelListener");
Clazz.overrideMethod (c$, "removeTreeModelListener", 
function (l) {
this.listenerList.remove (jsjavax.swing.event.TreeModelListener, l);
}, "jsjavax.swing.event.TreeModelListener");
Clazz.defineMethod (c$, "getTreeModelListeners", 
function () {
return this.listenerList.getListeners (jsjavax.swing.event.TreeModelListener);
});
...
if (listeners[i] === jsjavax.swing.event.TreeModelListener) {
if (e == null) e =  new jsjavax.swing.event.TreeModelEvent (source, path, childIndices, children);
...
Clazz.defineMethod (c$, "fireTreeStructureChanged", 
($fz = function (source, path) {
var listeners = this.listenerList.getListenerList ();
var e = null;
for (var i = listeners.length - 2; i >= 0; i -= 2) {
if (listeners[i] === jsjavax.swing.event.TreeModelListener) {
if (e == null) e =  new jsjavax.swing.event.TreeModelEvent (source, path);
(listeners[i + 1]).treeStructureChanged (e);
}}
}, $fz.isPrivate = true, $fz), "~O,jsjavax.swing.tree.TreePath");
