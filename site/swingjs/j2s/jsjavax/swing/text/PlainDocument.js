...
Clazz.load (["jsjavax.swing.text.AbstractDocument", "java.util.Vector"], "jsjavax.swing.text.PlainDocument", ["java.lang.Boolean", "$.Error", "$.StringBuffer", "jsjavax.swing.text.GapContent", "$.Segment", "$.Utilities"], function () {
...
}, jsjavax.swing.text, "PlainDocument", jsjavax.swing.text.AbstractDocument);
...
function () {
this.construct ( new jsjavax.swing.text.GapContent ());
});
Clazz.makeConstructor (c$, 
function (c) {
Clazz.superConstructor (this, jsjavax.swing.text.PlainDocument, [c]);
...
}}Clazz.superCall (this, jsjavax.swing.text.PlainDocument, "insertString", [offs, str, a]);
...
try {
if (this.s == null) {
this.s =  new jsjavax.swing.text.Segment ();
...
var ee =  new jsjavax.swing.text.AbstractDocument.ElementEdit (lineMap, index, relems, aelems);
chng.addEdit (ee);
...
Clazz.superCall (this, jsjavax.swing.text.PlainDocument, "insertUpdate", [chng, attr]);
...
var relems =  new Array (this.removed.size ());
this.removed.copyInto (relems);
var ee =  new jsjavax.swing.text.AbstractDocument.ElementEdit (map, line0, relems, aelems);
chng.addEdit (ee);
...
var ee =  new jsjavax.swing.text.AbstractDocument.ElementEdit (lineMap, index, relem, abelem);
chng.addEdit (ee);
abelem[0].replace (0, 0, alelem);
lineMap.replace (index, 1, abelem);
}, $fz.isPrivate = true, $fz), "jsjavax.swing.text.AbstractDocument.DefaultDocumentEvent,jsjavax.swing.text.AttributeSet");
