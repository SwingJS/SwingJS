...
Clazz.load (["jsjavax.swing.text.View"], "jsjavax.swing.text.CompositeView", ["java.lang.IllegalArgumentException", "jsjava.awt.Rectangle", "jsjavax.swing.text.BadLocationException", "$.Position", "$.StyleConstants", "$.Utilities"], function () {
...
}, jsjavax.swing.text, "CompositeView", jsjavax.swing.text.View);
Clazz.makeConstructor (c$, 
function (elem) {
Clazz.superConstructor (this, jsjavax.swing.text.CompositeView, [elem]);
...
function (parent) {
Clazz.superCall (this, jsjavax.swing.text.CompositeView, "setParent", [parent]);
...
if (views == null) {
views = jsjavax.swing.text.CompositeView.ZERO;
...
}}throw  new jsjavax.swing.text.BadLocationException ("Position not represented by view", pos);
...
var r0 =  new jsjava.awt.Rectangle (alloc);
var v0 = this.getViewAtPosition ((b0 === jsjavax.swing.text.Position.Bias.Backward) ? Math.max (0, p0 - 1) : p0, r0);
var r1 =  new jsjava.awt.Rectangle (alloc);
var v1 = this.getViewAtPosition ((b1 === jsjavax.swing.text.Position.Bias.Backward) ? Math.max (0, p1 - 1) : p1, r1);
if (v0 === v1) {
if (v0 == null) {
return a;
...
var endView;
var retRect;
var tempRect =  new jsjava.awt.Rectangle ();
if (v === v0) {
retRect = v0.modelToView (p0, b0, v0.getEndOffset (), jsjavax.swing.text.Position.Bias.Backward, r0).getBounds ();
endView = v1;
} else {
retRect = v1.modelToView (v1.getStartOffset (), jsjavax.swing.text.Position.Bias.Forward, p1, b1, r1).getBounds ();
endView = v0;
...
var endShape;
if (endView === v1) {
endShape = v1.modelToView (v1.getStartOffset (), jsjavax.swing.text.Position.Bias.Forward, p1, b1, r1);
} else {
endShape = v0.modelToView (p0, b0, v0.getEndOffset (), jsjavax.swing.text.Position.Bias.Backward, r0);
}if (Clazz.instanceOf (endShape, jsjava.awt.Rectangle)) {
...
throw  new jsjavax.swing.text.BadLocationException ("Position not represented by view", p0);
}, "~N,jsjavax.swing.text.Position.Bias,~N,jsjavax.swing.text.Position.Bias,jsjava.awt.Shape");
...
var retValue = -1;
try {
retValue = this.getNextVisualPositionFrom (-1, jsjavax.swing.text.Position.Bias.Forward, a, 3, bias);
} catch (e$$) {
...
var retValue = -1;
try {
retValue = this.getNextVisualPositionFrom (-1, jsjavax.swing.text.Position.Bias.Forward, a, 7, bias);
} catch (e$$) {
if (Clazz.exceptionOf (e$$, jsjavax.swing.text.BadLocationException)) {
var ble = e$$;
{
...
function (pos, b) {
if (b === jsjavax.swing.text.Position.Bias.Backward) {
pos -= 1;
...
function (attr) {
this.top = Clazz.floatToShort (jsjavax.swing.text.StyleConstants.getSpaceAbove (attr));
this.left = Clazz.floatToShort (jsjavax.swing.text.StyleConstants.getLeftIndent (attr));
this.bottom = Clazz.floatToShort (jsjavax.swing.text.StyleConstants.getSpaceBelow (attr));
this.right = Clazz.floatToShort (jsjavax.swing.text.StyleConstants.getRightIndent (attr));
