...
Clazz.load (["jsjavax.swing.SwingConstants"], "jsjavax.swing.text.View", ["java.lang.IllegalArgumentException", "jsjava.awt.Rectangle", "jsjavax.swing.event.DocumentEvent", "jsjavax.swing.text.Position", "$.Utilities"], function () {
c$ = Clazz.decorateAsClass (function () {
this.parent = null;
this.elem = null;
Clazz.instantialize (this, arguments);
}, jsjavax.swing.text, "View", null, jsjavax.swing.SwingConstants);
...
pos = jsjavax.swing.text.Utilities.getPositionAbove (target, pos, x);
} else {
pos = jsjavax.swing.text.Utilities.getPositionBelow (target, pos, x);
}}break;
case 7:
if (pos == -1) {
...
s1 =  new jsjava.awt.Rectangle (alloc.x + alloc.width - 1, alloc.y, 1, alloc.height);
}} else {
s1 = this.modelToView (p1, a, b1);
}var r0 = s0.getBounds ();
var r1 = (Clazz.instanceOf (s1, jsjava.awt.Rectangle)) ? s1 : s1.getBounds ();
if (r0.y != r1.y) {
var alloc = (Clazz.instanceOf (a, jsjava.awt.Rectangle)) ? a : a.getBounds ();
r0.x = alloc.x;
...
var rect = (Clazz.instanceOf (allocation, jsjava.awt.Rectangle)) ? allocation : allocation.getBounds ();
...
var rect = (Clazz.instanceOf (childAllocation, jsjava.awt.Rectangle)) ? childAllocation : childAllocation.getBounds ();
if (rect.contains (x, y)) {
return counter;
}}}
return -1;
...
var elem = this.getElement ();
var pos = e.getOffset ();
var index0 = this.getViewIndex (pos, jsjavax.swing.text.Position.Bias.Forward);
if (index0 == -1 && e.getType () === jsjavax.swing.event.DocumentEvent.EventType.REMOVE && pos >= this.getEndOffset ()) {
...
}}if (e.getType () !== jsjavax.swing.event.DocumentEvent.EventType.REMOVE) {
index1 = this.getViewIndex (pos + e.getLength (), jsjavax.swing.text.Position.Bias.Forward);
if (index1 < 0) {
...
function (v, e, a, f) {
var type = e.getType ();
if (type === jsjavax.swing.event.DocumentEvent.EventType.INSERT) {
v.insertUpdate (e, a, f);
} else if (type === jsjavax.swing.event.DocumentEvent.EventType.REMOVE) {
...
Clazz.defineMethod (c$, "modelToView", 
function (pos, a) {
return this.modelToView (pos, a, jsjavax.swing.text.Position.Bias.Forward);
}, "~N,jsjava.awt.Shape");
Clazz.defineMethod (c$, "viewToModel", 
function (x, y, a) {
jsjavax.swing.text.View.sharedBiasReturn[0] = jsjavax.swing.text.Position.Bias.Forward;
return this.viewToModel (x, y, a, jsjavax.swing.text.View.sharedBiasReturn);
}, "~N,~N,jsjava.awt.Shape");
