...
Clazz.load (["jsjavax.swing.text.TabExpander", "$.View"], "jsjavax.swing.text.PlainView", ["java.lang.IllegalArgumentException", "jsjava.awt.Rectangle", "jsjavax.swing.event.DocumentEvent", "jsjavax.swing.text.Position", "$.Segment", "$.SegmentCache", "$.Utilities"], function () {
...
}, jsjavax.swing.text, "PlainView", jsjavax.swing.text.View, jsjavax.swing.text.TabExpander);
...
var s = jsjavax.swing.text.SegmentCache.getSharedSegment ();
doc.getText (p0, pos - p0, s);
var xOffs = jsjavax.swing.text.Utilities.getTabbedTextWidth (s, this.metrics, this.tabBase, this, p0);
...
var offs = p0 + jsjavax.swing.text.Utilities.getTabbedTextOffset (s, this.metrics, this.tabBase, x, this, p0);
jsjavax.swing.text.SegmentCache.releaseSharedSegment (s);
return offs;
} catch (e) {
...
Clazz.superCall (this, jsjavax.swing.text.PlainView, "setSize", [width, height]);
this.updateMetrics ();
}, "~N,~N");
...
if (changes.getType () === jsjavax.swing.event.DocumentEvent.EventType.INSERT) {
...
this.longLine = e;
this.preferenceChanged (null, true, false);
}} else if (changes.getType () === jsjavax.swing.event.DocumentEvent.EventType.REMOVE) {
...
host.repaint ();
}}}, "~N,~N,jsjava.awt.Shape,jsjava.awt.Component");
...
alloc.x += this.firstLineOffset;
alloc.width -= this.firstLineOffset;
}r =  new jsjava.awt.Rectangle (alloc.x, alloc.y + (line * this.metrics.getHeight ()), alloc.width, this.metrics.getHeight ());
}return r;
}, "jsjava.awt.Shape,~N");
...
w = jsjavax.swing.text.Utilities.getTabbedTextWidth (s, this.metrics, this.tabBase, this, p0);
} catch (ble) {
