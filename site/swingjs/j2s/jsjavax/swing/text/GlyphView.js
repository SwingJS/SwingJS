...
Clazz.load (["jsjavax.swing.text.TabableView", "$.View"], "jsjavax.swing.text.GlyphView", ["java.lang.Boolean", "$.Character", "$.IllegalArgumentException", "java.util.BitSet", "jsjava.awt.Rectangle", "jsjavax.swing.text.AbstractDocument", "$.JTextComponent", "$.Position", "$.SegmentCache", "$.StateInvariantError", "$.StyleConstants", "$.StyledDocument"], function () {
...
}, jsjavax.swing.text, "GlyphView", jsjavax.swing.text.View, [jsjavax.swing.text.TabableView, Cloneable]);
Clazz.makeConstructor (c$, 
function (elem) {
Clazz.superConstructor (this, jsjavax.swing.text.GlyphView, [elem]);
this.offset = 0;
this.length = 0;
...
var o;
try {
o = Clazz.superCall (this, jsjavax.swing.text.GlyphView, "clone", []);
} catch (cnse) {
...
function (p) {
this.painter = p;
}, "jsjavax.swing.text.GlyphView.GlyphPainter");
Clazz.defineMethod (c$, "getText", 
function (p0, p1) {
var text = jsjavax.swing.text.SegmentCache.getSharedSegment ();
try {
var doc = this.getDocument ();
doc.getText (p0, p1 - p0, text);
} catch (bl) {
if (Clazz.exceptionOf (bl, jsjavax.swing.text.BadLocationException)) {
throw  new jsjavax.swing.text.StateInvariantError ("GlyphView: Stale view: " + bl);
} else {
throw bl;
}
}
...
function () {
var attr = this.getAttributes ();
return jsjavax.swing.text.StyleConstants.isUnderline (attr);
});
Clazz.defineMethod (c$, "isStrikeThrough", 
function () {
var attr = this.getAttributes ();
return jsjavax.swing.text.StyleConstants.isStrikeThrough (attr);
});
Clazz.defineMethod (c$, "isSubscript", 
function () {
var attr = this.getAttributes ();
return jsjavax.swing.text.StyleConstants.isSubscript (attr);
});
Clazz.defineMethod (c$, "isSuperscript", 
function () {
var attr = this.getAttributes ();
return jsjavax.swing.text.StyleConstants.isSuperscript (attr);
});
...
if (jsjavax.swing.text.GlyphView.defaultPainter == null) {
var classname = "jsjavax.swing.text.GlyphPainter1";
try {
var c;
...
if (Clazz.instanceOf (o, jsjavax.swing.text.GlyphView.GlyphPainter)) {
jsjavax.swing.text.GlyphView.defaultPainter = o;
}} catch (e) {
throw  new jsjavax.swing.text.StateInvariantError ("GlyphView: Can't load glyph painter: " + classname);
}
}this.setGlyphPainter (jsjavax.swing.text.GlyphView.defaultPainter.getPainter (this, this.getStartOffset (), this.getEndOffset ()));
}});
...
return width;
}, "~N,jsjavax.swing.text.TabExpander");
...
g.drawLine (x0, yTmp, x1, yTmp);
}}}, "jsjava.awt.Graphics,jsjava.awt.Shape,jsjava.awt.Color,~N,~N");
...
}return Clazz.superCall (this, jsjavax.swing.text.GlyphView, "getAlignment", [axis]);
}, "~N");
...
return 999;
}}return Clazz.superCall (this, jsjavax.swing.text.GlyphView, "getBreakWeight", [axis, pos, len]);
}, "~N,~N,~N");
...
($fz = function (p0, p1) {
var doc = this.getDocument ();
if (doc != null && Boolean.TRUE.equals (doc.getProperty (jsjavax.swing.text.AbstractDocument.MultiByteProperty))) {
...
}this.justificationInfo =  new jsjavax.swing.text.GlyphView.JustificationInfo (startJustifiableContent, endJustifiableContent, leadingSpaces, contentSpaces, trailingSpaces, hasTab, spaceMap);
return this.justificationInfo;
}, "~N");
Clazz.pu$h ();
c$ = Clazz.decorateAsClass (function () {
...
this.spaceMap = null;
Clazz.instantialize (this, arguments);
}, jsjavax.swing.text.GlyphView, "JustificationInfo");
Clazz.makeConstructor (c$, 
...
c$ = Clazz.p0p ();
Clazz.pu$h ();
c$ = Clazz.declareType (jsjavax.swing.text.GlyphView, "GlyphPainter");
Clazz.defineMethod (c$, "getPainter", 
function (a, b, c) {
return this;
}, "jsjavax.swing.text.GlyphView,~N,~N");
...
if (Clazz.instanceOf (i, jsjavax.swing.text.JTextComponent)) {
var j = (i).getCaret ();
var k;
...
return b;
}, "jsjavax.swing.text.GlyphView,~N,jsjavax.swing.text.Position.Bias,jsjava.awt.Shape,~N,~A");
c$ = Clazz.p0p ();
