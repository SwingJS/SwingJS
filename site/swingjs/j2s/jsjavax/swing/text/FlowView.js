...
Clazz.load (["jsjavax.swing.text.BoxView", "$.CompositeView"], "jsjavax.swing.text.FlowView", ["java.util.Vector", "jsjavax.swing.SizeRequirements", "jsjavax.swing.text.ComponentView", "$.LabelView", "$.Position", "$.TabExpander", "$.TabableView"], function () {
c$ = Clazz.decorateAsClass (function () {
this.layoutSpan = 0;
this.layoutPool = null;
this.strategy = null;
Clazz.instantialize (this, arguments);
}, jsjavax.swing.text, "FlowView", jsjavax.swing.text.BoxView);
Clazz.makeConstructor (c$, 
function (elem, axis) {
Clazz.superConstructor (this, jsjavax.swing.text.FlowView, [elem, axis]);
this.layoutSpan = 2147483647;
this.strategy =  new jsjavax.swing.text.FlowView.FlowStrategy ();
...
this.layoutPool =  new jsjavax.swing.text.FlowView.LogicalView (this.getElement ());
...
if (host != null) {
host.repaint ();
}}}Clazz.superCall (this, jsjavax.swing.text.FlowView, "layout", [width, height]);
}, "~N,~N");
...
function (parent) {
Clazz.superCall (this, jsjavax.swing.text.FlowView, "setParent", [parent]);
...
var h = (Clazz.instanceOf (a, jsjavax.swing.text.TabExpander)) ? a : null;
var i = a.getFlowAxis ();
var j = 0;
var k = 0;
var l = 0;
...
if (i == 0 && Clazz.instanceOf (o, jsjavax.swing.text.TabableView)) {
...
function (a, b) {
var c = a.getViewIndex (b, jsjavax.swing.text.Position.Bias.Forward);
if (c >= 0) {
for (var d = c; d < a.getViewCount (); d++) {
a.getView (d).setParent (a);
}
}}, "jsjavax.swing.text.View,~N");
Clazz.defineMethod (c$, "createView", 
function (a, b, c, d) {
var e = this.getLogicalView (a);
var f = e.getViewIndex (b, jsjavax.swing.text.Position.Bias.Forward);
var g = e.getView (f);
...
c$ = Clazz.p0p ();
Clazz.pu$h ();
c$ = Clazz.declareType (jsjavax.swing.text.FlowView, "LogicalView", jsjavax.swing.text.CompositeView);
Clazz.defineMethod (c$, "getViewIndexAtPosition", 
function (a) {
var b = this.getElement ();
if (b.isLeaf ()) {
return 0;
}return Clazz.superCall (this, jsjavax.swing.text.FlowView.LogicalView, "getViewIndexAtPosition", [a]);
}, "~N");
Clazz.defineMethod (c$, "loadChildren", 
function (a) {
var b = this.getElement ();
if (b.isLeaf ()) {
var c =  new jsjavax.swing.text.LabelView (b);
this.append (c);
} else {
Clazz.superCall (this, jsjavax.swing.text.FlowView.LogicalView, "loadChildren", [a]);
}}, "jsjavax.swing.text.ViewFactory");
...
d = false;
c = 0;
}if (Clazz.instanceOf (g, jsjavax.swing.text.ComponentView)) {
...
var e = a.getParent ();
a.setParent (this);
Clazz.superCall (this, jsjavax.swing.text.FlowView.LogicalView, "forwardUpdateToView", [a, b, c, d]);
a.setParent (e);
