...
Clazz.load (null, "jsjavax.swing.text.Utilities", ["jsjavax.swing.JComponent", "jsjavax.swing.text.CompositeView", "$.Position", "$.StyleConstants", "$.StyledDocument"], function () {
c$ = Clazz.declareType (jsjavax.swing.text, "Utilities");
...
return jsjavax.swing.text.Utilities.getTabbedTextWidth (null, s, metrics, x, e, startOffset, null);
}, "jsjavax.swing.text.Segment,jsjava.awt.FontMetrics,~N,jsjavax.swing.text.TabExpander,~N");
c$.getTabbedTextWidth = Clazz.defineMethod (c$, "getTabbedTextWidth", 
...
return nextX - x;
}, "jsjavax.swing.text.View,jsjavax.swing.text.Segment,jsjava.awt.FontMetrics,~N,jsjavax.swing.text.TabExpander,~N,~A");
c$.getTabbedTextOffset = Clazz.defineMethod (c$, "getTabbedTextOffset", 
function (s, metrics, x0, x, e, startOffset) {
return jsjavax.swing.text.Utilities.getTabbedTextOffset (s, metrics, x0, x, e, startOffset, true);
}, "jsjavax.swing.text.Segment,jsjava.awt.FontMetrics,~N,~N,jsjavax.swing.text.TabExpander,~N");
c$.getTabbedTextOffset = Clazz.defineMethod (c$, "getTabbedTextOffset", 
function (view, s, metrics, x0, x, e, startOffset, justificationData) {
return jsjavax.swing.text.Utilities.getTabbedTextOffset (view, s, metrics, x0, x, e, startOffset, true, justificationData);
}, "jsjavax.swing.text.View,jsjavax.swing.text.Segment,jsjava.awt.FontMetrics,~N,~N,jsjavax.swing.text.TabExpander,~N,~A");
c$.getTabbedTextOffset = Clazz.defineMethod (c$, "getTabbedTextOffset", 
function (s, metrics, x0, x, e, startOffset, round) {
return jsjavax.swing.text.Utilities.getTabbedTextOffset (null, s, metrics, x0, x, e, startOffset, round, null);
}, "jsjavax.swing.text.Segment,jsjava.awt.FontMetrics,~N,~N,jsjavax.swing.text.TabExpander,~N,~B");
c$.getTabbedTextOffset = Clazz.defineMethod (c$, "getTabbedTextOffset", 
...
return txtCount;
}, "jsjavax.swing.text.View,jsjavax.swing.text.Segment,jsjava.awt.FontMetrics,~N,~N,jsjavax.swing.text.TabExpander,~N,~B,~A");
...
return offs;
}, "jsjavax.swing.text.JTextComponent,~N");
...
function (c, offs, x) {
var lastOffs = jsjavax.swing.text.Utilities.getRowStart (c, offs) - 1;
if (lastOffs < 0) {
return -1;
...
return offs;
}, "jsjavax.swing.text.JTextComponent,~N,~N");
c$.getPositionBelow = Clazz.defineMethod (c$, "getPositionBelow", 
function (c, offs, x) {
var lastOffs = jsjavax.swing.text.Utilities.getRowEnd (c, offs) + 1;
if (lastOffs <= 0) {
return -1;
}var bestSpan = 2147483647;
var n = c.getDocument ().getLength ();
...
function (c, offs) {
var nextWord;
var line = jsjavax.swing.text.Utilities.getParagraphElement (c, offs);
for (nextWord = jsjavax.swing.text.Utilities.getNextWordInParagraph (c, line, offs, false); nextWord == -1; nextWord = jsjavax.swing.text.Utilities.getNextWordInParagraph (c, line, offs, true)) {
offs = line.getEndOffset ();
line = jsjavax.swing.text.Utilities.getParagraphElement (c, offs);
}
return nextWord;
}, "jsjavax.swing.text.JTextComponent,~N");
...
return 0;
}, "jsjavax.swing.text.JTextComponent,jsjavax.swing.text.Element,~N,~B");
c$.getPreviousWord = Clazz.defineMethod (c$, "getPreviousWord", 
function (c, offs) {
var prevWord;
var line = jsjavax.swing.text.Utilities.getParagraphElement (c, offs);
for (prevWord = jsjavax.swing.text.Utilities.getPrevWordInParagraph (c, line, offs); prevWord == -1; prevWord = jsjavax.swing.text.Utilities.getPrevWordInParagraph (c, line, offs)) {
...
return 0;
}, "jsjavax.swing.text.JTextComponent,jsjavax.swing.text.Element,~N");
...
return jsjavax.swing.text.Utilities.isComposedTextElement (elem);
}, "jsjavax.swing.text.Document,~N");
c$.isComposedTextElement = Clazz.defineMethod (c$, "isComposedTextElement", 
function (elem) {
var as = elem.getAttributes ();
return jsjavax.swing.text.Utilities.isComposedTextAttributeDefined (as);
}, "jsjavax.swing.text.Element");
c$.isComposedTextAttributeDefined = Clazz.defineMethod (c$, "isComposedTextAttributeDefined", 
function (as) {
return ((as != null) && (as.isDefined (jsjavax.swing.text.StyleConstants.ComposedTextAttribute)));
...
childIndex = v.getViewIndex (pos - 1, jsjavax.swing.text.Position.Bias.Forward);
} else {
childIndex = v.getViewIndex (pos, jsjavax.swing.text.Position.Bias.Forward);
}var child = v.getView (childIndex);
var childBounds = v.getChildAllocation (childIndex, alloc);
retValue = child.getNextVisualPositionFrom (pos, b, childBounds, direction, biasRet);
if ((direction == 3 || direction == 7) && (Clazz.instanceOf (v, jsjavax.swing.text.CompositeView)) && (v).flipEastAndWestAtEnds (pos, b)) {
increment *= -1;
...
return jsjavax.swing.text.Utilities.getNextVisualPositionFrom (v, pos, biasRet[0], alloc, direction, biasRet);
...
}, "jsjavax.swing.text.View,~N,jsjavax.swing.text.Position.Bias,jsjava.awt.Shape,~N,~A");
});
