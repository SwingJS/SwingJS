...
Clazz.load (["java.lang.ref.WeakReference", "jsjavax.swing.text.AbstractDocument", "$.GapVector", "$.Position", "jsjavax.swing.undo.AbstractUndoableEdit"], "jsjavax.swing.text.GapContent", ["java.lang.ref.ReferenceQueue", "java.util.Vector", "jsjavax.swing.text.BadLocationException", "$.Segment", "jsjavax.swing.undo.CannotRedoException", "$.CannotUndoException"], function () {
c$ = Clazz.decorateAsClass (function () {
if (!Clazz.isClassDefined ("jsjavax.swing.text.GapContent.MarkData")) {
jsjavax.swing.text.GapContent.$GapContent$MarkData$ ();
}
if (!Clazz.isClassDefined ("jsjavax.swing.text.GapContent.StickyPosition")) {
jsjavax.swing.text.GapContent.$GapContent$StickyPosition$ ();
}
this.marks = null;
this.search = null;
this.unusedMarks = 0;
this.queue = null;
if (!Clazz.isClassDefined ("jsjavax.swing.text.GapContent.UndoPosRef")) {
jsjavax.swing.text.GapContent.$GapContent$UndoPosRef$ ();
}
if (!Clazz.isClassDefined ("jsjavax.swing.text.GapContent.InsertUndo")) {
jsjavax.swing.text.GapContent.$GapContent$InsertUndo$ ();
}
if (!Clazz.isClassDefined ("jsjavax.swing.text.GapContent.RemoveUndo")) {
jsjavax.swing.text.GapContent.$GapContent$RemoveUndo$ ();
}
Clazz.instantialize (this, arguments);
}, jsjavax.swing.text, "GapContent", jsjavax.swing.text.GapVector, jsjavax.swing.text.AbstractDocument.Content);
...
Clazz.superConstructor (this, jsjavax.swing.text.GapContent, [Math.max (initialLength, 2)]);
var implied =  Clazz.newCharArray (1, '\0');
implied[0] = '\n';
this.replace (0, 0, implied, implied.length);
this.marks =  new jsjavax.swing.text.GapContent.MarkVector ();
this.search = Clazz.innerTypeInstance (jsjavax.swing.text.GapContent.MarkData, this, null, 0);
...
throw  new jsjavax.swing.text.BadLocationException ("Invalid insert", this.length ());
}var chars = str.toCharArray ();
this.replace (where, 0, chars, chars.length);
return Clazz.innerTypeInstance (jsjavax.swing.text.GapContent.InsertUndo, this, null, where, str.length);
}, "~N,~S");
Clazz.overrideMethod (c$, "remove", 
function (where, nitems) {
if (where + nitems >= this.length ()) {
throw  new jsjavax.swing.text.BadLocationException ("Invalid remove", this.length () + 1);
}var removedString = this.getString (where, nitems);
var edit = Clazz.innerTypeInstance (jsjavax.swing.text.GapContent.RemoveUndo, this, null, where, removedString);
this.replace (where, nitems, jsjavax.swing.text.GapContent.empty, 0);
return edit;
}, "~N,~N");
...
var end = where + len;
if (where < 0 || end < 0) {
throw  new jsjavax.swing.text.BadLocationException ("Invalid location", -1);
}if (end > this.length () || where > this.length ()) {
throw  new jsjavax.swing.text.BadLocationException ("Invalid location", this.length () + 1);
...
if (this.unusedMarks > Math.max (5, (Clazz.doubleToInt (this.marks.size () / 10)))) {
...
position = Clazz.innerTypeInstance (jsjavax.swing.text.GapContent.StickyPosition, this, null);
m = Clazz.innerTypeInstance (jsjavax.swing.text.GapContent.MarkData, this, null, index, position, this.queue);
position.setMark (m);
...
Clazz.superCall (this, jsjavax.swing.text.GapContent, "shiftEnd", [newSize]);
...
function (reqSize) {
if (reqSize < 524288) {
return Clazz.superCall (this, jsjavax.swing.text.GapContent, "getNewArraySize", [reqSize]);
} else {
...
Clazz.superCall (this, jsjavax.swing.text.GapContent, "shiftGap", [newGapStart]);
if (dg > 0) {
...
Clazz.superCall (this, jsjavax.swing.text.GapContent, "shiftGapStartDown", [newGapStart]);
this.resetMarksAtZero ();
}, "~N");
...
Clazz.superCall (this, jsjavax.swing.text.GapContent, "shiftGapEndUp", [newGapEnd]);
this.resetMarksAtZero ();
}, "~N");
...
return 0;
}}, "jsjavax.swing.text.GapContent.MarkData,jsjavax.swing.text.GapContent.MarkData");
...
}, "jsjavax.swing.text.GapContent.MarkData");
Clazz.defineMethod (c$, "removeUnusedMarks", 
function () {
var n = this.marks.size ();
var cleaned =  new jsjavax.swing.text.GapContent.MarkVector (n);
for (var i = 0; i < n; i++) {
var mark = this.marks.elementAt (i);
if (mark.get () != null) {
...
placeIn.addElement (Clazz.innerTypeInstance (jsjavax.swing.text.GapContent.UndoPosRef, this, null, this.marks.elementAt (counter)));
}
return placeIn;
...
this.index = 0;
Clazz.instantialize (this, arguments);
}, jsjavax.swing.text.GapContent, "MarkData", java.lang.ref.WeakReference);
Clazz.makeConstructor (c$, 
function (a) {
Clazz.superConstructor (this, jsjavax.swing.text.GapContent.MarkData, [null]);
this.index = a;
}, "~N");
Clazz.makeConstructor (c$, 
function (a, b, c) {
Clazz.superConstructor (this, jsjavax.swing.text.GapContent.MarkData, [b, c]);
this.index = a;
}, "~N,jsjavax.swing.text.GapContent.StickyPosition,java.lang.ref.ReferenceQueue");
Clazz.defineMethod (c$, "getOffset", 
function () {
var a = this.b$["jsjavax.swing.text.GapContent"].getGapStart ();
var b = this.b$["jsjavax.swing.text.GapContent"].getGapEnd ();
...
this.mark = null;
Clazz.instantialize (this, arguments);
}, jsjavax.swing.text.GapContent, "StickyPosition", null, jsjavax.swing.text.Position);
Clazz.makeConstructor (c$, 
function () {
});
...
this.rec = null;
Clazz.instantialize (this, arguments);
}, jsjavax.swing.text.GapContent, "UndoPosRef");
Clazz.makeConstructor (c$, 
function (a) {
this.rec = a;
...
this.posRefs = null;
Clazz.instantialize (this, arguments);
}, jsjavax.swing.text.GapContent, "InsertUndo", jsjavax.swing.undo.AbstractUndoableEdit);
Clazz.makeConstructor (c$, 
function (a, b) {
Clazz.superConstructor (this, jsjavax.swing.text.GapContent.InsertUndo);
this.offset = a;
this.length = b;
}, "~N,~N");
Clazz.defineMethod (c$, "undo", 
function () {
Clazz.superCall (this, jsjavax.swing.text.GapContent.InsertUndo, "undo", []);
try {
this.posRefs = this.b$["jsjavax.swing.text.GapContent"].getPositionsInRange (null, this.offset, this.length);
this.string = this.b$["jsjavax.swing.text.GapContent"].getString (this.offset, this.length);
this.b$["jsjavax.swing.text.GapContent"].remove (this.offset, this.length);
} catch (bl) {
...
function () {
Clazz.superCall (this, jsjavax.swing.text.GapContent.InsertUndo, "redo", []);
try {
this.b$["jsjavax.swing.text.GapContent"].insertString (this.offset, this.string);
this.string = null;
if (this.posRefs != null) {
this.b$["jsjavax.swing.text.GapContent"].updateUndoPositions (this.posRefs, this.offset, this.length);
this.posRefs = null;
}} catch (bl) {
if (Clazz.exceptionOf (bl, jsjavax.swing.text.BadLocationException)) {
...
this.posRefs = null;
Clazz.instantialize (this, arguments);
}, jsjavax.swing.text.GapContent, "RemoveUndo", jsjavax.swing.undo.AbstractUndoableEdit);
Clazz.makeConstructor (c$, 
function (a, b) {
Clazz.superConstructor (this, jsjavax.swing.text.GapContent.RemoveUndo);
this.offset = a;
this.string = b;
this.length = b.length;
this.posRefs = this.b$["jsjavax.swing.text.GapContent"].getPositionsInRange (null, a, this.length);
}, "~N,~S");
Clazz.defineMethod (c$, "undo", 
function () {
Clazz.superCall (this, jsjavax.swing.text.GapContent.RemoveUndo, "undo", []);
try {
this.b$["jsjavax.swing.text.GapContent"].insertString (this.offset, this.string);
if (this.posRefs != null) {
this.b$["jsjavax.swing.text.GapContent"].updateUndoPositions (this.posRefs, this.offset, this.length);
...
Clazz.defineMethod (c$, "redo", 
function () {
Clazz.superCall (this, jsjavax.swing.text.GapContent.RemoveUndo, "redo", []);
try {
this.string = this.b$["jsjavax.swing.text.GapContent"].getString (this.offset, this.length);
this.posRefs = this.b$["jsjavax.swing.text.GapContent"].getPositionsInRange (null, this.offset, this.length);
this.b$["jsjavax.swing.text.GapContent"].remove (this.offset, this.length);
...
this.oneMark = null;
Clazz.instantialize (this, arguments);
}, jsjavax.swing.text.GapContent, "MarkVector", jsjavax.swing.text.GapVector);
...
}, "jsjavax.swing.text.GapContent.MarkData,~N");
