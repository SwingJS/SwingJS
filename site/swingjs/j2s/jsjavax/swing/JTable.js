...
Clazz.load (["java.lang.Enum", "jsjavax.swing.DefaultCellEditor", "$.JCheckBox", "$.JComponent", "$.Scrollable", "jsjavax.swing.event.CellEditorListener", "$.ListSelectionListener", "$.RowSorterListener", "$.TableColumnModelListener", "$.TableModelListener", "jsjavax.swing.plaf.UIResource", "jsjavax.swing.table.DefaultTableCellRenderer", "$.TableCellRenderer", "jsjavax.swing.DropMode", "jsjavax.swing.border.EmptyBorder"], "jsjavax.swing.JTable", ["java.lang.Boolean", "$.Double", "$.Float", "$.IllegalArgumentException", "$.Number", "java.util.Date", "jsjava.awt.Color", "$.Dimension", "$.Point", "$.Rectangle", "jsjava.awt.event.MouseEvent", "jsjava.text.NumberFormat", "jsjavax.swing.DefaultListSelectionModel", "$.Icon", "$.ImageIcon", "$.JScrollPane", "$.JTextField", "$.JViewport", "$.SizeSequence", "$.SwingUtilities", "$.UIDefaults", "$.UIManager", "jsjavax.swing.border.LineBorder", "jsjavax.swing.event.RowSorterEvent", "$.TableModelEvent", "jsjavax.swing.table.AbstractTableModel", "$.DefaultTableColumnModel", "$.DefaultTableModel", "$.JTableHeader", "$.TableColumn", "$.TableRowSorter", "jssun.swing.SwingUtilities2"], function () {
...
this.dropMode = null;
if (!Clazz.isClassDefined ("jsjavax.swing.JTable.SortManager")) {
jsjavax.swing.JTable.$JTable$SortManager$ ();
}
if (!Clazz.isClassDefined ("jsjavax.swing.JTable.ModelChange")) {
jsjavax.swing.JTable.$JTable$ModelChange$ ();
}
Clazz.instantialize (this, arguments);
}, jsjavax.swing, "JTable", jsjavax.swing.JComponent, [jsjavax.swing.event.TableModelListener, jsjavax.swing.Scrollable, jsjavax.swing.event.TableColumnModelListener, jsjavax.swing.event.ListSelectionListener, jsjavax.swing.event.CellEditorListener, jsjavax.swing.event.RowSorterListener]);
...
}, "jsjavax.swing.table.TableModel,jsjavax.swing.table.TableColumnModel");
Clazz.makeConstructor (c$, 
function (dm, cm, sm) {
Clazz.superConstructor (this, jsjavax.swing.JTable);
this.setLayout (null);
if (cm == null) {
...
this.updateUI ();
}, "jsjavax.swing.table.TableModel,jsjavax.swing.table.TableColumnModel,jsjavax.swing.ListSelectionModel");
Clazz.makeConstructor (c$, 
function (numRows, numColumns) {
this.construct ( new jsjavax.swing.table.DefaultTableModel (numRows, numColumns));
}, "~N,~N");
Clazz.makeConstructor (c$, 
function (rowData, columnNames) {
this.construct ( new jsjavax.swing.table.DefaultTableModel (rowData, columnNames));
}, "java.util.Vector,java.util.Vector");
Clazz.makeConstructor (c$, 
function (rowData, columnNames) {
this.construct (((Clazz.isClassDefined ("jsjavax.swing.JTable$1") ? 0 : jsjavax.swing.JTable.$JTable$1$ ()), Clazz.innerTypeInstance (jsjavax.swing.JTable$1, this, Clazz.cloneFinals ("columnNames", columnNames, "rowData", rowData))));
}, "~A,~A");
Clazz.defineMethod (c$, "addNotify", 
function () {
Clazz.superCall (this, jsjavax.swing.JTable, "addNotify", []);
this.configureEnclosingScrollPane ();
});
Clazz.defineMethod (c$, "configureEnclosingScrollPane", 
function () {
var p = this.getParent ();
if (Clazz.instanceOf (p, jsjavax.swing.JViewport)) {
var gp = p.getParent ();
if (Clazz.instanceOf (gp, jsjavax.swing.JScrollPane)) {
var scrollPane = gp;
...
if (border == null || Clazz.instanceOf (border, jsjavax.swing.plaf.UIResource)) {
var scrollPaneBorder = jsjavax.swing.UIManager.getBorder ("Table.scrollPaneBorder");
if (scrollPaneBorder != null) {
scrollPane.setBorder (scrollPaneBorder);
}}var corner = scrollPane.getCorner ("UPPER_TRAILING_CORNER");
if (corner == null || Clazz.instanceOf (corner, jsjavax.swing.plaf.UIResource)) {
corner = null;
try {
corner = jsjavax.swing.UIManager.get ("Table.scrollPaneCornerComponent");
} catch (e) {
...
var corner = scrollPane.getCorner ("UPPER_TRAILING_CORNER");
if (Clazz.instanceOf (corner, jsjavax.swing.plaf.UIResource)) {
...
}Clazz.superCall (this, jsjavax.swing.JTable, "setUIProperty", [propertyName, value]);
}, "~S,~O");
c$.createScrollPaneForTable = Clazz.defineMethod (c$, "createScrollPaneForTable", 
function (aTable) {
return  new jsjavax.swing.JScrollPane (aTable);
...
}}, "jsjavax.swing.table.JTableHeader");
...
this.rowModel =  new jsjavax.swing.SizeSequence (this.getRowCount (), this.getRowHeight ());
...
function () {
return  new jsjava.awt.Dimension (this.getColumnModel ().getColumnMargin (), this.rowMargin);
});
...
var newColumn =  new jsjavax.swing.table.TableColumn (i);
...
}}, "Class,jsjavax.swing.table.TableCellRenderer");
...
}}, "Class,jsjavax.swing.table.TableCellEditor");
...
case jsjavax.swing.DropMode.ON:
case jsjavax.swing.DropMode.INSERT:
case jsjavax.swing.DropMode.INSERT_ROWS:
case jsjavax.swing.DropMode.INSERT_COLS:
case jsjavax.swing.DropMode.ON_OR_INSERT:
case jsjavax.swing.DropMode.ON_OR_INSERT_ROWS:
case jsjavax.swing.DropMode.ON_OR_INSERT_COLS:
...
this.setRowSorter ( new jsjavax.swing.table.TableRowSorter (this.getModel ()));
...
if (sorter != null) {
this.sortManager = Clazz.innerTypeInstance (jsjavax.swing.JTable.SortManager, this, null, sorter);
}this.resizeAndRepaint ();
...
jssun.swing.SwingUtilities2.setLeadAnchorWithoutSelection (selModel, oldLead, oldAnchor);
...
($fz = function (sm, index, toggle, extend, selected, anchor, anchorSelected) {
if (extend) {
if (toggle) {
if (anchorSelected) {
...
}}}, $fz.isPrivate = true, $fz), "jsjavax.swing.ListSelectionModel,~N,~B,~B,~B,~N,~B");
...
r.setBounds (r.x + Clazz.doubleToInt (cm / 2), r.y + Clazz.doubleToInt (rm / 2), r.width - cm, r.height - rm);
}return r;
}, "~N,~N,~B");
...
return -1;
}, $fz.isPrivate = true, $fz), "jsjavax.swing.table.TableColumn");
...
}Clazz.superCall (this, jsjavax.swing.JTable, "doLayout", []);
});
...
var r = ((Clazz.isClassDefined ("jsjavax.swing.JTable$2") ? 0 : jsjavax.swing.JTable.$JTable$2$ ()), Clazz.innerTypeInstance (jsjavax.swing.JTable$2, this, Clazz.cloneFinals ("cm", cm, "inverse", inverse)));
this.adjustSizes (target, r, inverse);
}, $fz.isPrivate = true, $fz), "~B");
Clazz.defineMethod (c$, "accommodateDelta", 
($fz = function (resizingColumnIndex, delta) {
...
var end = to;
var cm = this.columnModel;
var r = ((Clazz.isClassDefined ("jsjavax.swing.JTable$3") ? 0 : jsjavax.swing.JTable.$JTable$3$ ()), Clazz.innerTypeInstance (jsjavax.swing.JTable$3, this, Clazz.cloneFinals ("end", end, "start", start, "cm", cm)));
var totalWidth = 0;
...
s = ((Clazz.isClassDefined ("jsjavax.swing.JTable$4") ? 0 : jsjavax.swing.JTable.$JTable$4$ ()), Clazz.innerTypeInstance (jsjavax.swing.JTable$4, this, Clazz.cloneFinals ("r", r)));
} else {
s = ((Clazz.isClassDefined ("jsjavax.swing.JTable$5") ? 0 : jsjavax.swing.JTable.$JTable$5$ ()), Clazz.innerTypeInstance (jsjavax.swing.JTable$5, this, Clazz.cloneFinals ("r", r)));
}this.adjustSizes (target, s, !inverse);
}, $fz.isPrivate = true, $fz), "~N,jsjavax.swing.JTable.Resizable3,~B");
Clazz.defineMethod (c$, "adjustSizes", 
($fz = function (target, r, limitToRange) {
...
}, $fz.isPrivate = true, $fz), "~N,jsjavax.swing.JTable.Resizable2,~B");
...
var newEvent =  new jsjava.awt.event.MouseEvent (component, event.getID (), event.getWhen (), event.getModifiers (), p.x, p.y, event.getXOnScreen (), event.getYOnScreen (), event.getClickCount (), event.isPopupTrigger (), 0);
...
function (ui) {
if (this.ui !== ui) {
Clazz.superCall (this, jsjavax.swing.JTable, "setUI", [ui]);
this.repaint ();
}}, "jsjavax.swing.plaf.TableUI");
Clazz.overrideMethod (c$, "updateUI", 
function () {
var cm = this.getColumnModel ();
for (var column = 0; column < cm.getColumnCount (); column++) {
var aColumn = cm.getColumn (column);
jsjavax.swing.SwingUtilities.updateRendererOrEditorUI (aColumn.getCellRenderer ());
jsjavax.swing.SwingUtilities.updateRendererOrEditorUI (aColumn.getCellEditor ());
jsjavax.swing.SwingUtilities.updateRendererOrEditorUI (aColumn.getHeaderRenderer ());
}
var defaultRenderers = this.defaultRenderersByColumnClass.elements ();
while (defaultRenderers.hasMoreElements ()) {
jsjavax.swing.SwingUtilities.updateRendererOrEditorUI (defaultRenderers.nextElement ());
}
var defaultEditors = this.defaultEditorsByColumnClass.elements ();
while (defaultEditors.hasMoreElements ()) {
jsjavax.swing.SwingUtilities.updateRendererOrEditorUI (defaultEditors.nextElement ());
}
...
this.tableChanged ( new jsjavax.swing.event.TableModelEvent (dataModel, -1));
this.firePropertyChange ("model", old, dataModel);
if (this.getAutoCreateRowSorter ()) {
this.setRowSorter ( new jsjavax.swing.table.TableRowSorter (dataModel));
}}}, "jsjavax.swing.table.TableModel");
...
function (e) {
if (e.getType () === jsjavax.swing.event.RowSorterEvent.Type.SORT_ORDER_CHANGED) {
var header = this.getTableHeader ();
if (header != null) {
header.repaint ();
}} else if (e.getType () === jsjavax.swing.event.RowSorterEvent.Type.SORTED) {
...
($fz = function (sortedEvent, e) {
var editingModelIndex = -1;
var change = (e != null) ? Clazz.innerTypeInstance (jsjavax.swing.JTable.ModelChange, this, null, e) : null;
...
this.clearSelectionAndLeadAnchor ();
this.resizeAndRepaint ();
}}, $fz.isPrivate = true, $fz), "jsjavax.swing.event.RowSorterEvent,jsjavax.swing.event.TableModelEvent");
...
}, $fz.isPrivate = true, $fz), "jsjavax.swing.JTable.ModelChange");
Clazz.defineMethod (c$, "restoreSortingSelection", 
($fz = function (selection, lead, change) {
...
jssun.swing.SwingUtilities2.setLeadAnchorWithoutSelection (this.selectionModel, lead, lead);
this.selectionModel.setValueIsAdjusting (false);
}, $fz.isPrivate = true, $fz), "~A,~N,jsjavax.swing.JTable.ModelChange");
Clazz.defineMethod (c$, "restoreSortingEditingRow", 
($fz = function (editingRow) {
if (editingRow == -1) {
...
}, $fz.isPrivate = true, $fz), "~N,jsjavax.swing.JTable.ModelChange");
...
return selection;
}, $fz.isPrivate = true, $fz), "jsjavax.swing.event.RowSorterEvent");
Clazz.defineMethod (c$, "convertRowIndexToModel", 
($fz = function (e, viewIndex) {
if (e != null) {
...
}, $fz.isPrivate = true, $fz), "jsjavax.swing.event.RowSorterEvent,~N");
...
var dirtyRegion;
if (modelColumn == -1) {
dirtyRegion =  new jsjava.awt.Rectangle (0, start * this.getRowHeight (), this.getColumnModel ().getTotalColumnWidth (), 0);
} else {
...
var drawRect =  new jsjava.awt.Rectangle (0, start * rh, this.getColumnModel ().getTotalColumnWidth (), (this.getRowCount () - start) * rh);
this.revalidate ();
this.repaint (drawRect);
}, $fz.isPrivate = true, $fz), "jsjavax.swing.event.TableModelEvent");
...
var drawRect =  new jsjava.awt.Rectangle (0, start * rh, this.getColumnModel ().getTotalColumnWidth (), (previousRowCount - start) * rh);
this.revalidate ();
this.repaint (drawRect);
}, $fz.isPrivate = true, $fz), "jsjavax.swing.event.TableModelEvent");
...
newCellLoc =  new jsjava.awt.Point (x, newEdge);
} else if (leftToRight) {
newEdge = visibleLeadingEdge - visibleRect.width;
newCellLoc =  new jsjava.awt.Point (newEdge, visibleRect.y);
} else {
newEdge = visibleLeadingEdge + visibleRect.width;
newCellLoc =  new jsjava.awt.Point (newEdge - 1, visibleRect.y);
...
($fz = function (visibleRect) {
var leadingPoint;
if (this.getComponentOrientation ().isLeftToRight ()) {
leadingPoint =  new jsjava.awt.Point (visibleRect.x, visibleRect.y);
} else {
...
var trailingPoint;
if (this.getComponentOrientation ().isLeftToRight ()) {
trailingPoint =  new jsjava.awt.Point (visibleRect.x, visibleRect.y + visibleRect.height - 1);
} else {
trailingPoint =  new jsjava.awt.Point (visibleRect.x + visibleRect.width - 1, visibleRect.y + visibleRect.height - 1);
...
var trailingPoint;
if (this.getComponentOrientation ().isLeftToRight ()) {
trailingPoint =  new jsjava.awt.Point (visibleRect.x + visibleRect.width - 1, visibleRect.y);
} else {
trailingPoint =  new jsjava.awt.Point (visibleRect.x, visibleRect.y);
}return this.columnAtPoint (trailingPoint);
}, $fz.isPrivate = true, $fz), "jsjava.awt.Rectangle");
Clazz.defineMethod (c$, "leadingEdge", 
($fz = function (rect, orientation) {
if (orientation == 1) {
return rect.y;
...
function () {
return this.getFillsViewportHeight () && Clazz.instanceOf (this.getParent (), jsjavax.swing.JViewport) && ((this.getParent ()).getHeight () > this.getPreferredSize ().height);
});
...
var retValue = Clazz.superCall (this, jsjavax.swing.JTable, "processKeyBinding", [ks, e, condition, pressed]);
...
if (editorComponent == null) {
return false;
}}if (Clazz.instanceOf (editorComponent, jsjavax.swing.JComponent)) {
...
($fz = function (h, c, s) {
h.put (c, s);
}, $fz.isPrivate = true, $fz), "java.util.Hashtable,Class,~S");
...
function () {
this.defaultRenderersByColumnClass =  new jsjavax.swing.UIDefaults (8, 0.75);
this.setLazyRenderer (JavaObject, "jsjavax.swing.table.DefaultTableCellRenderer$UIResource");
this.setLazyRenderer (Number, "jsjavax.swing.JTable$NumberRenderer");
this.setLazyRenderer (Float, "jsjavax.swing.JTable$DoubleRenderer");
this.setLazyRenderer (Double, "jsjavax.swing.JTable$DoubleRenderer");
this.setLazyRenderer (java.util.Date, "jsjavax.swing.JTable$DateRenderer");
this.setLazyRenderer (jsjavax.swing.Icon, "jsjavax.swing.JTable$IconRenderer");
this.setLazyRenderer (jsjavax.swing.ImageIcon, "jsjavax.swing.JTable$IconRenderer");
this.setLazyRenderer (Boolean, "jsjavax.swing.JTable$BooleanRenderer");
});
...
function () {
this.defaultEditorsByColumnClass =  new jsjavax.swing.UIDefaults (3, 0.75);
this.setLazyEditor (JavaObject, "jsjavax.swing.JTable$GenericEditor");
this.setLazyEditor (Number, "jsjavax.swing.JTable$NumberEditor");
this.setLazyEditor (Boolean, "jsjavax.swing.JTable$BooleanEditor");
});
...
this.setPreferredScrollableViewportSize ( new jsjava.awt.Dimension (450, 400));
this.setAutoscrolls (true);
});
Clazz.defineMethod (c$, "createDefaultDataModel", 
function () {
return  new jsjavax.swing.table.DefaultTableModel ();
});
...
function () {
return  new jsjavax.swing.table.JTableHeader (this.columnModel);
});
...
}, "jsjavax.swing.table.TableCellRenderer,~N,~N");
Clazz.defineMethod (c$, "getCellEditor", 
function (row, column) {
var tableColumn = this.getColumnModel ().getColumn (column);
...
return comp;
}, "jsjavax.swing.table.TableCellEditor,~N,~N");
...
Clazz.instantialize (this, arguments);
}, jsjavax.swing.JTable, "SortManager");
Clazz.makeConstructor (c$, 
function (a) {
this.sorter = a;
a.addRowSorterListener (this.b$["jsjavax.swing.JTable"]);
}, "jsjavax.swing.RowSorter");
Clazz.defineMethod (c$, "dispose", 
function () {
if (this.sorter != null) {
this.sorter.removeRowSorterListener (this.b$["jsjavax.swing.JTable"]);
}});
Clazz.defineMethod (c$, "setViewRowHeight", 
function (a, b) {
if (this.modelRowSizes == null) {
this.modelRowSizes =  new jsjavax.swing.SizeSequence (this.b$["jsjavax.swing.JTable"].getModel ().getRowCount (), this.b$["jsjavax.swing.JTable"].getRowHeight ());
}this.modelRowSizes.setSize (this.b$["jsjavax.swing.JTable"].convertRowIndexToModel (a), b);
}, "~N,~N");
...
function (a, b) {
if (this.b$["jsjavax.swing.JTable"].getUpdateSelectionOnSort ()) {
this.cacheSelection (a, b);
}}, "jsjavax.swing.event.RowSorterEvent,jsjavax.swing.JTable.ModelChange");
Clazz.defineMethod (c$, "cacheSelection", 
($fz = function (a, b) {
if (a != null) {
if (this.modelSelection == null && this.sorter.getViewRowCount () != this.b$["jsjavax.swing.JTable"].getModel ().getRowCount ()) {
this.modelSelection =  new jsjavax.swing.DefaultListSelectionModel ();
var c = this.b$["jsjavax.swing.JTable"].getSelectionModel ();
var d = c.getMinSelectionIndex ();
var e = c.getMaxSelectionIndex ();
var f;
for (var g = d; g <= e; g++) {
if (c.isSelectedIndex (g)) {
f = this.b$["jsjavax.swing.JTable"].convertRowIndexToModel (a, g);
if (f != -1) {
this.modelSelection.addSelectionInterval (f, f);
}}}
f = this.b$["jsjavax.swing.JTable"].convertRowIndexToModel (a, c.getLeadSelectionIndex ());
jssun.swing.SwingUtilities2.setLeadAnchorWithoutSelection (this.modelSelection, f, f);
...
}}, $fz.isPrivate = true, $fz), "jsjavax.swing.event.RowSorterEvent,jsjavax.swing.JTable.ModelChange");
Clazz.defineMethod (c$, "cacheModelSelection", 
($fz = function (a) {
this.lastModelSelection = this.b$["jsjavax.swing.JTable"].convertSelectionToModel (a);
this.modelLeadIndex = this.b$["jsjavax.swing.JTable"].convertRowIndexToModel (a, this.b$["jsjavax.swing.JTable"].selectionModel.getLeadSelectionIndex ());
}, $fz.isPrivate = true, $fz), "jsjavax.swing.event.RowSorterEvent");
...
if (b.allRowsChanged) {
this.modelRowSizes = null;
this.b$["jsjavax.swing.JTable"].rowModel = null;
} else if (this.modelRowSizes != null) {
if (b.type == 1) {
this.modelRowSizes.insertEntries (b.startModelIndex, b.endModelIndex - b.startModelIndex + 1, this.b$["jsjavax.swing.JTable"].getRowHeight ());
} else if (b.type == -1) {
...
}}, "jsjavax.swing.event.RowSorterEvent,jsjavax.swing.JTable.ModelChange,~B");
Clazz.defineMethod (c$, "setViewRowHeightsFromModel", 
($fz = function () {
if (this.modelRowSizes != null) {
this.b$["jsjavax.swing.JTable"].rowModel.setSizes (this.b$["jsjavax.swing.JTable"].getRowCount (), this.b$["jsjavax.swing.JTable"].getRowHeight ());
for (var a = this.b$["jsjavax.swing.JTable"].getRowCount () - 1; a >= 0; a--) {
var b = this.b$["jsjavax.swing.JTable"].convertRowIndexToModel (a);
this.b$["jsjavax.swing.JTable"].rowModel.setSize (a, this.modelRowSizes.getSize (b));
}
}}, $fz.isPrivate = true, $fz));
...
this.b$["jsjavax.swing.JTable"].restoreSortingSelection (this.lastModelSelection, this.modelLeadIndex, a);
this.lastModelSelection = null;
} else if (this.modelSelection != null) {
var b = this.b$["jsjavax.swing.JTable"].getSelectionModel ();
...
e = this.b$["jsjavax.swing.JTable"].convertRowIndexToView (f);
if (e != -1) {
b.addSelectionInterval (e, e);
}}}
var g = this.modelSelection.getLeadSelectionIndex ();
if (g != -1) {
g = this.b$["jsjavax.swing.JTable"].convertRowIndexToView (g);
}jssun.swing.SwingUtilities2.setLeadAnchorWithoutSelection (b, g, g);
...
Clazz.instantialize (this, arguments);
}, jsjavax.swing.JTable, "ModelChange");
Clazz.makeConstructor (c$, 
function (a) {
this.startModelIndex = Math.max (0, a.getFirstRow ());
this.endModelIndex = a.getLastRow ();
this.modelRowCount = this.b$["jsjavax.swing.JTable"].getModel ().getRowCount ();
...
Clazz.pu$h ();
c$ = Clazz.declareType (jsjavax.swing.JTable, "PrintMode", Enum);
Clazz.defineEnumConstant (c$, "NORMAL", 0, []);
Clazz.defineEnumConstant (c$, "FIT_WIDTH", 1, []);
c$ = Clazz.p0p ();
c$.$JTable$1$ = function () {
Clazz.pu$h ();
c$ = Clazz.declareAnonymous (jsjavax.swing, "JTable$1", jsjavax.swing.table.AbstractTableModel);
...
c$.$JTable$2$ = function () {
Clazz.pu$h ();
c$ = Clazz.declareAnonymous (jsjavax.swing, "JTable$2", null, jsjavax.swing.JTable.Resizable3);
...
c$.$JTable$3$ = function () {
Clazz.pu$h ();
c$ = Clazz.declareAnonymous (jsjavax.swing, "JTable$3", null, jsjavax.swing.JTable.Resizable3);
Clazz.defineMethod (c$, "getElementCount", 
function () {
...
c$.$JTable$4$ = function () {
Clazz.pu$h ();
c$ = Clazz.declareAnonymous (jsjavax.swing, "JTable$4", null, jsjavax.swing.JTable.Resizable2);
Clazz.defineMethod (c$, "getElementCount", 
function () {
...
c$.$JTable$5$ = function () {
Clazz.pu$h ();
c$ = Clazz.declareAnonymous (jsjavax.swing, "JTable$5", null, jsjavax.swing.JTable.Resizable2);
Clazz.defineMethod (c$, "getElementCount", 
function () {
return this.f$.r.getElementCount ();
});
...
Clazz.declareInterface (jsjavax.swing.JTable, "Resizable2");
Clazz.declareInterface (jsjavax.swing.JTable, "Resizable3", jsjavax.swing.JTable.Resizable2);
Clazz.pu$h ();
c$ = Clazz.declareType (jsjavax.swing.JTable, "NumberRenderer", jsjavax.swing.table.DefaultTableCellRenderer.UIResource);
Clazz.makeConstructor (c$, 
function () {
Clazz.superConstructor (this, jsjavax.swing.JTable.NumberRenderer);
...
this.formatter = null;
Clazz.instantialize (this, arguments);
}, jsjavax.swing.JTable, "DoubleRenderer", jsjavax.swing.JTable.NumberRenderer);
Clazz.overrideMethod (c$, "setValue", 
function (a) {
if (this.formatter == null) {
this.formatter = jsjava.text.NumberFormat.getInstance ();
}this.setText ((a == null) ? "" : this.formatter.format (a));
}, "~O");
c$ = Clazz.p0p ();
Clazz.pu$h ();
c$ = Clazz.declareType (jsjavax.swing.JTable, "IconRenderer", jsjavax.swing.table.DefaultTableCellRenderer.UIResource);
Clazz.makeConstructor (c$, 
function () {
Clazz.superConstructor (this, jsjavax.swing.JTable.IconRenderer);
this.setHorizontalAlignment (0);
});
Clazz.overrideMethod (c$, "setValue", 
function (a) {
this.setIcon ((Clazz.instanceOf (a, jsjavax.swing.Icon)) ? a : null);
}, "~O");
c$ = Clazz.p0p ();
Clazz.pu$h ();
c$ = Clazz.declareType (jsjavax.swing.JTable, "BooleanRenderer", jsjavax.swing.JCheckBox, [jsjavax.swing.table.TableCellRenderer, jsjavax.swing.plaf.UIResource]);
Clazz.makeConstructor (c$, 
function () {
Clazz.superConstructor (this, jsjavax.swing.JTable.BooleanRenderer);
this.setHorizontalAlignment (0);
...
Clazz.superCall (this, jsjavax.swing.JTable.BooleanRenderer, "setBackground", [a.getSelectionBackground ()]);
} else {
this.setForeground (a.getForeground ());
this.setBackground (a.getBackground ());
}this.setSelected ((b != null && (b).booleanValue ()));
if (d) {
this.setBorder (jsjavax.swing.UIManager.getBorder ("Table.focusCellHighlightBorder"));
} else {
this.setBorder (jsjavax.swing.JTable.BooleanRenderer.noFocusBorder);
}return this;
}, "jsjavax.swing.JTable,~O,~B,~B,~N,~N");
c$.noFocusBorder = c$.prototype.noFocusBorder =  new jsjavax.swing.border.EmptyBorder (1, 1, 1, 1);
c$ = Clazz.p0p ();
Clazz.pu$h ();
c$ = Clazz.decorateAsClass (function () {
this.argTypes = null;
...
this.value = null;
Clazz.instantialize (this, arguments);
}, jsjavax.swing.JTable, "GenericEditor", jsjavax.swing.DefaultCellEditor);
Clazz.prepareFields (c$, function () {
this.argTypes =  Clazz.newArray (-1, [String]);
});
Clazz.makeConstructor (c$, 
function () {
Clazz.superConstructor (this, jsjavax.swing.JTable.GenericEditor, [ new jsjavax.swing.JTextField ()]);
this.getComponent ().setName ("Table.editor");
});
Clazz.defineMethod (c$, "stopCellEditing", 
function () {
var a = Clazz.superCall (this, jsjavax.swing.JTable.GenericEditor, "getCellEditorValue", []);
try {
if ("".equals (a)) {
if (this.constructor.getDeclaringClass () === String) {
this.value = a;
}Clazz.superCall (this, jsjavax.swing.JTable.GenericEditor, "stopCellEditing", []);
}this.value = this.constructor.newInstance ( Clazz.newArray (-1, [a]));
} catch (e) {
if (Clazz.exceptionOf (e, Exception)) {
(this.getComponent ()).setBorder ( new jsjavax.swing.border.LineBorder (jsjava.awt.Color.red));
return false;
} else {
throw e;
}
}
return Clazz.superCall (this, jsjavax.swing.JTable.GenericEditor, "stopCellEditing", []);
});
Clazz.defineMethod (c$, "getTableCellEditorComponent", 
function (a, b, c, d, e) {
this.value = null;
(this.getComponent ()).setBorder ( new jsjavax.swing.border.LineBorder (jsjava.awt.Color.black));
try {
...
return Clazz.superCall (this, jsjavax.swing.JTable.GenericEditor, "getTableCellEditorComponent", [a, b, c, d, e]);
...
c$ = Clazz.p0p ();
Clazz.pu$h ();
c$ = Clazz.declareType (jsjavax.swing.JTable, "NumberEditor", jsjavax.swing.JTable.GenericEditor);
Clazz.makeConstructor (c$, 
function () {
Clazz.superConstructor (this, jsjavax.swing.JTable.NumberEditor, []);
(this.getComponent ()).setHorizontalAlignment (4);
});
c$ = Clazz.p0p ();
Clazz.pu$h ();
c$ = Clazz.declareType (jsjavax.swing.JTable, "BooleanEditor", jsjavax.swing.DefaultCellEditor);
Clazz.makeConstructor (c$, 
function () {
Clazz.superConstructor (this, jsjavax.swing.JTable.BooleanEditor, [ new jsjavax.swing.JCheckBox ()]);
