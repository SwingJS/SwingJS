...
Clazz.load (["jsjavax.swing.JComponent", "$.JScrollBar", "$.ScrollPaneConstants", "jsjavax.swing.plaf.UIResource"], "jsjavax.swing.JScrollPane", ["java.lang.Boolean", "$.ClassCastException", "$.IllegalArgumentException", "jsjava.awt.Point", "$.Rectangle", "jsjavax.swing.JViewport", "$.ScrollPaneLayout", "$.Scrollable", "$.SwingUtilities", "$.UIManager"], function () {
...
if (!Clazz.isClassDefined ("jsjavax.swing.JScrollPane.ScrollBar")) {
jsjavax.swing.JScrollPane.$JScrollPane$ScrollBar$ ();
}
Clazz.instantialize (this, arguments);
}, jsjavax.swing, "JScrollPane", jsjavax.swing.JComponent, jsjavax.swing.ScrollPaneConstants);
Clazz.makeConstructor (c$, 
function (view, vsbPolicy, hsbPolicy) {
Clazz.superConstructor (this, jsjavax.swing.JScrollPane, []);
this.setLayout ( new jsjavax.swing.ScrollPaneLayout.UIResource ());
...
this.viewport.setViewPosition ( new jsjava.awt.Point (2147483647, 0));
...
function (layout) {
if (Clazz.instanceOf (layout, jsjavax.swing.ScrollPaneLayout)) {
Clazz.superCall (this, jsjavax.swing.JScrollPane, "setLayout", [layout]);
...
function () {
var borderR =  new jsjava.awt.Rectangle (this.getSize ());
...
var leftToRight = jsjavax.swing.SwingUtilities.isLeftToRight (this);
...
function () {
return Clazz.innerTypeInstance (jsjavax.swing.JScrollPane.ScrollBar, this, null, 0);
});
...
this.revalidate ();
this.repaint ();
}, "jsjavax.swing.JScrollBar");
Clazz.defineMethod (c$, "createVerticalScrollBar", 
function () {
return Clazz.innerTypeInstance (jsjavax.swing.JScrollPane.ScrollBar, this, null, 1);
});
...
function () {
return  new jsjavax.swing.JViewport ();
});
...
function (co) {
Clazz.superCall (this, jsjavax.swing.JScrollPane, "setComponentOrientation", [co]);
...
Clazz.instantialize (this, arguments);
}, jsjavax.swing.JScrollPane, "ScrollBar", jsjavax.swing.JScrollBar, jsjavax.swing.plaf.UIResource);
Clazz.makeConstructor (c$, 
function (a) {
Clazz.superConstructor (this, jsjavax.swing.JScrollPane.ScrollBar, [a]);
...
Clazz.superCall (this, jsjavax.swing.JScrollPane.ScrollBar, "setUnitIncrement", [a]);
}, "~N");
Clazz.defineMethod (c$, "getUnitIncrement", 
function (a) {
var b = this.b$["jsjavax.swing.JScrollPane"].getViewport ();
if (!this.unitIncrementSet && (b != null) && (Clazz.instanceOf (b.getView (), jsjavax.swing.Scrollable))) {
var c = (b.getView ());
var d = b.getViewRect ();
return c.getScrollableUnitIncrement (d, this.getOrientation (), a);
} else {
return Clazz.superCall (this, jsjavax.swing.JScrollPane.ScrollBar, "getUnitIncrement", [a]);
}}, "~N");
Clazz.defineMethod (c$, "setBlockIncrement", 
function (a) {
this.blockIncrementSet = true;
this.putClientProperty ("JScrollBar.fastWheelScrolling", null);
Clazz.superCall (this, jsjavax.swing.JScrollPane.ScrollBar, "setBlockIncrement", [a]);
}, "~N");
Clazz.defineMethod (c$, "getBlockIncrement", 
function (a) {
var b = this.b$["jsjavax.swing.JScrollPane"].getViewport ();
if (this.blockIncrementSet || b == null) {
return Clazz.superCall (this, jsjavax.swing.JScrollPane.ScrollBar, "getBlockIncrement", [a]);
} else if (Clazz.instanceOf (b.getView (), jsjavax.swing.Scrollable)) {
var c = (b.getView ());
var d = b.getViewRect ();
