...
Clazz.load (null, "jssun.awt.image.ImagingLib", ["swingjs.JSToolkit"], function () {
c$ = Clazz.declareType (jssun.awt.image, "ImagingLib");
...
c$.filter = Clazz.defineMethod (c$, "filter", 
function (op, src, dst) {
if (jssun.awt.image.ImagingLib.verbose) {
