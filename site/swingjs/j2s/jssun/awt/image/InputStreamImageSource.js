...
Clazz.load (["jsjava.awt.image.ImageProducer", "jssun.awt.image.ImageFetchable"], "jssun.awt.image.InputStreamImageSource", ["java.lang.SecurityException", "$.Thread", "jssun.awt.image.ImageConsumerQueue", "$.ImageFetcher"], function () {
...
}, jssun.awt.image, "InputStreamImageSource", null, [jsjava.awt.image.ImageProducer, jssun.awt.image.ImageFetchable]);
...
}}, "jsjava.awt.image.ImageConsumer,~B");
...
($fz = function (cq, needReload) {
while (cq != null) {
if (cq.interested) {
this.errorConsumer (cq, needReload);
}cq = cq.next;
}
}, $fz.isPrivate = true, $fz), "jssun.awt.image.ImageConsumerQueue,~B");
...
this.consumers = null;
this.awaitingFetch = false;
}}, $fz.isPrivate = true, $fz), "jssun.awt.image.ImageDecoder");
