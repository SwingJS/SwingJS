...
function () {
var outerNode = this.setHTMLElementCUI ();
var prop = null;
...
if (prop != null) swingjs.api.DOMNode.setStyles (outerNode, ["width", this.c.getWidth () + "px", "text-align", prop]);
return outerNode;
});
Clazz.overrideMethod (c$, "installJSUI", 
function () {
javax.swing.LookAndFeel.installColorsAndFont (this.c, null, null, "Label.font");
});
