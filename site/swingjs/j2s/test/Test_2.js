...
this.canvas =  new test.Test_2Canvas ();
this.canvas.setSize (850, 500);
var c = this.getContentPane ();
c.setSize (850, 500);
c.add (this.canvas, "Center");
c.add (this.controls =  new test.Test_2Controls (this.canvas), "North");
});
Clazz.defineMethod (c$, "setSize", 
function (width, height) {
Clazz.superCall (this, test.Test_2, "setSize", [width, height]);
this.validate ();
}, "~N,~N");
...
x1 = Delta / Bp;
y1 = x1;
y2 = test.Test_2.CalcF4T1g (x1);
y3 = test.Test_2.CalcP4T1g (x1);
fE = test.Test_2.CalcG2Eg (x1);
fT1 = test.Test_2.CalcG2T1g (x1);
fT2 = test.Test_2.CalcG2T2g (x1);
fA1 = test.Test_2.CalcG2A1g (x1);
fT2b = test.Test_2.CalcD2T2g (x1);
fT2H = test.Test_2.CalcH2T2g (x1);
fEH = test.Test_2.CalcH2Eg (x1);
fT1H = test.Test_2.CalcH2T1g (x1);
...
this.outPRec = null;
Clazz.instantialize (this, arguments);
}, test, "Test_2Canvas", javax.swing.JPanel, [java.awt.event.MouseListener, java.awt.event.MouseMotionListener]);
...
Clazz.makeConstructor (c$, 
function () {
Clazz.superConstructor (this, test.Test_2Canvas, []);
this.setName ("Test_2Canvas");
...
if (this.end_x < 35) {
yDivisor = test.Test_2.CalcD2T2g (this.end_x);
} else yDivisor = test.Test_2.CalcP4T1g (this.end_x);
...
this.x1 = this.deltaB;
this.y1 = this.x1;
this.y2 = test.Test_2.CalcF4T1g (this.x1);
this.y3 = test.Test_2.CalcP4T1g (this.x1);
this.fE = test.Test_2.CalcG2Eg (this.x1);
this.fT1 = test.Test_2.CalcG2T1g (this.x1);
this.fT2 = test.Test_2.CalcG2T2g (this.x1);
this.fA1 = test.Test_2.CalcG2A1g (this.x1);
this.fT2b = test.Test_2.CalcD2T2g (this.x1);
this.fT2H = test.Test_2.CalcH2T2g (this.x1);
this.fEH = test.Test_2.CalcH2Eg (this.x1);
this.fT1H = test.Test_2.CalcH2T1g (this.x1);
...
this.bg = null;
Clazz.instantialize (this, arguments);
}, test, "Test_2Controls", javax.swing.JPanel, java.awt.event.ItemListener);
Clazz.makeConstructor (c$, 
function (canvas) {
Clazz.superConstructor (this, test.Test_2Controls, []);
this.setLayout ( new java.awt.FlowLayout ());
this.setName ("T3d3Controls");
this.canvas = canvas;
this.range = 0;
var c =  new javax.swing.JCheckBox ("test");
...
this.b = enableBtn;
this.add (enableBtn);
enableBtn.addActionListener (((Clazz.isClassDefined ("test.Test_2Controls$1") ? 0 : test.Test_2Controls.$Test_2Controls$1$ ()), Clazz.innerTypeInstance (test.Test_2Controls$1, this, Clazz.cloneFinals ("enableBtn", enableBtn))));
...
System.out.println ("OK, box " + (e.getSource ()).getName () + " isSelected=" + (e.getSource ()).isSelected ());
return;
...
c$.$Test_2Controls$1$ = function () {
Clazz.pu$h(self.c$);
c$ = Clazz.declareAnonymous (test, "Test_2Controls$1", null, java.awt.event.ActionListener);
...
Clazz.defineMethod (c$, "enableButtons", 
 function (isEnable) {
var x = this.b$["test.Test_2Controls"].bg.getElements ();
