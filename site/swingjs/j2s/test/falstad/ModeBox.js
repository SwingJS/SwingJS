...
test.falstad.ModeBox.oc.initFrame ();
}, "~A");
Clazz.defineMethod (c$, "showFrame", 
function () {
if (test.falstad.ModeBox.oc == null) {
this.started = true;
...
if (this.showControls) this.main.add (this.clearButton =  new swingjs.awt.Button ("Clear"));
...
if (this.showControls) this.main.add (this.spectrumCheck);
...
if (this.showControls) this.main.add (this.memoryImageSourceCheck);
...
if (this.showControls) this.main.add ( new swingjs.awt.Label ("http://www.falstad.com", 0));
try {
...
var camnorm = Math.sqrt (camvx * camvx + camvy * camvy + camvz * camvz);
var n;
var simpr = 0;
var simpg = 0;
var nmax = 14;
...
var h = Clazz.doubleToInt (ym * (.2 + Math.log (this.spectrum[i]) / 4));
if (h > ym) h = ym;
...
var i;
if (this.view3d.contains (x, y)) this.selection = 1;
if (this.viewSpectrum != null && this.viewSpectrum.contains (x, y)) {
this.selection = 3;
...
function (x, y, z) {
return Math.sqrt (x * x / (this.boxwidth * this.boxwidth) + y * y / (this.boxheight * this.boxheight) + z * z / 4.);
}, "~N,~N,~N");
