...
Clazz.load (["jsjava.awt.geom.PathIterator"], "jsjava.awt.geom.FlatteningPathIterator", ["java.lang.IllegalArgumentException", "java.util.NoSuchElementException", "jsjava.awt.geom.CubicCurve2D", "$.QuadCurve2D"], function () {
...
}, jsjava.awt.geom, "FlatteningPathIterator", null, jsjava.awt.geom.PathIterator);
...
}, "jsjava.awt.geom.PathIterator,~N");
Clazz.makeConstructor (c$, 
...
if (jsjava.awt.geom.QuadCurve2D.getFlatnessSq (this.hold, this.holdIndex) < this.squareflat) {
break;
}this.ensureHoldCapacity (4);
jsjava.awt.geom.QuadCurve2D.subdivide (this.hold, this.holdIndex, this.hold, this.holdIndex - 4, this.hold, this.holdIndex);
this.holdIndex -= 4;
level++;
...
while (level < this.limit) {
if (jsjava.awt.geom.CubicCurve2D.getFlatnessSq (this.hold, this.holdIndex) < this.squareflat) {
break;
}this.ensureHoldCapacity (6);
jsjava.awt.geom.CubicCurve2D.subdivide (this.hold, this.holdIndex, this.hold, this.holdIndex - 6, this.hold, this.holdIndex);
this.holdIndex -= 6;
level++;
this.levels[this.levelIndex] = level;
this.levelIndex++;
