...
Clazz.load (["jsjava.awt.geom.RectangularShape"], "jsjava.awt.geom.Arc2D", ["java.lang.Double", "$.IllegalArgumentException", "jsjava.awt.geom.ArcIterator", "$.Line2D", "$.Point2D", "$.Rectangle2D"], function () {
c$ = Clazz.decorateAsClass (function () {
this.type = 0;
Clazz.instantialize (this, arguments);
}, jsjava.awt.geom, "Arc2D", jsjava.awt.geom.RectangularShape);
...
Clazz.makeConstructor (c$, 
function (type) {
Clazz.superConstructor (this, jsjava.awt.geom.Arc2D, []);
...
return  new jsjava.awt.geom.Point2D.Double (x, y);
});
...
}, "jsjava.awt.geom.Point2D,jsjava.awt.geom.Point2D,jsjava.awt.geom.Point2D,~N");
...
return true;
}angle = jsjava.awt.geom.Arc2D.normalizeDegrees (angle) - jsjava.awt.geom.Arc2D.normalizeDegrees (this.getAngleStart ());
if (backwards) {
angle = -angle;
}if (angle < 0.0) {
angle += 360.0;
...
var inside = (jsjava.awt.geom.Line2D.relativeCCW (x1, y1, x2, y2, 2 * normx, 2 * normy) * jsjava.awt.geom.Line2D.relativeCCW (x1, y1, x2, y2, 0, 0) >= 0);
...
Clazz.defineMethod (c$, "contains", 
($fz = function (x, y, w, h, origrect) {
if (!(this.contains (x, y) && this.contains (x + w, y) && this.contains (x, y + h) && this.contains (x + w, y + h))) {
return false;
}if (this.type != 2 || Math.abs (this.getAngleExtent ()) <= 180.0) {
return true;
}if (origrect == null) {
origrect =  new jsjava.awt.geom.Rectangle2D.Double (x, y, w, h);
...
}, $fz.isPrivate = true, $fz), "~N,~N,~N,~N,jsjava.awt.geom.Rectangle2D");
Clazz.defineMethod (c$, "getPathIterator", 
function (at) {
return  new jsjava.awt.geom.ArcIterator (this, at);
...
if (obj === this) {
return true;
}if (Clazz.instanceOf (obj, jsjava.awt.geom.Arc2D)) {
var a2d = obj;
...
this.extent = 0;
Clazz.instantialize (this, arguments);
}, jsjava.awt.geom.Arc2D, "Float", jsjava.awt.geom.Arc2D);
Clazz.makeConstructor (c$, 
function () {
Clazz.superConstructor (this, jsjava.awt.geom.Arc2D.Float, [0]);
});
Clazz.makeConstructor (c$, 
function (a, b, c, d, e, f, g) {
Clazz.superConstructor (this, jsjava.awt.geom.Arc2D.Float, [g]);
this.x = a;
this.y = b;
this.width = c;
this.height = d;
...
Clazz.makeConstructor (c$, 
function (a, b, c, d) {
Clazz.superConstructor (this, jsjava.awt.geom.Arc2D.Float, [d]);
this.x = a.getX ();
this.y = a.getY ();
...
this.extent = 0;
Clazz.instantialize (this, arguments);
}, jsjava.awt.geom.Arc2D, "Double", jsjava.awt.geom.Arc2D);
Clazz.makeConstructor (c$, 
function () {
Clazz.superConstructor (this, jsjava.awt.geom.Arc2D.Double, [0]);
});
Clazz.makeConstructor (c$, 
function (a, b, c, d, e, f, g) {
Clazz.superConstructor (this, jsjava.awt.geom.Arc2D.Double, [g]);
this.x = a;
this.y = b;
this.width = c;
this.height = d;
...
Clazz.makeConstructor (c$, 
function (a, b, c, d) {
Clazz.superConstructor (this, jsjava.awt.geom.Arc2D.Double, [d]);
this.x = a.getX ();
this.y = a.getY ();
this.width = a.getWidth ();
this.height = a.getHeight ();
