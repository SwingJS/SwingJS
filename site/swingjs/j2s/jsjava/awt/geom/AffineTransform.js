...
Clazz.load (null, "jsjava.awt.geom.AffineTransform", ["java.lang.Double", "$.InternalError", "jsjava.awt.geom.NoninvertibleTransformException", "$.Path2D", "$.Point2D", "jsjava.awt.geom.Point2D.Double"], function () {
...
}, jsjava.awt.geom, "AffineTransform", null, [Cloneable, java.io.Serializable]);
...
function (tx, ty) {
var Tx =  new jsjava.awt.geom.AffineTransform ();
...
this.m10 = this.m11;
this.m11 = -M0;
var state = jsjava.awt.geom.AffineTransform.rot90conversion[this.state];
...
throw  new jsjava.awt.geom.NoninvertibleTransformException ("Determinant is " + det);
}return  new jsjava.awt.geom.AffineTransform (this.m11 / det, -this.m10 / det, -this.m01 / det, this.m00 / det, (this.m01 * this.m12 - this.m11 * this.m02) / det, (this.m10 * this.m02 - this.m00 * this.m12) / det, (7));
case (6):
det = this.m00 * this.m11 - this.m01 * this.m10;
if (Math.abs (det) <= 4.9E-324) {
throw  new jsjava.awt.geom.NoninvertibleTransformException ("Determinant is " + det);
}return  new jsjava.awt.geom.AffineTransform (this.m11 / det, -this.m10 / det, -this.m01 / det, this.m00 / det, 0.0, 0.0, (6));
case (5):
if (this.m01 == 0.0 || this.m10 == 0.0) {
throw  new jsjava.awt.geom.NoninvertibleTransformException ("Determinant is 0");
}return  new jsjava.awt.geom.AffineTransform (0.0, 1.0 / this.m01, 1.0 / this.m10, 0.0, -this.m12 / this.m10, -this.m02 / this.m01, (5));
case (4):
if (this.m01 == 0.0 || this.m10 == 0.0) {
throw  new jsjava.awt.geom.NoninvertibleTransformException ("Determinant is 0");
}return  new jsjava.awt.geom.AffineTransform (0.0, 1.0 / this.m01, 1.0 / this.m10, 0.0, 0.0, 0.0, (4));
case (3):
if (this.m00 == 0.0 || this.m11 == 0.0) {
throw  new jsjava.awt.geom.NoninvertibleTransformException ("Determinant is 0");
}return  new jsjava.awt.geom.AffineTransform (1.0 / this.m00, 0.0, 0.0, 1.0 / this.m11, -this.m02 / this.m00, -this.m12 / this.m11, (3));
case (2):
if (this.m00 == 0.0 || this.m11 == 0.0) {
throw  new jsjava.awt.geom.NoninvertibleTransformException ("Determinant is 0");
}return  new jsjava.awt.geom.AffineTransform (1.0 / this.m00, 0.0, 0.0, 1.0 / this.m11, 0.0, 0.0, (2));
case (1):
return  new jsjava.awt.geom.AffineTransform (1.0, 0.0, 0.0, 1.0, -this.m02, -this.m12, (1));
case (0):
...
if (ptDst == null) {
if (Clazz.instanceOf (ptSrc, jsjava.awt.geom.Point2D.Double)) {
ptDst =  new jsjava.awt.geom.Point2D.Double ();
} else {
ptDst =  new jsjava.awt.geom.Point2D.Float ();
}}var x = ptSrc.getX ();
var y = ptSrc.getY ();
switch (this.state) {
default:
...
if (dst == null) {
if (Clazz.instanceOf (src, jsjava.awt.geom.Point2D.Double)) {
dst =  new jsjava.awt.geom.Point2D.Double ();
} else {
dst =  new jsjava.awt.geom.Point2D.Float ();
}ptDst[dstOff - 1] = dst;
}switch (state) {
default:
this.stateError ();
...
if (pSrc == null) {
return null;
}return  new jsjava.awt.geom.Path2D.Double (pSrc, this);
}, "jsjava.awt.Shape");
...
function () {
return ("AffineTransform[[" + jsjava.awt.geom.AffineTransform._matround (this.m00) + ", " + jsjava.awt.geom.AffineTransform._matround (this.m01) + ", " + jsjava.awt.geom.AffineTransform._matround (this.m02) + "], [" + jsjava.awt.geom.AffineTransform._matround (this.m10) + ", " + jsjava.awt.geom.AffineTransform._matround (this.m11) + ", " + jsjava.awt.geom.AffineTransform._matround (this.m12) + "]]");
});
...
function () {
try {
return Clazz.superCall (this, jsjava.awt.geom.AffineTransform, "clone", []);
} catch (e) {
...
function (obj) {
if (!(Clazz.instanceOf (obj, jsjava.awt.geom.AffineTransform))) {
return false;
}var a = obj;
