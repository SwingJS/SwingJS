...
Clazz.load (["jsjava.awt.geom.PathIterator"], "jsjava.awt.geom.EllipseIterator", ["java.util.NoSuchElementException"], function () {
...
}, jsjava.awt.geom, "EllipseIterator", null, jsjava.awt.geom.PathIterator);
...
this.index = 6;
}}, "jsjava.awt.geom.Ellipse2D,jsjava.awt.geom.AffineTransform");
...
var ctrls = jsjava.awt.geom.EllipseIterator.ctrlpts[3];
coords[0] = (this.x + ctrls[4] * this.w);
coords[1] = (this.y + ctrls[5] * this.h);
if (this.affine != null) {
this.affine.transform (coords, 0, coords, 0, 1);
}return 0;
}var ctrls = jsjava.awt.geom.EllipseIterator.ctrlpts[this.index - 1];
