...
Clazz.load (["jsjava.awt.Shape", "jsjava.awt.geom.PathIterator"], "jsjava.awt.geom.Path2D", ["java.lang.Double", "$.IllegalArgumentException", "java.util.Arrays", "jsjava.awt.geom.FlatteningPathIterator", "$.IllegalPathStateException", "$.Point2D", "$.Rectangle2D", "jssun.awt.geom.Curve"], function () {
...
}, jsjava.awt.geom, "Path2D", null, [jsjava.awt.Shape, Cloneable]);
...
c$.contains = Clazz.defineMethod (c$, "contains", 
function (pi, p) {
return jsjava.awt.geom.Path2D.contains (pi, p.getX (), p.getY ());
}, "jsjava.awt.geom.PathIterator,jsjava.awt.geom.Point2D");
...
c$.contains = Clazz.defineMethod (c$, "contains", 
function (pi, r) {
return jsjava.awt.geom.Path2D.contains (pi, r.getX (), r.getY (), r.getWidth (), r.getHeight ());
}, "jsjava.awt.geom.PathIterator,jsjava.awt.geom.Rectangle2D");
Clazz.defineMethod (c$, "contains", 
function (x, y, w, h) {
if (java.lang.Double.isNaN (x + w) || java.lang.Double.isNaN (y + h)) {
return false;
...
c$.intersects = Clazz.defineMethod (c$, "intersects", 
function (pi, r) {
return jsjava.awt.geom.Path2D.intersects (pi, r.getX (), r.getY (), r.getWidth (), r.getHeight ());
}, "jsjava.awt.geom.PathIterator,jsjava.awt.geom.Rectangle2D");
...
Clazz.instantialize (this, arguments);
}, jsjava.awt.geom.Path2D, "Float", jsjava.awt.geom.Path2D);
Clazz.makeConstructor (c$, 
function () {
this.construct (1, 20);
});
...
Clazz.makeConstructor (c$, 
function (a, b) {
Clazz.superConstructor (this, jsjava.awt.geom.Path2D.Float, [a, b]);
...
Clazz.makeConstructor (c$, 
function (a, b) {
Clazz.superConstructor (this, jsjava.awt.geom.Path2D.Float, []);
if (Clazz.instanceOf (a, jsjava.awt.geom.Path2D)) {
var c = a;
...
this.append (c, false);
}}, "jsjava.awt.Shape,jsjava.awt.geom.AffineTransform");
...
function (a) {
return  new jsjava.awt.geom.Point2D.Float (this.floatCoords[a], this.floatCoords[a + 1]);
}, "~N");
...
}, "jsjava.awt.geom.PathIterator,~B");
...
function (a) {
if (a == null) {
return  new jsjava.awt.geom.Path2D.Float.CopyIterator (this);
} else {
return  new jsjava.awt.geom.Path2D.Float.TxIterator (this, a);
}}, "jsjava.awt.geom.AffineTransform");
Clazz.overrideMethod (c$, "clone", 
function () {
if (Clazz.instanceOf (this, jsjava.awt.geom.GeneralPath)) {
return  new jsjava.awt.geom.GeneralPath (this);
} else {
return  new jsjava.awt.geom.Path2D.Float (this);
}});
Clazz.pu$h ();
c$ = Clazz.decorateAsClass (function () {
this.floatCoords = null;
Clazz.instantialize (this, arguments);
}, jsjava.awt.geom.Path2D.Float, "CopyIterator", jsjava.awt.geom.Path2D.Iterator);
Clazz.makeConstructor (c$, 
function (a) {
Clazz.superConstructor (this, jsjava.awt.geom.Path2D.Float.CopyIterator, [a]);
this.floatCoords = a.floatCoords;
}, "jsjava.awt.geom.Path2D.Float");
Clazz.defineMethod (c$, "currentSegment", 
function (a) {
var b = this.path.pointTypes[this.typeIdx];
var c = jsjava.awt.geom.Path2D.Iterator.curvecoords[b];
if (c > 0) {
System.arraycopy (this.floatCoords, this.pointIdx, a, 0, c);
}return b;
}, "~A");
Clazz.defineMethod (c$, "currentSegment", 
function (a) {
...
this.affine = null;
Clazz.instantialize (this, arguments);
}, jsjava.awt.geom.Path2D.Float, "TxIterator", jsjava.awt.geom.Path2D.Iterator);
Clazz.makeConstructor (c$, 
function (a, b) {
Clazz.superConstructor (this, jsjava.awt.geom.Path2D.Float.TxIterator, [a]);
this.floatCoords = a.floatCoords;
this.affine = b;
}, "jsjava.awt.geom.Path2D.Float,jsjava.awt.geom.AffineTransform");
Clazz.defineMethod (c$, "currentSegment", 
function (a) {
var b = this.path.pointTypes[this.typeIdx];
var c = jsjava.awt.geom.Path2D.Iterator.curvecoords[b];
...
Clazz.instantialize (this, arguments);
}, jsjava.awt.geom.Path2D, "Double", jsjava.awt.geom.Path2D);
Clazz.makeConstructor (c$, 
function () {
this.construct (1, 20);
});
...
Clazz.makeConstructor (c$, 
function (a, b) {
Clazz.superConstructor (this, jsjava.awt.geom.Path2D.Double, [a, b]);
...
Clazz.makeConstructor (c$, 
function (a, b) {
Clazz.superConstructor (this, jsjava.awt.geom.Path2D.Double, []);
if (Clazz.instanceOf (a, jsjava.awt.geom.Path2D)) {
var c = a;
this.setWindingRule (c.windingRule);
this.numTypes = c.numTypes;
...
Clazz.overrideMethod (c$, "getPoint", 
function (a) {
return  new jsjava.awt.geom.Point2D.Double (this.doubleCoords[a], this.doubleCoords[a + 1]);
}, "~N");
Clazz.overrideMethod (c$, "needRoom", 
function (a, b) {
if (a && this.numTypes == 0) {
...
function (a) {
if (a == null) {
return  new jsjava.awt.geom.Path2D.Double.CopyIterator (this);
} else {
return  new jsjava.awt.geom.Path2D.Double.TxIterator (this, a);
}}, "jsjava.awt.geom.AffineTransform");
Clazz.overrideMethod (c$, "clone", 
function () {
return  new jsjava.awt.geom.Path2D.Double (this);
});
Clazz.pu$h ();
c$ = Clazz.decorateAsClass (function () {
this.doubleCoords = null;
Clazz.instantialize (this, arguments);
}, jsjava.awt.geom.Path2D.Double, "CopyIterator", jsjava.awt.geom.Path2D.Iterator);
Clazz.makeConstructor (c$, 
function (a) {
Clazz.superConstructor (this, jsjava.awt.geom.Path2D.Double.CopyIterator, [a]);
this.doubleCoords = a.doubleCoords;
}, "jsjava.awt.geom.Path2D.Double");
Clazz.defineMethod (c$, "currentSegment", 
function (a) {
var b = this.path.pointTypes[this.typeIdx];
var c = jsjava.awt.geom.Path2D.Iterator.curvecoords[b];
...
this.affine = null;
Clazz.instantialize (this, arguments);
}, jsjava.awt.geom.Path2D.Double, "TxIterator", jsjava.awt.geom.Path2D.Iterator);
Clazz.makeConstructor (c$, 
function (a, b) {
Clazz.superConstructor (this, jsjava.awt.geom.Path2D.Double.TxIterator, [a]);
this.doubleCoords = a.doubleCoords;
this.affine = b;
}, "jsjava.awt.geom.Path2D.Double,jsjava.awt.geom.AffineTransform");
Clazz.defineMethod (c$, "currentSegment", 
function (a) {
var b = this.path.pointTypes[this.typeIdx];
var c = jsjava.awt.geom.Path2D.Iterator.curvecoords[b];
...
this.path = null;
Clazz.instantialize (this, arguments);
}, jsjava.awt.geom.Path2D, "Iterator", null, jsjava.awt.geom.PathIterator);
Clazz.makeConstructor (c$, 
function (a) {
this.path = a;
}, "jsjava.awt.geom.Path2D");
...
this.pointIdx += jsjava.awt.geom.Path2D.Iterator.curvecoords[a];
});
