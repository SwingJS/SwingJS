...
Clazz.load (["jsjava.awt.Shape", "jsjava.awt.geom.PathIterator", "java.util.Vector"], ["jsjava.awt.geom.Area", "$.AreaIterator"], ["java.lang.NullPointerException", "java.util.NoSuchElementException", "jsjava.awt.geom.FlatteningPathIterator", "$.Rectangle2D", "jssun.awt.geom.AreaOp", "$.Crossings", "$.Curve"], function () {
c$ = Clazz.decorateAsClass (function () {
this.curves = null;
this.cachedBounds = null;
Clazz.instantialize (this, arguments);
}, jsjava.awt.geom, "Area", null, [jsjava.awt.Shape, Cloneable]);
Clazz.makeConstructor (c$, 
function () {
this.curves = jsjava.awt.geom.Area.EmptyCurves;
});
Clazz.makeConstructor (c$, 
function (s) {
if (Clazz.instanceOf (s, jsjava.awt.geom.Area)) {
this.curves = (s).curves;
} else {
this.curves = jsjava.awt.geom.Area.pathToCurves (s.getPathIterator (null));
}}, "jsjava.awt.Shape");
...
}return operator.calculate (curves, jsjava.awt.geom.Area.EmptyCurves);
}, $fz.isPrivate = true, $fz), "jsjava.awt.geom.PathIterator");
...
}var r =  new jsjava.awt.geom.Rectangle2D.Double ();
...
function () {
return  new jsjava.awt.geom.Area (this);
});
...
}this.curves = jsjava.awt.geom.Area.pathToCurves (this.getPathIterator (t));
this.invalidateBounds ();
}, "jsjava.awt.geom.AffineTransform");
Clazz.defineMethod (c$, "createTransformedArea", 
function (t) {
var a =  new jsjava.awt.geom.Area (this);
a.transform (t);
return a;
}, "jsjava.awt.geom.AffineTransform");
...
function (at) {
return  new jsjava.awt.geom.AreaIterator (this.curves, at);
}, "jsjava.awt.geom.AffineTransform");
Clazz.defineMethod (c$, "getPathIterator", 
...
this.thiscurve = null;
Clazz.instantialize (this, arguments);
}, jsjava.awt.geom, "AreaIterator", null, jsjava.awt.geom.PathIterator);
Clazz.makeConstructor (c$, 
function (curves, at) {
this.curves = curves;
this.transform = at;
...
}}, "java.util.Vector,jsjava.awt.geom.AffineTransform");
