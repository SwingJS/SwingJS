...
Clazz.load (["jsjava.awt.Shape"], "jsjava.awt.geom.CubicCurve2D", ["java.lang.InternalError", "java.util.Arrays", "jsjava.awt.geom.CubicIterator", "$.FlatteningPathIterator", "$.Line2D", "$.Point2D", "$.QuadCurve2D", "$.Rectangle2D", "jssun.awt.geom.Curve"], function () {
c$ = Clazz.declareType (jsjava.awt.geom, "CubicCurve2D", null, [jsjava.awt.Shape, Cloneable]);
...
}, "jsjava.awt.geom.Point2D,jsjava.awt.geom.Point2D,jsjava.awt.geom.Point2D,jsjava.awt.geom.Point2D");
Clazz.defineMethod (c$, "setCurve", 
function (pts, offset) {
...
}, "jsjava.awt.geom.CubicCurve2D");
c$.getFlatnessSq = Clazz.defineMethod (c$, "getFlatnessSq", 
function (x1, y1, ctrlx1, ctrly1, ctrlx2, ctrly2, x2, y2) {
return Math.max (jsjava.awt.geom.Line2D.ptSegDistSq (x1, y1, x2, y2, ctrlx1, ctrly1), jsjava.awt.geom.Line2D.ptSegDistSq (x1, y1, x2, y2, ctrlx2, ctrly2));
}, "~N,~N,~N,~N,~N,~N,~N,~N");
c$.getFlatness = Clazz.defineMethod (c$, "getFlatness", 
function (x1, y1, ctrlx1, ctrly1, ctrlx2, ctrly2, x2, y2) {
return Math.sqrt (jsjava.awt.geom.CubicCurve2D.getFlatnessSq (x1, y1, ctrlx1, ctrly1, ctrlx2, ctrly2, x2, y2));
}, "~N,~N,~N,~N,~N,~N,~N,~N");
c$.getFlatnessSq = Clazz.defineMethod (c$, "getFlatnessSq", 
function (coords, offset) {
return jsjava.awt.geom.CubicCurve2D.getFlatnessSq (coords[offset + 0], coords[offset + 1], coords[offset + 2], coords[offset + 3], coords[offset + 4], coords[offset + 5], coords[offset + 6], coords[offset + 7]);
}, "~A,~N");
c$.getFlatness = Clazz.defineMethod (c$, "getFlatness", 
function (coords, offset) {
return jsjava.awt.geom.CubicCurve2D.getFlatness (coords[offset + 0], coords[offset + 1], coords[offset + 2], coords[offset + 3], coords[offset + 4], coords[offset + 5], coords[offset + 6], coords[offset + 7]);
}, "~A,~N");
Clazz.defineMethod (c$, "getFlatnessSq", 
function () {
return jsjava.awt.geom.CubicCurve2D.getFlatnessSq (this.getX1 (), this.getY1 (), this.getCtrlX1 (), this.getCtrlY1 (), this.getCtrlX2 (), this.getCtrlY2 (), this.getX2 (), this.getY2 ());
});
Clazz.defineMethod (c$, "getFlatness", 
function () {
return jsjava.awt.geom.CubicCurve2D.getFlatness (this.getX1 (), this.getY1 (), this.getCtrlX1 (), this.getCtrlY1 (), this.getCtrlX2 (), this.getCtrlY2 (), this.getX2 (), this.getY2 ());
});
Clazz.defineMethod (c$, "subdivide", 
function (left, right) {
jsjava.awt.geom.CubicCurve2D.subdivide (this, left, right);
}, "jsjava.awt.geom.CubicCurve2D,jsjava.awt.geom.CubicCurve2D");
...
}}, "jsjava.awt.geom.CubicCurve2D,jsjava.awt.geom.CubicCurve2D,jsjava.awt.geom.CubicCurve2D");
c$.subdivide = Clazz.defineMethod (c$, "subdivide", 
...
function (eqn) {
return jsjava.awt.geom.CubicCurve2D.solveCubic (eqn, eqn);
}, "~A");
c$.solveCubic = Clazz.defineMethod (c$, "solveCubic", 
function (eqn, res) {
var d = eqn[3];
if (d == 0.0) {
return jsjava.awt.geom.QuadCurve2D.solveQuadratic (eqn, res);
}var a = eqn[2] / d;
var b = eqn[1] / d;
var c = eqn[0] / d;
var roots = 0;
...
res[roots++] = Q * Math.cos ((theta - 6.283185307179586) / 3.0) - a;
jsjava.awt.geom.CubicCurve2D.fixRoots (res, eqn);
} else {
var neg = (R < 0.0);
...
res[i] = jsjava.awt.geom.CubicCurve2D.findZero (t, 0, eqn);
} else if (Math.abs (t - 1) < 1.0E-5) {
res[i] = jsjava.awt.geom.CubicCurve2D.findZero (t, 1, eqn);
}}
...
var origt = t;
while (true) {
slope = jsjava.awt.geom.CubicCurve2D.solveEqn (slopeqn, 2, t);
if (slope == 0) {
return t;
}var y = jsjava.awt.geom.CubicCurve2D.solveEqn (eqn, 3, t);
if (y == 0) {
return t;
}var delta = -(y / slope);
if (origdelta == 0) {
...
var tag = (origt < t ? jsjava.awt.geom.CubicCurve2D.getTag (target, origt, t) : jsjava.awt.geom.CubicCurve2D.getTag (target, t, origt));
if (tag != 0) {
return (origt + t) / 2;
}t = target;
} else {
...
var y1 = this.getY1 ();
var x1tag = jsjava.awt.geom.CubicCurve2D.getTag (x1, x, x + w);
var y1tag = jsjava.awt.geom.CubicCurve2D.getTag (y1, y, y + h);
if (x1tag == 0 && y1tag == 0) {
return true;
}var x2 = this.getX2 ();
var y2 = this.getY2 ();
var x2tag = jsjava.awt.geom.CubicCurve2D.getTag (x2, x, x + w);
var y2tag = jsjava.awt.geom.CubicCurve2D.getTag (y2, y, y + h);
if (x2tag == 0 && y2tag == 0) {
return true;
...
var ctrlx1tag = jsjava.awt.geom.CubicCurve2D.getTag (ctrlx1, x, x + w);
var ctrly1tag = jsjava.awt.geom.CubicCurve2D.getTag (ctrly1, y, y + h);
var ctrlx2tag = jsjava.awt.geom.CubicCurve2D.getTag (ctrlx2, x, x + w);
var ctrly2tag = jsjava.awt.geom.CubicCurve2D.getTag (ctrly2, y, y + h);
...
return false;
}if (jsjava.awt.geom.CubicCurve2D.inwards (x1tag, x2tag, ctrlx1tag) && jsjava.awt.geom.CubicCurve2D.inwards (y1tag, y2tag, ctrly1tag)) {
return true;
}if (jsjava.awt.geom.CubicCurve2D.inwards (x2tag, x1tag, ctrlx2tag) && jsjava.awt.geom.CubicCurve2D.inwards (y2tag, y1tag, ctrly2tag)) {
return true;
...
if (!yoverlap) {
jsjava.awt.geom.CubicCurve2D.fillEqn (eqn, (y1tag < 0 ? y : y + h), y1, ctrly1, ctrly2, y2);
var num = jsjava.awt.geom.CubicCurve2D.solveCubic (eqn, res);
num = jsjava.awt.geom.CubicCurve2D.evalCubic (res, num, true, true, null, x1, ctrlx1, ctrlx2, x2);
return (num == 2 && jsjava.awt.geom.CubicCurve2D.getTag (res[0], x, x + w) * jsjava.awt.geom.CubicCurve2D.getTag (res[1], x, x + w) <= 0);
}if (!xoverlap) {
jsjava.awt.geom.CubicCurve2D.fillEqn (eqn, (x1tag < 0 ? x : x + w), x1, ctrlx1, ctrlx2, x2);
var num = jsjava.awt.geom.CubicCurve2D.solveCubic (eqn, res);
num = jsjava.awt.geom.CubicCurve2D.evalCubic (res, num, true, true, null, y1, ctrly1, ctrly2, y2);
return (num == 2 && jsjava.awt.geom.CubicCurve2D.getTag (res[0], y, y + h) * jsjava.awt.geom.CubicCurve2D.getTag (res[1], y, y + h) <= 0);
}var dx = x2 - x1;
var dy = y2 - y1;
var k = y2 * x1 - x2 * y1;
var c1tag;
...
c1tag = jsjava.awt.geom.CubicCurve2D.getTag ((k + dx * (y1tag < 0 ? y : y + h)) / dy, x, x + w);
}if (y2tag == 0) {
c2tag = x2tag;
} else {
c2tag = jsjava.awt.geom.CubicCurve2D.getTag ((k + dx * (y2tag < 0 ? y : y + h)) / dy, x, x + w);
}if (c1tag * c2tag <= 0) {
return true;
}c1tag = ((c1tag * x1tag <= 0) ? y1tag : y2tag);
jsjava.awt.geom.CubicCurve2D.fillEqn (eqn, (c2tag < 0 ? x : x + w), x1, ctrlx1, ctrlx2, x2);
var num = jsjava.awt.geom.CubicCurve2D.solveCubic (eqn, res);
num = jsjava.awt.geom.CubicCurve2D.evalCubic (res, num, true, true, null, y1, ctrly1, ctrly2, y2);
var tags =  Clazz.newIntArray (num + 1, 0);
for (var i = 0; i < num; i++) {
tags[i] = jsjava.awt.geom.CubicCurve2D.getTag (res[i], y, y + h);
}
tags[num] = c1tag;
...
return false;
}var rect =  new jsjava.awt.geom.Rectangle2D.Double (x, y, w, h);
...
function (at) {
return  new jsjava.awt.geom.CubicIterator (this, at);
...
function () {
try {
return Clazz.superCall (this, jsjava.awt.geom.CubicCurve2D, "clone", []);
} catch (e) {
...
}, jsjava.awt.geom.CubicCurve2D, "Float", jsjava.awt.geom.CubicCurve2D);
Clazz.makeConstructor (c$, 
function () {
Clazz.superConstructor (this, jsjava.awt.geom.CubicCurve2D.Float, []);
});
Clazz.makeConstructor (c$, 
...
function () {
return  new jsjava.awt.geom.Point2D.Float (this.ctrlx1, this.ctrly1);
});
...
function () {
return  new jsjava.awt.geom.Point2D.Float (this.ctrlx2, this.ctrly2);
});
...
return  new jsjava.awt.geom.Rectangle2D.Float (a, b, c - a, d - b);
});
c$ = Clazz.p0p ();
Clazz.pu$h ();
c$ = Clazz.decorateAsClass (function () {
...
this.y2 = 0;
Clazz.instantialize (this, arguments);
}, jsjava.awt.geom.CubicCurve2D, "Double", jsjava.awt.geom.CubicCurve2D);
Clazz.makeConstructor (c$, 
function () {
Clazz.superConstructor (this, jsjava.awt.geom.CubicCurve2D.Double, []);
});
Clazz.makeConstructor (c$, 
function (a, b, c, d, e, f, g, h) {
Clazz.superConstructor (this, jsjava.awt.geom.CubicCurve2D.Double, []);
...
Clazz.overrideMethod (c$, "getCtrlP1", 
function () {
return  new jsjava.awt.geom.Point2D.Double (this.ctrlx1, this.ctrly1);
});
Clazz.overrideMethod (c$, "getCtrlX2", 
function () {
return this.ctrlx2;
...
Clazz.overrideMethod (c$, "getCtrlP2", 
function () {
return  new jsjava.awt.geom.Point2D.Double (this.ctrlx2, this.ctrly2);
});
Clazz.overrideMethod (c$, "getX2", 
function () {
return this.x2;
...
var c = Math.max (Math.max (this.x1, this.x2), Math.max (this.ctrlx1, this.ctrlx2));
var d = Math.max (Math.max (this.y1, this.y2), Math.max (this.ctrly1, this.ctrly2));
return  new jsjava.awt.geom.Rectangle2D.Double (a, b, c - a, d - b);
});
c$ = Clazz.p0p ();
