...
Clazz.load (null, "jsjava.awt.Cursor", ["java.lang.IllegalArgumentException"], function () {
...
}var c = jsjava.awt.Cursor.predefinedPrivate[type];
if (c == null) {
jsjava.awt.Cursor.predefinedPrivate[type] = c =  new jsjava.awt.Cursor (type);
}if (jsjava.awt.Cursor.predefined[type] == null) {
jsjava.awt.Cursor.predefined[type] = c;
}return c;
}, "~N");
