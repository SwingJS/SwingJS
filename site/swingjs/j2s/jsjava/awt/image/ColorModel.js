...
Clazz.load (["jsjava.awt.Transparency", "jsjava.awt.color.ColorSpace"], "jsjava.awt.image.ColorModel", ["java.lang.IllegalArgumentException", "$.NullPointerException", "$.UnsupportedOperationException"], function () {
...
}, jsjava.awt.image, "ColorModel", null, jsjava.awt.Transparency);
Clazz.prepareFields (c$, function () {
this.colorSpace = jsjava.awt.color.ColorSpace.getInstance (1000);
});
c$.getRGBdefault = Clazz.defineMethod (c$, "getRGBdefault", 
function () {
if (jsjava.awt.image.ColorModel.RGBdefault == null) {
jsjava.awt.image.ColorModel.RGBdefault =  new jsjava.awt.image.DirectColorModel (32, 0x00ff0000, 0x0000ff00, 0x000000ff, 0xff000000);
}return jsjava.awt.image.ColorModel.RGBdefault;
});
...
this.maxBits = bits;
this.transferType = jsjava.awt.image.ColorModel.getDefaultTransferType (bits);
}, "~N");
Clazz.makeConstructor (c$, 
...
}if (cspace !== jsjava.awt.color.ColorSpace.getInstance (1000)) {
this.is_sRGB = false;
}this.transferType = transferType;
}, "~N,~A,jsjava.awt.color.ColorSpace,~B,~B,~N,~N");
...
function (obj) {
if (!(Clazz.instanceOf (obj, jsjava.awt.image.ColorModel))) {
return false;
}var cm = obj;
if (this === cm) {
return true;
