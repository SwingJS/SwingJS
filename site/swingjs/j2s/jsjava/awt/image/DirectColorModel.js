...
Clazz.load (["jsjava.awt.image.PackedColorModel"], "jsjava.awt.image.DirectColorModel", ["java.lang.ClassCastException", "$.UnsupportedOperationException", "jsjava.awt.color.ColorSpace", "jsjava.awt.image.ColorModel"], function () {
...
}, jsjava.awt.image, "DirectColorModel", jsjava.awt.image.PackedColorModel);
...
Clazz.superConstructor (this, jsjava.awt.image.DirectColorModel, [jsjava.awt.color.ColorSpace.getInstance (1000), bits, rmask, gmask, bmask, amask, false, amask == 0 ? 1 : 3, jsjava.awt.image.ColorModel.getDefaultTransferType (bits)]);
}, "~N,~N,~N,~N,~N");
Clazz.makeConstructor (c$, 
function (space, bits, rmask, gmask, bmask, amask, isAlphaPremultiplied, transferType) {
Clazz.superConstructor (this, jsjava.awt.image.DirectColorModel, [space, bits, rmask, gmask, bmask, amask, isAlphaPremultiplied, amask == 0 ? 1 : 3, transferType]);
}, "jsjava.awt.color.ColorSpace,~N,~N,~N,~N,~N,~B,~N");
...
}var defaultCM = jsjava.awt.image.ColorModel.getRGBdefault ();
...
var sdata;
if (pixel == null) {
sdata =  Clazz.newShortArray (1, 0);
} else {
sdata = pixel;
}sdata[0] = (intpixel[0] & 0xffff);
return sdata;
}case 3:
return intpixel;
}
...
if (Clazz.instanceOf (obj, Array)) {
var sdata = obj;
sdata[0] = (pixel & 0xffff);
return sdata;
} else {
var sdata =  Clazz.newShortArray (-1, [(pixel & 0xffff)]);
return sdata;
}case 3:
if (Clazz.instanceOf (obj, Array)) {
var idata = obj;
