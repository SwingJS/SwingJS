...
Clazz.load (["jsjava.awt.image.ImageConsumer"], "jsjava.awt.image.PixelGrabber", ["jsjava.awt.image.ColorModel"], function () {
...
}, jsjava.awt.image, "PixelGrabber", null, jsjava.awt.image.ImageConsumer);
Clazz.makeConstructor (c$, 
function (img, x, y, w, h, pix, off, scansize) {
this.construct (img.getSource (), x, y, w, h, pix, off, scansize);
}, "jsjava.awt.Image,~N,~N,~N,~N,~A,~N,~N");
Clazz.makeConstructor (c$, 
...
this.intPixels = pix;
this.imageModel = jsjava.awt.image.ColorModel.getRGBdefault ();
}, "jsjava.awt.image.ImageProducer,~N,~N,~N,~N,~A,~N,~N");
Clazz.makeConstructor (c$, 
...
} else if (this.intPixels == null && this.imageModel === jsjava.awt.image.ColorModel.getRGBdefault ()) {
...
if (this.imageModel !== jsjava.awt.image.ColorModel.getRGBdefault ()) {
this.convertToRGB ();
}var dstRem = this.dstScan - srcW;
var srcRem = srcScan - srcW;
for (var h = srcH; h > 0; h--) {
