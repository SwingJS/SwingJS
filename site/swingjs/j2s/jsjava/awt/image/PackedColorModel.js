...
Clazz.load (["jsjava.awt.image.ColorModel"], "jsjava.awt.image.PackedColorModel", ["java.lang.IllegalArgumentException"], function () {
c$ = Clazz.decorateAsClass (function () {
this.maskArray = null;
this.maskOffsets = null;
this.scaleFactors = null;
Clazz.instantialize (this, arguments);
}, jsjava.awt.image, "PackedColorModel", jsjava.awt.image.ColorModel);
Clazz.makeConstructor (c$, 
function (space, bits, colorMaskArray, alphaMask, isAlphaPremultiplied, trans, transferType) {
Clazz.superConstructor (this, jsjava.awt.image.PackedColorModel, [bits, jsjava.awt.image.PackedColorModel.createBitsArray (colorMaskArray, alphaMask), space, (alphaMask == 0 ? false : true), isAlphaPremultiplied, trans, transferType]);
if (bits < 1 || bits > 32) {
...
this.transparency = 2;
}}}, "jsjava.awt.color.ColorSpace,~N,~A,~N,~B,~N,~N");
Clazz.makeConstructor (c$, 
function (space, bits, rmask, gmask, bmask, amask, isAlphaPremultiplied, trans, transferType) {
Clazz.superConstructor (this, jsjava.awt.image.PackedColorModel, [bits, jsjava.awt.image.PackedColorModel.createBitsArray (rmask, gmask, bmask, amask), space, (amask == 0 ? false : true), isAlphaPremultiplied, trans, transferType]);
if (space.getType () != 5) {
...
if (this.nBits[3] == 1) {
this.transparency = 2;
}}}, "jsjava.awt.color.ColorSpace,~N,~N,~N,~N,~N,~B,~N,~N");
...
($fz = function (mask, idx, componentName) {
var off = 0;
...
function (obj) {
if (!(Clazz.instanceOf (obj, jsjava.awt.image.PackedColorModel))) {
return false;
}if (!Clazz.superCall (this, jsjava.awt.image.PackedColorModel, "equals", [obj])) {
return false;
}var cm = obj;
...
arr[3] = jsjava.awt.image.PackedColorModel.countBits (amask);
if (arr[3] < 0) {
