...
Clazz.load (["jsjava.awt.LayoutManager2"], "jsjava.awt.GridBagLayout", ["java.lang.IllegalArgumentException", "java.util.Arrays", "$.Hashtable", "jsjava.awt.Component", "$.Dimension", "$.GridBagConstraints", "$.GridBagLayoutInfo", "$.Point", "$.Rectangle"], function () {
...
}, jsjava.awt, "GridBagLayout", null, [jsjava.awt.LayoutManager2, java.io.Serializable]);
Clazz.makeConstructor (c$, 
function () {
this.comptable =  new java.util.Hashtable ();
this.defaultConstraints =  new jsjava.awt.GridBagConstraints ();
});
Clazz.defineMethod (c$, "setConstraints", 
function (comp, constraints) {
this.comptable.put (comp, constraints.clone ());
}, "jsjava.awt.Component,jsjava.awt.GridBagConstraints");
...
function () {
var origin =  new jsjava.awt.Point (0, 0);
...
Clazz.defineMethod (c$, "addLayoutComponent", 
function (comp, constraints) {
if (Clazz.instanceOf (constraints, jsjava.awt.GridBagConstraints)) {
...
function (target) {
return  new jsjava.awt.Dimension (2147483647, 2147483647);
}, "jsjava.awt.Container");
...
r =  new jsjava.awt.GridBagLayoutInfo (layoutWidth, layoutHeight);
curRow = curCol = -1;
...
if (constraints.baselineResizeBehavior === jsjava.awt.Component.BaselineResizeBehavior.CONSTANT_DESCENT) {
...
} else if (constraints.baselineResizeBehavior !== jsjava.awt.Component.BaselineResizeBehavior.CONSTANT_DESCENT) {
...
($fz = function (c, constraints, size) {
...
if (constraints.baselineResizeBehavior === jsjava.awt.Component.BaselineResizeBehavior.CENTER_OFFSET) {
...
return false;
}}, $fz.isPrivate = true, $fz), "jsjava.awt.Component,jsjava.awt.GridBagConstraints,jsjava.awt.Dimension");
Clazz.defineMethod (c$, "adjustForGravity", 
function (constraints, r) {
this.AdjustForGravity (constraints, r);
}, "jsjava.awt.GridBagConstraints,jsjava.awt.Rectangle");
Clazz.defineMethod (c$, "AdjustForGravity", 
function (constraints, r) {
var diffx;
var diffy;
...
($fz = function (cons, r, cellY, cellHeight) {
if (cons.ascent >= 0) {
if (cons.baselineResizeBehavior === jsjava.awt.Component.BaselineResizeBehavior.CONSTANT_DESCENT) {
...
}if (cons.baselineResizeBehavior === jsjava.awt.Component.BaselineResizeBehavior.OTHER) {
var fits = false;
...
case jsjava.awt.Component.BaselineResizeBehavior.OTHER:
break;
default:
break;
}
...
}}, $fz.isPrivate = true, $fz), "jsjava.awt.GridBagConstraints,jsjava.awt.Rectangle,~N,~N");
...
($fz = function (cons, r, cellHeight) {
if (!cons.isVerticallyResizable ()) {
r.y += Math.max (0, Clazz.doubleToInt ((cellHeight - cons.insets.top - cons.insets.bottom - cons.minHeight - cons.ipady) / 2));
}}, $fz.isPrivate = true, $fz), "jsjava.awt.GridBagConstraints,jsjava.awt.Rectangle,~N");
Clazz.defineMethod (c$, "getMinSize", 
function (parent, info) {
return this.GetMinSize (parent, info);
}, "jsjava.awt.Container,jsjava.awt.GridBagLayoutInfo");
Clazz.defineMethod (c$, "GetMinSize", 
function (parent, info) {
var d =  new jsjava.awt.Dimension ();
var i;
var t;
