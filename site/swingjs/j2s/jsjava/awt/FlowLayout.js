...
Clazz.load (["jsjava.awt.LayoutManager"], "jsjava.awt.FlowLayout", ["jsjava.awt.Dimension"], function () {
...
}, jsjava.awt, "FlowLayout", null, [jsjava.awt.LayoutManager, java.io.Serializable]);
...
function (target) {
{
var dim =  new jsjava.awt.Dimension (0, 0);
...
($fz = function (target, x, y, width, height, rowStart, rowEnd, ltr, useBaseline, ascent, descent) {
...
return height;
}, $fz.isPrivate = true, $fz), "jsjava.awt.Container,~N,~N,~N,~N,~N,~N,~B,~B,~A,~A");
