...
Clazz.load (null, "jsjava.awt.Insets", ["java.lang.InternalError"], function () {
...
}, jsjava.awt, "Insets", null, [Cloneable, java.io.Serializable]);
...
function (obj) {
if (Clazz.instanceOf (obj, jsjava.awt.Insets)) {
var insets = obj;
...
function () {
try {
return Clazz.superCall (this, jsjava.awt.Insets, "clone", []);
} catch (e) {
