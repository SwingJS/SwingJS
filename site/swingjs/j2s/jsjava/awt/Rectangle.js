...
Clazz.load (["jsjava.awt.Shape", "jsjava.awt.geom.Rectangle2D"], "jsjava.awt.Rectangle", ["jsjava.awt.Dimension", "$.Point"], function () {
...
}, jsjava.awt, "Rectangle", jsjava.awt.geom.Rectangle2D, jsjava.awt.Shape);
...
Clazz.superConstructor (this, jsjava.awt.Rectangle, []);
this.x = x;
this.y = y;
this.width = width;
this.height = height;
...
}, "jsjava.awt.Point,jsjava.awt.Dimension");
Clazz.makeConstructor (c$, 
function (p) {
...
newx = jsjava.awt.Rectangle.clip (x, false);
if (width >= 0) width += x - newx;
neww = jsjava.awt.Rectangle.clip (width, width >= 0);
}if (y > 4.294967294E9) {
newy = 2147483647;
newh = -1;
} else {
newy = jsjava.awt.Rectangle.clip (y, false);
if (height >= 0) height += y - newy;
newh = jsjava.awt.Rectangle.clip (height, height >= 0);
}this.reshape (newx, newy, neww, newh);
}, "~N,~N,~N,~N");
c$.clip = Clazz.defineMethod (c$, "clip", 
($fz = function (v, doceil) {
if (v <= -2147483648) {
return -2147483648;
}if (v >= 2147483647) {
return 2147483647;
...
return  new jsjava.awt.Rectangle (tx1, ty1, tx2, ty2);
}, "jsjava.awt.Rectangle");
...
var ty2 = this.height;
if ((tx2 | ty2) < 0) {
return  new jsjava.awt.Rectangle (r);
}var rx2 = r.width;
var ry2 = r.height;
if ((rx2 | ry2) < 0) {
return  new jsjava.awt.Rectangle (this);
}var tx1 = this.x;
var ty1 = this.y;
tx2 += tx1;
ty2 += ty1;
...
function (r) {
if (Clazz.instanceOf (r, jsjava.awt.Rectangle)) {
return this.intersection (r);
}var dest =  new jsjava.awt.geom.Rectangle2D.Double ();
jsjava.awt.geom.Rectangle2D.intersect (this, r, dest);
return dest;
...
jsjava.awt.geom.Rectangle2D.union (this, r, dest);
return dest;
}, "jsjava.awt.geom.Rectangle2D");
Clazz.defineMethod (c$, "equals", 
function (obj) {
if (Clazz.instanceOf (obj, jsjava.awt.Rectangle)) {
var r = obj;
return ((this.x == r.x) && (this.y == r.y) && (this.width == r.width) && (this.height == r.height));
}return Clazz.superCall (this, jsjava.awt.Rectangle, "equals", [obj]);
}, "~O");
