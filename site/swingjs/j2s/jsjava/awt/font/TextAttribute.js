...
Clazz.load (["jsjava.text.AttributedCharacterIterator", "java.lang.Boolean", "$.Float", "java.util.HashMap"], "jsjava.awt.font.TextAttribute", ["java.io.InvalidObjectException"], function () {
c$ = Clazz.declareType (jsjava.awt.font, "TextAttribute", jsjava.text.AttributedCharacterIterator.Attribute);
Clazz.makeConstructor (c$, 
function (name) {
Clazz.superConstructor (this, jsjava.awt.font.TextAttribute, [name]);
if (this.getClass () === jsjava.awt.font.TextAttribute) {
jsjava.awt.font.TextAttribute.$instanceMap.put (name, this);
}}, "~S");
...
}var instance = jsjava.awt.font.TextAttribute.$instanceMap.get (this.getName ());
if (instance != null) {
return instance;
} else {
...
c$.FAMILY = c$.prototype.FAMILY =  new jsjava.awt.font.TextAttribute ("family");
c$.WEIGHT = c$.prototype.WEIGHT =  new jsjava.awt.font.TextAttribute ("weight");
...
c$.WIDTH = c$.prototype.WIDTH =  new jsjava.awt.font.TextAttribute ("width");
...
c$.POSTURE = c$.prototype.POSTURE =  new jsjava.awt.font.TextAttribute ("posture");
...
c$.SIZE = c$.prototype.SIZE =  new jsjava.awt.font.TextAttribute ("size");
c$.TRANSFORM = c$.prototype.TRANSFORM =  new jsjava.awt.font.TextAttribute ("transform");
c$.SUPERSCRIPT = c$.prototype.SUPERSCRIPT =  new jsjava.awt.font.TextAttribute ("superscript");
...
c$.FONT = c$.prototype.FONT =  new jsjava.awt.font.TextAttribute ("font");
c$.CHAR_REPLACEMENT = c$.prototype.CHAR_REPLACEMENT =  new jsjava.awt.font.TextAttribute ("char_replacement");
c$.FOREGROUND = c$.prototype.FOREGROUND =  new jsjava.awt.font.TextAttribute ("foreground");
c$.BACKGROUND = c$.prototype.BACKGROUND =  new jsjava.awt.font.TextAttribute ("background");
c$.UNDERLINE = c$.prototype.UNDERLINE =  new jsjava.awt.font.TextAttribute ("underline");
c$.UNDERLINE_ON = c$.prototype.UNDERLINE_ON = Integer.$valueOf (0);
c$.STRIKETHROUGH = c$.prototype.STRIKETHROUGH =  new jsjava.awt.font.TextAttribute ("strikethrough");
c$.STRIKETHROUGH_ON = c$.prototype.STRIKETHROUGH_ON = Boolean.TRUE;
c$.RUN_DIRECTION = c$.prototype.RUN_DIRECTION =  new jsjava.awt.font.TextAttribute ("run_direction");
...
c$.BIDI_EMBEDDING = c$.prototype.BIDI_EMBEDDING =  new jsjava.awt.font.TextAttribute ("bidi_embedding");
c$.JUSTIFICATION = c$.prototype.JUSTIFICATION =  new jsjava.awt.font.TextAttribute ("justification");
...
c$.INPUT_METHOD_HIGHLIGHT = c$.prototype.INPUT_METHOD_HIGHLIGHT =  new jsjava.awt.font.TextAttribute ("input method highlight");
c$.INPUT_METHOD_UNDERLINE = c$.prototype.INPUT_METHOD_UNDERLINE =  new jsjava.awt.font.TextAttribute ("input method underline");
...
c$.SWAP_COLORS = c$.prototype.SWAP_COLORS =  new jsjava.awt.font.TextAttribute ("swap_colors");
c$.SWAP_COLORS_ON = c$.prototype.SWAP_COLORS_ON = Boolean.TRUE;
c$.NUMERIC_SHAPING = c$.prototype.NUMERIC_SHAPING =  new jsjava.awt.font.TextAttribute ("numeric_shaping");
c$.KERNING = c$.prototype.KERNING =  new jsjava.awt.font.TextAttribute ("kerning");
c$.KERNING_ON = c$.prototype.KERNING_ON = Integer.$valueOf (1);
c$.LIGATURES = c$.prototype.LIGATURES =  new jsjava.awt.font.TextAttribute ("ligatures");
c$.LIGATURES_ON = c$.prototype.LIGATURES_ON = Integer.$valueOf (1);
c$.TRACKING = c$.prototype.TRACKING =  new jsjava.awt.font.TextAttribute ("tracking");
