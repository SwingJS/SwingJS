Clazz.declarePackage ("jsjava.awt.color");
Clazz.load (null, "jsjava.awt.color.ColorSpace", ["java.lang.IllegalArgumentException"], function () {
...
default:
case 1000:
if (jsjava.awt.color.ColorSpace.sRGBspace == null) {
jsjava.awt.color.ColorSpace.sRGBspace =  new jsjava.awt.color.ColorSpace (1000, 4);
}theColorSpace = jsjava.awt.color.ColorSpace.sRGBspace;
break;
}
...
function () {
return (this === jsjava.awt.color.ColorSpace.sRGBspace);
});
