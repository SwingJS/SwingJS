...
Clazz.load (null, ["jsjava.awt.AWTKeyStroke", "$.VKCollection"], ["java.io.ObjectStreamException", "java.lang.IllegalArgumentException", "$.StringBuilder", "java.util.Collections", "$.HashMap", "$.StringTokenizer", "jsjava.awt.event.KeyEvent", "jssun.awt.AppContext"], function () {
...
($fz = function () {
var clazz = jssun.awt.AppContext.getAppContext ().get (jsjava.awt.AWTKeyStroke);
if (clazz == null) {
clazz = jsjava.awt.AWTKeyStroke;
jssun.awt.AppContext.getAppContext ().put (jsjava.awt.AWTKeyStroke, jsjava.awt.AWTKeyStroke);
}return clazz;
...
($fz = function (keyChar, keyCode, modifiers, onKeyRelease) {
return null;
}, $fz.isPrivate = true, $fz), "~S,~N,~N,~B");
c$.getAWTKeyStroke = Clazz.defineMethod (c$, "getAWTKeyStroke", 
function (keyChar) {
return jsjava.awt.AWTKeyStroke.getCachedStroke (keyChar, 0, 0, false);
}, "~S");
c$.getAWTKeyStroke = Clazz.defineMethod (c$, "getAWTKeyStroke", 
function (keyChar, modifiers) {
if (keyChar == null) {
throw  new IllegalArgumentException ("keyChar cannot be null");
}return jsjava.awt.AWTKeyStroke.getCachedStroke (keyChar.charValue (), 0, modifiers, false);
}, "Character,~N");
c$.getAWTKeyStroke = Clazz.defineMethod (c$, "getAWTKeyStroke", 
function (keyCode, modifiers, onKeyRelease) {
return jsjava.awt.AWTKeyStroke.getCachedStroke ('\uffff', keyCode, modifiers, onKeyRelease);
}, "~N,~N,~B");
c$.getAWTKeyStroke = Clazz.defineMethod (c$, "getAWTKeyStroke", 
function (keyCode, modifiers) {
return jsjava.awt.AWTKeyStroke.getCachedStroke ('\uffff', keyCode, modifiers, false);
}, "~N,~N");
...
case 401:
case 402:
return jsjava.awt.AWTKeyStroke.getCachedStroke ('\uffff', anEvent.getKeyCode (), anEvent.getModifiers (), (id == 402));
case 400:
return jsjava.awt.AWTKeyStroke.getCachedStroke (anEvent.getKeyChar (), 0, anEvent.getModifiers (), false);
default:
return null;
}
...
var pressed = false;
{
if (jsjava.awt.AWTKeyStroke.modifierKeywords == null) {
...
jsjava.awt.AWTKeyStroke.modifierKeywords = java.util.Collections.synchronizedMap (uninitializedMap);
...
}return jsjava.awt.AWTKeyStroke.getCachedStroke (token.charAt (0), 0, mask, false);
}if (pressed || released || i == count) {
if (i != count) {
throw  new IllegalArgumentException ("String formatted incorrectly");
}var keyCodeName = "VK_" + token;
var keyCode = jsjava.awt.AWTKeyStroke.getVKValue (keyCodeName);
return jsjava.awt.AWTKeyStroke.getCachedStroke ('\uffff', keyCode, mask, released);
...
typed = true;
continue;
}var tokenMask = jsjava.awt.AWTKeyStroke.modifierKeywords.get (token);
if (tokenMask != null) {
...
($fz = function () {
if (jsjava.awt.AWTKeyStroke.vks == null) {
jsjava.awt.AWTKeyStroke.vks =  new jsjava.awt.VKCollection ();
}return jsjava.awt.AWTKeyStroke.vks;
}, $fz.isPrivate = true, $fz));
c$.getVKValue = Clazz.defineMethod (c$, "getVKValue", 
($fz = function (key) {
var vkCollect = jsjava.awt.AWTKeyStroke.getVKCollection ();
var value = vkCollect.findCode (key);
if (value == null) {
var keyCode = 0;
var errmsg = "String formatted incorrectly";
try {
keyCode = jsjava.awt.event.KeyEvent.getField (key).getInt (jsjava.awt.event.KeyEvent);
} catch (e$$) {
...
function (anObject) {
if (Clazz.instanceOf (anObject, jsjava.awt.AWTKeyStroke)) {
var ks = anObject;
...
function () {
if (this.keyCode == 0) {
return jsjava.awt.AWTKeyStroke.getModifiersText (this.modifiers) + "typed " + this.keyChar;
} else {
return jsjava.awt.AWTKeyStroke.getModifiersText (this.modifiers) + (this.onKeyRelease ? "released" : "pressed") + " " + jsjava.awt.AWTKeyStroke.getVKText (this.keyCode);
}});
...
var awtKeyStrokeClass = jsjava.awt.AWTKeyStroke.getAWTKeyStrokeClass ();
if (!newClass.equals (awtKeyStrokeClass)) {
jsjava.awt.AWTKeyStroke.registerSubclass (newClass);
}return jsjava.awt.AWTKeyStroke.getCachedStroke (this.keyChar, this.keyCode, this.modifiers, this.onKeyRelease);
}});
