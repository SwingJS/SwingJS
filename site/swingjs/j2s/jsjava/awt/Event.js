...
for (var i = 0; i < jsjava.awt.Event.actionKeyCodes.length; i++) {
if (jsjava.awt.Event.actionKeyCodes[i][0] == keyCode) {
return jsjava.awt.Event.actionKeyCodes[i][1];
}}
...
function () {
for (var i = 0; i < jsjava.awt.Event.actionKeyCodes.length; i++) {
if (jsjava.awt.Event.actionKeyCodes[i][1] == this.key) {
return '\uffff';
}}
