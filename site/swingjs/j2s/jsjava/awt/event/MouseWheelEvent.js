...
Clazz.load (["jsjava.awt.event.MouseEvent"], "jsjava.awt.event.MouseWheelEvent", null, function () {
c$ = Clazz.decorateAsClass (function () {
this.scrollType = 0;
this.scrollAmount = 0;
this.wheelRotation = 0;
Clazz.instantialize (this, arguments);
}, jsjava.awt.event, "MouseWheelEvent", jsjava.awt.event.MouseEvent);
...
}, "jsjava.awt.Component,~N,~N,~N,~N,~N,~N,~B,~N,~N,~N");
Clazz.makeConstructor (c$, 
function (source, id, when, modifiers, x, y, xAbs, yAbs, clickCount, popupTrigger, scrollType, scrollAmount, wheelRotation) {
Clazz.superConstructor (this, jsjava.awt.event.MouseWheelEvent, [source, id, when, modifiers, x, y, xAbs, yAbs, clickCount, popupTrigger, 0]);
this.scrollType = scrollType;
this.scrollAmount = scrollAmount;
this.wheelRotation = wheelRotation;
}, "jsjava.awt.Component,~N,~N,~N,~N,~N,~N,~N,~N,~B,~N,~N,~N");
...
}return Clazz.superCall (this, jsjava.awt.event.MouseWheelEvent, "paramString", []) + ",scrollType=" + scrollTypeStr + ",scrollAmount=" + this.getScrollAmount () + ",wheelRotation=" + this.getWheelRotation ();
});
