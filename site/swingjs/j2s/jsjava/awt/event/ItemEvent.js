...
Clazz.load (["jsjava.awt.AWTEvent"], "jsjava.awt.event.ItemEvent", null, function () {
c$ = Clazz.decorateAsClass (function () {
this.item = null;
this.stateChange = 0;
Clazz.instantialize (this, arguments);
}, jsjava.awt.event, "ItemEvent", jsjava.awt.AWTEvent);
Clazz.makeConstructor (c$, 
function (source, id, item, stateChange) {
Clazz.superConstructor (this, jsjava.awt.event.ItemEvent, [source, id]);
this.item = item;
this.stateChange = stateChange;
}, "jsjava.awt.ItemSelectable,~N,~O,~N");
