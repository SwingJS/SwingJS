...
Clazz.load (["jsjava.awt.event.ComponentEvent"], "jsjava.awt.event.WindowEvent", ["jsjava.awt.Window", "jssun.awt.AppContext", "$.SunToolkit"], function () {
c$ = Clazz.decorateAsClass (function () {
this.opposite = null;
this.oldState = 0;
this.newState = 0;
Clazz.instantialize (this, arguments);
}, jsjava.awt.event, "WindowEvent", jsjava.awt.event.ComponentEvent);
Clazz.makeConstructor (c$, 
function (source, id, opposite, oldState, newState) {
Clazz.superConstructor (this, jsjava.awt.event.WindowEvent, [source, id]);
this.opposite = opposite;
this.oldState = oldState;
this.newState = newState;
}, "jsjava.awt.Window,~N,jsjava.awt.Window,~N,~N");
Clazz.makeConstructor (c$, 
function (source, id, opposite) {
this.construct (source, id, opposite, 0, 0);
}, "jsjava.awt.Window,~N,jsjava.awt.Window");
Clazz.makeConstructor (c$, 
function (source, id, oldState, newState) {
this.construct (source, id, null, oldState, newState);
}, "jsjava.awt.Window,~N,~N,~N");
Clazz.makeConstructor (c$, 
function (source, id) {
...
function () {
return (Clazz.instanceOf (this.source, jsjava.awt.Window)) ? this.source : null;
});
