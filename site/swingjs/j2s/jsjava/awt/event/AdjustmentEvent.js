...
Clazz.load (["jsjava.awt.AWTEvent"], "jsjava.awt.event.AdjustmentEvent", null, function () {
...
}, jsjava.awt.event, "AdjustmentEvent", jsjava.awt.AWTEvent);
Clazz.makeConstructor (c$, 
function (source, id, type, value) {
this.construct (source, id, type, value, false);
}, "jsjava.awt.Adjustable,~N,~N,~N");
Clazz.makeConstructor (c$, 
function (source, id, type, value, isAdjusting) {
Clazz.superConstructor (this, jsjava.awt.event.AdjustmentEvent, [source, id]);
this.adjustable = source;
this.adjustmentType = type;
this.value = value;
this.isAdjusting = isAdjusting;
}, "jsjava.awt.Adjustable,~N,~N,~N,~B");
