...
Clazz.load (["jsjava.text.NumberFormat", "java.util.Hashtable", "jsjava.text.DigitList"], "jsjava.text.DecimalFormat", ["java.lang.Byte", "$.Character", "$.Double", "$.Float", "$.IllegalArgumentException", "$.InternalError", "$.Long", "$.NullPointerException", "$.Number", "$.Short", "$.StringBuffer", "java.util.ArrayList", "$.Currency", "$.Locale", "jsjava.text.CharacterIteratorFieldDelegate", "$.DecimalFormatSymbols", "$.FieldPosition", "$.ParsePosition", "jssun.util.resources.LocaleData"], function () {
...
}, jsjava.text, "DecimalFormat", jsjava.text.NumberFormat);
Clazz.prepareFields (c$, function () {
this.digitList =  new jsjava.text.DigitList ();
this.$maximumIntegerDigits = Clazz.superCall (this, jsjava.text.DecimalFormat, "getMaximumIntegerDigits", []);
this.$minimumIntegerDigits = Clazz.superCall (this, jsjava.text.DecimalFormat, "getMinimumIntegerDigits", []);
this.$maximumFractionDigits = Clazz.superCall (this, jsjava.text.DecimalFormat, "getMaximumFractionDigits", []);
this.$minimumFractionDigits = Clazz.superCall (this, jsjava.text.DecimalFormat, "getMinimumFractionDigits", []);
});
Clazz.makeConstructor (c$, 
function () {
Clazz.superConstructor (this, jsjava.text.DecimalFormat, []);
var def = java.util.Locale.getDefault ();
var pattern = jsjava.text.DecimalFormat.$cachedLocaleData.get (def);
if (pattern == null) {
var rb = jssun.util.resources.LocaleData.getNumberFormatData (def);
var all = rb.getStringArray ("NumberPatterns");
pattern = all[0];
jsjava.text.DecimalFormat.$cachedLocaleData.put (def, pattern);
}this.symbols =  new jsjava.text.DecimalFormatSymbols (def);
this.applyPattern (pattern, false);
});
Clazz.makeConstructor (c$, 
function (pattern) {
Clazz.superConstructor (this, jsjava.text.DecimalFormat, []);
this.symbols =  new jsjava.text.DecimalFormatSymbols (java.util.Locale.getDefault ());
this.applyPattern (pattern, false);
}, "~S");
Clazz.makeConstructor (c$, 
...
this.applyPattern (pattern, false);
}, "~S,jsjava.text.DecimalFormatSymbols");
...
}, "~N,StringBuffer,jsjava.text.FieldPosition");
Clazz.defineMethod (c$, "format", 
($fz = function (number, result, delegate) {
...
delegate.formatted (0, jsjava.text.NumberFormat.Field.INTEGER, jsjava.text.NumberFormat.Field.INTEGER, iFieldStart, result.length (), result);
return result;
...
if (isNegative) {
this.append (result, this.negativePrefix, delegate, this.getNegativePrefixFieldPositions (), jsjava.text.NumberFormat.Field.SIGN);
} else {
this.append (result, this.positivePrefix, delegate, this.getPositivePrefixFieldPositions (), jsjava.text.NumberFormat.Field.SIGN);
}var iFieldStart = result.length ();
result.append (this.symbols.getInfinity ());
delegate.formatted (0, jsjava.text.NumberFormat.Field.INTEGER, jsjava.text.NumberFormat.Field.INTEGER, iFieldStart, result.length (), result);
if (isNegative) {
this.append (result, this.negativeSuffix, delegate, this.getNegativeSuffixFieldPositions (), jsjava.text.NumberFormat.Field.SIGN);
} else {
this.append (result, this.positiveSuffix, delegate, this.getPositiveSuffixFieldPositions (), jsjava.text.NumberFormat.Field.SIGN);
}return result;
}if (isNegative) {
number = -number;
}{
var maxIntDigits = Clazz.superCall (this, jsjava.text.DecimalFormat, "getMaximumIntegerDigits", []);
var minIntDigits = Clazz.superCall (this, jsjava.text.DecimalFormat, "getMinimumIntegerDigits", []);
var maxFraDigits = Clazz.superCall (this, jsjava.text.DecimalFormat, "getMaximumFractionDigits", []);
var minFraDigits = Clazz.superCall (this, jsjava.text.DecimalFormat, "getMinimumFractionDigits", []);
...
}}, $fz.isPrivate = true, $fz), "~N,StringBuffer,jsjava.text.Format.FieldDelegate");
Clazz.defineMethod (c$, "format", 
function (number, result, fieldPosition) {
fieldPosition.setBeginIndex (0);
fieldPosition.setEndIndex (0);
...
($fz = function (result, delegate, isNegative, isInteger, maxIntDigits, minIntDigits, maxFraDigits, minFraDigits) {
...
iFieldEnd = result.length ();
}delegate.formatted (0, jsjava.text.NumberFormat.Field.INTEGER, jsjava.text.NumberFormat.Field.INTEGER, iFieldStart, iFieldEnd, result);
if (addedDecimalSeparator) {
delegate.formatted (jsjava.text.NumberFormat.Field.DECIMAL_SEPARATOR, jsjava.text.NumberFormat.Field.DECIMAL_SEPARATOR, iFieldEnd, fFieldStart, result);
}if (fFieldStart == -1) {
fFieldStart = result.length ();
}delegate.formatted (1, jsjava.text.NumberFormat.Field.FRACTION, jsjava.text.NumberFormat.Field.FRACTION, fFieldStart, result.length (), result);
var fieldStart = result.length ();
result.append (this.symbols.getExponentSeparator ());
delegate.formatted (jsjava.text.NumberFormat.Field.EXPONENT_SYMBOL, jsjava.text.NumberFormat.Field.EXPONENT_SYMBOL, fieldStart, result.length (), result);
if (this.digitList.isZero ()) {
exponent = 0;
...
delegate.formatted (jsjava.text.NumberFormat.Field.EXPONENT_SIGN, jsjava.text.NumberFormat.Field.EXPONENT_SIGN, fieldStart, result.length (), result);
...
delegate.formatted (jsjava.text.NumberFormat.Field.EXPONENT, jsjava.text.NumberFormat.Field.EXPONENT, eFieldStart, result.length (), result);
} else {
var iFieldStart = result.length ();
...
delegate.formatted (jsjava.text.NumberFormat.Field.GROUPING_SEPARATOR, jsjava.text.NumberFormat.Field.GROUPING_SEPARATOR, gStart, result.length (), result);
}}
...
delegate.formatted (jsjava.text.NumberFormat.Field.DECIMAL_SEPARATOR, jsjava.text.NumberFormat.Field.DECIMAL_SEPARATOR, sStart, result.length (), result);
...
}, $fz.isPrivate = true, $fz), "StringBuffer,jsjava.text.Format.FieldDelegate,~B,~B,~N,~N,~N,~N");
Clazz.defineMethod (c$, "append", 
($fz = function (result, string, delegate, positions, signAttribute) {
...
if (attribute === jsjava.text.NumberFormat.Field.SIGN) {
attribute = signAttribute;
}delegate.formatted (attribute, attribute, start + fp.getBeginIndex (), start + fp.getEndIndex (), result);
}
}}, $fz.isPrivate = true, $fz), "StringBuffer,~S,jsjava.text.Format.FieldDelegate,~A,jsjava.text.Format.Field");
...
($fz = function (text, parsePosition, positivePrefix, negativePrefix, digits, isExponent, status) {
...
var pos =  new jsjava.text.ParsePosition (position + exponentString.length);
var stat =  Clazz.newBooleanArray (2, false);
var exponentDigits =  new jsjava.text.DigitList ();
...
}, $fz.isPrivate = true, $fz), "~S,jsjava.text.ParsePosition,~S,~S,jsjava.text.DigitList,~B,~A");
...
}, "jsjava.text.DecimalFormatSymbols");
...
this.positivePrefixFieldPositions = jsjava.text.DecimalFormat.EmptyFieldPositionArray;
...
this.negativePrefixFieldPositions = jsjava.text.DecimalFormat.EmptyFieldPositionArray;
...
this.positiveSuffixFieldPositions = jsjava.text.DecimalFormat.EmptyFieldPositionArray;
...
this.negativeSuffixFieldPositions = jsjava.text.DecimalFormat.EmptyFieldPositionArray;
...
function () {
try {
var other = Clazz.superCall (this, jsjava.text.DecimalFormat, "clone", []);
...
if (!Clazz.superCall (this, jsjava.text.DecimalFormat, "equals", [obj])) return false;
var other = obj;
...
function () {
return Clazz.superCall (this, jsjava.text.DecimalFormat, "hashCode", []) * 37 + this.positivePrefix.hashCode ();
});
...
}var fp =  new jsjava.text.FieldPosition (jsjava.text.NumberFormat.Field.CURRENCY);
...
c = this.symbols.getPercent ();
field = -1;
fieldID = jsjava.text.NumberFormat.Field.PERCENT;
break;
case '\u2030':
c = this.symbols.getPerMill ();
field = -1;
fieldID = jsjava.text.NumberFormat.Field.PERMILLE;
break;
case '-':
c = this.symbols.getMinusSign ();
field = -1;
fieldID = jsjava.text.NumberFormat.Field.SIGN;
break;
}
if (fieldID != null) {
if (positions == null) {
positions =  new java.util.ArrayList (2);
}var fp =  new jsjava.text.FieldPosition (fieldID, field);
fp.setBeginIndex (stringIndex);
...
if (positions != null) {
return positions.toArray (jsjava.text.DecimalFormat.EmptyFieldPositionArray);
}return jsjava.text.DecimalFormat.EmptyFieldPositionArray;
}, $fz.isPrivate = true, $fz), "~S");
Clazz.defineMethod (c$, "appendAffix", 
($fz = function (buffer, affixPattern, expAffix, localized) {
...
}}, $fz.isPrivate = true, $fz), "StringBuffer,~S,~S,~B");
Clazz.defineMethod (c$, "appendAffix", 
($fz = function (buffer, affix, localized) {
var needQuote;
if (localized) {
...
}, $fz.isPrivate = true, $fz), "StringBuffer,~S,~B");
Clazz.defineMethod (c$, "toPattern", 
($fz = function (localized) {
...
Clazz.superCall (this, jsjava.text.DecimalFormat, "setMaximumIntegerDigits", [(this.$maximumIntegerDigits > 309) ? 309 : this.$maximumIntegerDigits]);
if (this.$minimumIntegerDigits > this.$maximumIntegerDigits) {
this.$minimumIntegerDigits = this.$maximumIntegerDigits;
Clazz.superCall (this, jsjava.text.DecimalFormat, "setMinimumIntegerDigits", [(this.$minimumIntegerDigits > 309) ? 309 : this.$minimumIntegerDigits]);
}}, "~N");
...
Clazz.superCall (this, jsjava.text.DecimalFormat, "setMaximumFractionDigits", [(this.$maximumFractionDigits > 340) ? 340 : this.$maximumFractionDigits]);
if (this.$minimumFractionDigits > this.$maximumFractionDigits) {
this.$minimumFractionDigits = this.$maximumFractionDigits;
Clazz.superCall (this, jsjava.text.DecimalFormat, "setMinimumFractionDigits", [(this.$minimumFractionDigits > 340) ? 340 : this.$minimumFractionDigits]);
}}, "~N");
...
Clazz.overrideMethod (c$, "getCurrency", 
function () {
return this.symbols.getCurrency ();
});
Clazz.overrideMethod (c$, "setCurrency", 
function (currency) {
...
function () {
var currency = this.symbols.getCurrency ();
if (currency == null) {
try {
currency = java.util.Currency.getInstance (this.symbols.getInternationalCurrencySymbol ());
} catch (e) {
