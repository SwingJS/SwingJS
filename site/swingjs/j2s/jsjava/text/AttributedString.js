...
Clazz.load (["java.util.AbstractMap", "$.Map", "jsjava.text.AttributedCharacterIterator"], ["jsjava.text.AttributedString", "$.AttributeEntry"], ["java.lang.IllegalArgumentException", "$.InternalError", "$.NullPointerException", "$.StringBuffer", "$.UnsupportedOperationException", "java.util.HashSet", "$.Hashtable", "$.Vector", "jsjava.text.Annotation"], function () {
...
if (!Clazz.isClassDefined ("jsjava.text.AttributedString.AttributedStringIterator")) {
jsjava.text.AttributedString.$AttributedString$AttributedStringIterator$ ();
}
if (!Clazz.isClassDefined ("jsjava.text.AttributedString.AttributeMap")) {
jsjava.text.AttributedString.$AttributedString$AttributeMap$ ();
}
...
if (jsjava.text.AttributedString.mapsDiffer (last, attrs)) {
...
}, "jsjava.text.AttributedCharacterIterator");
Clazz.makeConstructor (c$, 
function (text, beginIndex, endIndex) {
this.construct (text, beginIndex, endIndex, null);
}, "jsjava.text.AttributedCharacterIterator,~N,~N");
Clazz.makeConstructor (c$, 
...
if (value != null) {
if (Clazz.instanceOf (value, jsjava.text.Annotation)) {
...
}, "jsjava.text.AttributedCharacterIterator,~N,~N,~A");
...
}, "jsjava.text.AttributedCharacterIterator.Attribute,~O");
Clazz.defineMethod (c$, "addAttribute", 
...
}, "jsjava.text.AttributedCharacterIterator.Attribute,~O,~N,~N");
...
($fz = function (attribute, value, beginIndex, endIndex) {
if (this.runCount == 0) {
this.createRunAttributeDataVectors ();
}var beginRunIndex = this.ensureRunBreak (beginIndex);
var endRunIndex = this.ensureRunBreak (endIndex);
this.addAttributeRunData (attribute, value, beginRunIndex, endRunIndex);
}, $fz.isPrivate = true, $fz), "jsjava.text.AttributedCharacterIterator.Attribute,~O,~N,~N");
...
($fz = function (attribute, value, beginRunIndex, endRunIndex) {
...
Clazz.defineMethod (c$, "getIterator", 
function (attributes, beginIndex, endIndex) {
return Clazz.innerTypeInstance (jsjava.text.AttributedString.AttributedStringIterator, this, null, attributes, beginIndex, endIndex);
}, "~A,~N,~N");
...
($fz = function (attribute, runIndex) {
...
return null;
}}, $fz.isPrivate = true, $fz), "jsjava.text.AttributedCharacterIterator.Attribute,~N");
Clazz.defineMethod (c$, "getAttributeCheckRange", 
($fz = function (attribute, runIndex, beginIndex, endIndex) {
var value = this.getAttribute (attribute, runIndex);
if (Clazz.instanceOf (value, jsjava.text.Annotation)) {
if (beginIndex > 0) {
var currIndex = runIndex;
var runStart = this.runStarts[currIndex];
while (runStart >= beginIndex && jsjava.text.AttributedString.valuesMatch (value, this.getAttribute (attribute, currIndex - 1))) {
currIndex--;
...
while (runLimit <= endIndex && jsjava.text.AttributedString.valuesMatch (value, this.getAttribute (attribute, currIndex + 1))) {
currIndex++;
...
}, $fz.isPrivate = true, $fz), "jsjava.text.AttributedCharacterIterator.Attribute,~N,~N,~N");
Clazz.defineMethod (c$, "attributeValuesMatch", 
($fz = function (attributes, runIndex1, runIndex2) {
var iterator = attributes.iterator ();
while (iterator.hasNext ()) {
var key = iterator.next ();
if (!jsjava.text.AttributedString.valuesMatch (this.getAttribute (key, runIndex1), this.getAttribute (key, runIndex2))) {
return false;
}}
return true;
}, $fz.isPrivate = true, $fz), "java.util.Set,~N,~N");
c$.valuesMatch = Clazz.defineMethod (c$, "valuesMatch", 
($fz = function (value1, value2) {
if (value1 == null) {
return value2 == null;
} else {
...
}, $fz.isPrivate = true, $fz), "StringBuffer,jsjava.text.CharacterIterator");
Clazz.defineMethod (c$, "setAttributes", 
($fz = function (attrs, offset) {
if (this.runCount == 0) {
this.createRunAttributeDataVectors ();
...
}}, $fz.isPrivate = true, $fz), "java.util.Map,~N");
c$.mapsDiffer = Clazz.defineMethod (c$, "mapsDiffer", 
($fz = function (last, attrs) {
if (last == null) {
return (attrs != null && attrs.size () > 0);
}return (!last.equals (attrs));
}, $fz.isPrivate = true, $fz), "java.util.Map,java.util.Map");
...
Clazz.instantialize (this, arguments);
}, jsjava.text.AttributedString, "AttributedStringIterator", null, jsjava.text.AttributedCharacterIterator);
Clazz.makeConstructor (c$, 
function (a, b, c) {
if (b < 0 || b > c || c > this.b$["jsjava.text.AttributedString"].length ()) {
throw  new IllegalArgumentException ("Invalid substring range");
}this.beginIndex = b;
this.endIndex = c;
this.currentIndex = b;
...
if (this === a) {
return true;
}if (!(Clazz.instanceOf (a, jsjava.text.AttributedString.AttributedStringIterator))) {
return false;
}var b = a;
if (this.b$["jsjava.text.AttributedString"] !== b.getString ()) return false;
if (this.currentIndex != b.currentIndex || this.beginIndex != b.beginIndex || this.endIndex != b.endIndex) return false;
return true;
}, "~O");
Clazz.overrideMethod (c$, "hashCode", 
function () {
return this.b$["jsjava.text.AttributedString"].text.hashCode () ^ this.currentIndex ^ this.beginIndex ^ this.endIndex;
});
Clazz.overrideMethod (c$, "clone", 
function () {
try {
var a = Clazz.superCall (this, jsjava.text.AttributedString.AttributedStringIterator, "clone", []);
return a;
} catch (e) {
...
return this.b$["jsjava.text.AttributedString"].charAt (this.currentIndex);
}});
...
while (c > this.beginIndex && jsjava.text.AttributedString.valuesMatch (b, this.b$["jsjava.text.AttributedString"].getAttribute (a, d - 1))) {
d--;
c = this.b$["jsjava.text.AttributedString"].runStarts[d];
}
...
while (b > this.beginIndex && this.b$["jsjava.text.AttributedString"].attributeValuesMatch (a, this.currentRunIndex, c - 1)) {
c--;
b = this.b$["jsjava.text.AttributedString"].runStarts[c];
}
...
var d = this.currentRunIndex;
while (c < this.endIndex && jsjava.text.AttributedString.valuesMatch (b, this.b$["jsjava.text.AttributedString"].getAttribute (a, d + 1))) {
d++;
c = d < this.b$["jsjava.text.AttributedString"].runCount - 1 ? this.b$["jsjava.text.AttributedString"].runStarts[d + 1] : this.endIndex;
}
if (c > this.endIndex) {
c = this.endIndex;
}return c;
...
var c = this.currentRunIndex;
while (b < this.endIndex && this.b$["jsjava.text.AttributedString"].attributeValuesMatch (a, this.currentRunIndex, c + 1)) {
c++;
b = c < this.b$["jsjava.text.AttributedString"].runCount - 1 ? this.b$["jsjava.text.AttributedString"].runStarts[c + 1] : this.endIndex;
}
if (b > this.endIndex) {
b = this.endIndex;
}return b;
...
function () {
if (this.b$["jsjava.text.AttributedString"].runAttributes == null || this.currentRunIndex == -1 || this.b$["jsjava.text.AttributedString"].runAttributes[this.currentRunIndex] == null) {
return  new java.util.Hashtable ();
}return Clazz.innerTypeInstance (jsjava.text.AttributedString.AttributeMap, this, null, this.currentRunIndex, this.beginIndex, this.endIndex);
});
Clazz.overrideMethod (c$, "getAllAttributeKeys", 
function () {
if (this.b$["jsjava.text.AttributedString"].runAttributes == null) {
return  new java.util.HashSet ();
}{
var a =  new java.util.HashSet ();
var b = 0;
while (b < this.b$["jsjava.text.AttributedString"].runCount) {
if (this.b$["jsjava.text.AttributedString"].runStarts[b] < this.endIndex && (b == this.b$["jsjava.text.AttributedString"].runCount - 1 || this.b$["jsjava.text.AttributedString"].runStarts[b + 1] > this.beginIndex)) {
var c = this.b$["jsjava.text.AttributedString"].runAttributes[b];
if (c != null) {
var d = c.size ();
while (d-- > 0) {
a.add (c.get (d));
...
if (b < 0) {
return null;
}return this.b$["jsjava.text.AttributedString"].getAttributeCheckRange (a, b, this.beginIndex, this.endIndex);
}, "jsjava.text.AttributedCharacterIterator.Attribute");
Clazz.defineMethod (c$, "getString", 
($fz = function () {
return this.b$["jsjava.text.AttributedString"];
}, $fz.isPrivate = true, $fz));
...
return this.b$["jsjava.text.AttributedString"].charAt (a);
}}, $fz.isPrivate = true, $fz), "~N");
...
{
var a = -1;
while (a < this.b$["jsjava.text.AttributedString"].runCount - 1 && this.b$["jsjava.text.AttributedString"].runStarts[a + 1] <= this.currentIndex) a++;

this.currentRunIndex = a;
if (a >= 0) {
this.currentRunStart = this.b$["jsjava.text.AttributedString"].runStarts[a];
if (this.currentRunStart < this.beginIndex) this.currentRunStart = this.beginIndex;
} else {
this.currentRunStart = this.beginIndex;
}if (a < this.b$["jsjava.text.AttributedString"].runCount - 1) {
this.currentRunLimit = this.b$["jsjava.text.AttributedString"].runStarts[a + 1];
...
this.endIndex = 0;
Clazz.instantialize (this, arguments);
}, jsjava.text.AttributedString, "AttributeMap", java.util.AbstractMap);
Clazz.makeConstructor (c$, 
function (a, b, c) {
Clazz.superConstructor (this, jsjava.text.AttributedString.AttributeMap, []);
this.runIndex = a;
this.beginIndex = b;
this.endIndex = c;
}, "~N,~N,~N");
...
var a =  new java.util.HashSet ();
{
var b = this.b$["jsjava.text.AttributedString"].runAttributes[this.runIndex].size ();
for (var c = 0; c < b; c++) {
var d = this.b$["jsjava.text.AttributedString"].runAttributes[this.runIndex].get (c);
var e = this.b$["jsjava.text.AttributedString"].runAttributeValues[this.runIndex].get (c);
if (Clazz.instanceOf (e, jsjava.text.Annotation)) {
e = this.b$["jsjava.text.AttributedString"].getAttributeCheckRange (d, this.runIndex, this.beginIndex, this.endIndex);
if (e == null) {
continue;
}}var f =  new jsjava.text.AttributeEntry (d, e);
a.add (f);
}
}return a;
});
...
function (a) {
return this.b$["jsjava.text.AttributedString"].getAttributeCheckRange (a, this.runIndex, this.beginIndex, this.endIndex);
}, "~O");
c$ = Clazz.p0p ();
};
...
this.value = null;
Clazz.instantialize (this, arguments);
}, jsjava.text, "AttributeEntry", null, java.util.Map.Entry);
Clazz.makeConstructor (c$, 
function (key, value) {
this.key = key;
this.value = value;
...
Clazz.overrideMethod (c$, "equals", 
function (o) {
if (!(Clazz.instanceOf (o, jsjava.text.AttributeEntry))) {
return false;
}var other = o;
