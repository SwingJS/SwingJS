...
Clazz.load (["java.util.zip.DeflaterOutputStream", "$.ZipConstants", "java.util.Hashtable", "java.util.zip.CRC32", "javajs.util.Lst"], "java.util.zip.ZipOutputStream", ["com.jcraft.jzlib.ZStream", "java.io.IOException", "java.lang.Boolean", "$.IllegalArgumentException", "$.IndexOutOfBoundsException", "$.Long", "java.util.zip.Deflater", "$.ZipException"], function () {
...
this.xentries =  new javajs.util.Lst ();
