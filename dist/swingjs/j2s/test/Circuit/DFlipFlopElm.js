...
Clazz.load (["test.Circuit.ChipElm"], "test.Circuit.DFlipFlopElm", ["java.awt.Checkbox", "test.Circuit.EditInfo"], function () {
c$ = Clazz.decorateAsClass (function () {
this.FLAG_RESET = 2;
this.FLAG_SET = 4;
Clazz.instantialize (this, arguments);
}, test.Circuit, "DFlipFlopElm", test.Circuit.ChipElm);
...
Clazz.superConstructor (this, test.Circuit.DFlipFlopElm, [xa, ya, xb, yb, f, st]);
...
this.pins[0] = Clazz.innerTypeInstance (test.Circuit.ChipElm.Pin, this, null, 0, 2, "D");
...
function () {
Clazz.superCall (this, test.Circuit.DFlipFlopElm, "reset", []);
this.volts[2] = 5;
...
return ei;
}return Clazz.superCall (this, test.Circuit.DFlipFlopElm, "getEditInfo", [n]);
}, "~N");
...
this.allocNodes ();
this.setPoints ();
}Clazz.superCall (this, test.Circuit.DFlipFlopElm, "setEditValue", [n, ei]);
