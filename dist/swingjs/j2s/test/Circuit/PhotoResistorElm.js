...
Clazz.load (["test.Circuit.CircuitElm"], "test.Circuit.PhotoResistorElm", ["java.awt.Label", "$.Point", "$.Scrollbar", "java.lang.Double", "test.Circuit.CirSim", "$.EditInfo"], function () {
...
}, test.Circuit, "PhotoResistorElm", test.Circuit.CircuitElm);
Clazz.makeConstructor (c$, 
function (xx, yy) {
Clazz.superConstructor (this, test.Circuit.PhotoResistorElm, [xx, yy]);
...
Clazz.superConstructor (this, test.Circuit.PhotoResistorElm, [xa, ya, xb, yb, f]);
...
function () {
return Clazz.superCall (this, test.Circuit.PhotoResistorElm, "dump", []) + " " + this.minresistance + " " + this.maxresistance;
});
Clazz.defineMethod (c$, "createSlider", 
function () {
test.Circuit.CirSim.main.add (this.label =  new java.awt.Label ("Light Level", 1));
var value = 50;
...
function () {
Clazz.superCall (this, test.Circuit.PhotoResistorElm, "setPoints", []);
this.calcLeads (32);
