...
Clazz.load (["test.Circuit.CircuitElm"], "test.Circuit.TriacElm", ["java.lang.Double", "test.Circuit.Diode", "$.EditInfo"], function () {
...
}, test.Circuit, "TriacElm", test.Circuit.CircuitElm);
Clazz.makeConstructor (c$, 
function (xx, yy) {
Clazz.superConstructor (this, test.Circuit.TriacElm, [xx, yy]);
this.setDefaults ();
this.setup ();
}, "~N,~N");
Clazz.makeConstructor (c$, 
function (xa, ya, xb, yb, f, st) {
Clazz.superConstructor (this, test.Circuit.TriacElm, [xa, ya, xb, yb, f]);
this.setDefaults ();
try {
...
function () {
return Clazz.superCall (this, test.Circuit.TriacElm, "dump", []) + " " + (this.volts[0] - this.volts[1]) + " " + (this.volts[0] - this.volts[2]) + " " + this.triggerI + " " + this.holdingI + " " + this.cresistance;
});
Clazz.defineMethod (c$, "setPoints", 
function () {
Clazz.superCall (this, test.Circuit.TriacElm, "setPoints", []);
var dir = 0;
