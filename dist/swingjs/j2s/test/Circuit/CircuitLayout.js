...
Clazz.load (["java.awt.LayoutManager"], "test.Circuit.CircuitLayout", ["java.awt.Choice", "$.Dimension", "$.Label", "$.Scrollbar"], function () {
c$ = Clazz.declareType (test.Circuit, "CircuitLayout", null, java.awt.LayoutManager);
...
var cw = Clazz.doubleToInt (targetw * 8 / 10);
