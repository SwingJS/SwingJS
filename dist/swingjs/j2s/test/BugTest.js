...
this.me = "me";
this.name = null;
if (!Clazz.isClassDefined ("test.BugTest.SubBaseClass")) {
test.BugTest.$BugTest$SubBaseClass$ ();
}
...
c$.test = Clazz.defineMethod (c$, "test", 
 function (value, prec) {
System.out.println (value + " prec=" + prec + " " + String.format ("%1." + prec + "f", [new Double (value)]) + " " + String.format ("%1." + prec + "g", [new Double (value)]) + " " + String.format ("%1." + prec + "e", [new Double (value)]) + " ");
}, "~N,~N");
c$.test2 = Clazz.defineMethod (c$, "test2", 
 function (d) {
for (var i = 0; i < 10; i++) test.BugTest.test (d, i);

}, "~N");
c$.$BugTest$SubBaseClass$ = function () {
Clazz.pu$h(self.c$);
c$ = Clazz.decorateAsClass (function () {
Clazz.prepareCallback (this, arguments);
Clazz.instantialize (this, arguments);
}, test.BugTest, "SubBaseClass");
c$ = Clazz.p0p ();
};
...
c$ = Clazz.p0p ();
{
var d = 1234.56789356789;
for (var i = -10; i < 10; i++) {
System.out.println ("----");
test.BugTest.test2 (d * Math.pow (10, i));
}
d = 1.5;
for (var i = -10; i < 10; i++) {
System.out.println ("----");
...
System.out.println ("{" + String.format ("%.3f", [new Float (36)]) + "}");
System.out.println ("----");
}});
