...
Clazz.load (["javax.swing.JApplet", "$.JComponent", "javax.swing.event.ChangeListener", "java.awt.GridLayout", "javax.swing.JPanel", "$.JSlider"], "test.ultrastudio.LissajousSimple", ["java.awt.BasicStroke", "$.BorderLayout", "$.Color", "$.Dimension", "java.awt.geom.Line2D", "javax.swing.BorderFactory"], function () {
c$ = Clazz.decorateAsClass (function () {
this.acceleration = 100;
if (!Clazz.isClassDefined ("test.ultrastudio.LissajousSimple.LisChart")) {
test.ultrastudio.LissajousSimple.$LissajousSimple$LisChart$ ();
}
if (!Clazz.isClassDefined ("test.ultrastudio.LissajousSimple.SigChart")) {
test.ultrastudio.LissajousSimple.$LissajousSimple$SigChart$ ();
}
this.fySlider = null;
this.fxSlider = null;
this.aySlider = null;
...
}, test.ultrastudio, "LissajousSimple", javax.swing.JApplet, javax.swing.event.ChangeListener);
...
function () {
Clazz.superConstructor (this, test.ultrastudio.LissajousSimple, []);
...
var lissajousChart = Clazz.innerTypeInstance (test.ultrastudio.LissajousSimple.LisChart, this, null);
lissajousChart.setBorder (javax.swing.BorderFactory.createLineBorder (java.awt.Color.BLACK));
var signalChart = Clazz.innerTypeInstance (test.ultrastudio.LissajousSimple.SigChart, this, null);
...
this.scale = 0;
Clazz.instantialize (this, arguments);
}, test.ultrastudio.LissajousSimple, "LisChart", javax.swing.JComponent);
...
f.x2 = this.g (this.b$["test.ultrastudio.LissajousSimple"].xx[0]);
f.y2 = this.g (this.b$["test.ultrastudio.LissajousSimple"].yy[0]);
for (var g = 1; g < this.b$["test.ultrastudio.LissajousSimple"].count; g++) {
f.x1 = f.x2;
f.y1 = f.y2;
f.x2 = this.g (this.b$["test.ultrastudio.LissajousSimple"].xx[g]);
f.y2 = this.g (this.b$["test.ultrastudio.LissajousSimple"].yy[g]);
b.draw (f);
}
}, "java.awt.Graphics");
...
this.sy = 0;
Clazz.instantialize (this, arguments);
}, test.ultrastudio.LissajousSimple, "SigChart", javax.swing.JComponent);
Clazz.overrideMethod (c$, "paint", 
function (a) {
var b = a;
var c = this.getWidth ();
...
var f = 100.0 * e * (this.b$["test.ultrastudio.LissajousSimple"].count) / 1000;
this.sx = c / f;
this.sy = d / 2.2;
b.setStroke ( new java.awt.BasicStroke (2));
b.setColor (java.awt.Color.RED);
this.paintSignal (b, this.b$["test.ultrastudio.LissajousSimple"].xx);
b.setColor (java.awt.Color.BLUE);
this.paintSignal (b, this.b$["test.ultrastudio.LissajousSimple"].yy);
}, "java.awt.Graphics");
Clazz.defineMethod (c$, "paintSignal", 
 function (a, b) {
var c =  new java.awt.geom.Line2D.Float ();
c.x2 = this.gx (this.b$["test.ultrastudio.LissajousSimple"].tt[0]);
c.y2 = this.gy (b[0]);
for (var d = 1; d < this.b$["test.ultrastudio.LissajousSimple"].count; d++) {
c.x1 = c.x2;
c.y1 = c.y2;
c.x2 = this.gx (this.b$["test.ultrastudio.LissajousSimple"].tt[d]);
c.y2 = this.gy (b[d]);
a.draw (c);
}
