...
Clazz.load (null, "sun.swing.ImageCache", ["java.util.LinkedList"], function () {
...
entry =  new sun.swing.ImageCache.Entry (config, w, h, args);
...
function () {
var a = Clazz.superCall (this, sun.swing.ImageCache.Entry, "toString", []) + "[ graphicsConfig=" + this.config + ", image=" + this.image + ", w=" + this.w + ", h=" + this.h;
if (this.args != null) {
