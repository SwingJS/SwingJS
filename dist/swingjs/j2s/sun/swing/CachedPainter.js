...
Clazz.load (["java.util.HashMap"], "sun.swing.CachedPainter", ["java.awt.image.BufferedImage", "$.VolatileImage", "sun.swing.ImageCache"], function () {
c$ = Clazz.declareType (sun.swing, "CachedPainter");
c$.getCache = Clazz.defineMethod (c$, "getCache", 
 function (key) {
{
var cache = sun.swing.CachedPainter.cacheMap.get (key);
if (cache == null) {
cache =  new sun.swing.ImageCache (1);
sun.swing.CachedPainter.cacheMap.put (key, cache);
}return cache;
}}, "~O");
Clazz.makeConstructor (c$, 
function (cacheCount) {
sun.swing.CachedPainter.getCache (this.getClass ()).setMaxCount (cacheCount);
}, "~N");
...
var cache = sun.swing.CachedPainter.getCache (key);
...
function () {
{
sun.swing.CachedPainter.getCache (this.getClass ()).flush ();
}});
