...
Clazz.load (["java.awt.LayoutManager2", "javax.swing.Spring", "java.util.HashMap", "JU.Lst"], "javax.swing.SpringLayout", ["java.util.Collections", "$.HashSet", "java.awt.Component", "$.Dimension", "javax.swing.JComponent", "javax.swing.Spring.HeightSpring", "$.SpringMap", "$.WidthSpring"], function () {
...
Clazz.prepareFields (c$, function () {
this.horizontalHistory =  new JU.Lst ();
this.verticalHistory =  new JU.Lst ();
});
Clazz.makeConstructor (c$, 
function () {
});
...
function () {
var a = [this.x, this.y, this.width, this.height, this.east, this.south, this.horizontalCenter, this.verticalCenter, this.baseline];
...
"WIDTH", "Width",
"HEIGHT", "Height");
c$.ALL_HORIZONTAL = c$.prototype.ALL_HORIZONTAL = ["West", "Width", "East", "HorizontalCenter"];
c$.ALL_VERTICAL = c$.prototype.ALL_VERTICAL = ["North", "Height", "South", "VerticalCenter", "Baseline"];
});
