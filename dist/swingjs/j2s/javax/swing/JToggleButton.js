...
Clazz.load (["javax.swing.AbstractButton", "$.DefaultButtonModel"], "javax.swing.JToggleButton", ["java.awt.EventQueue", "java.awt.event.ActionEvent", "$.InputEvent", "$.ItemEvent"], function () {
...
this.construct (text, icon, selected, "ToggleButtonUI");
}, "~S,javax.swing.Icon,~B");
Clazz.makeConstructor (c$, 
function (text, icon, selected, uid) {
