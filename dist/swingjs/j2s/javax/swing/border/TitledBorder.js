...
Clazz.load (["javax.swing.border.AbstractBorder", "java.awt.Point"], "javax.swing.border.TitledBorder", ["java.lang.IllegalArgumentException", "$.NullPointerException", "java.awt.Component", "$.Dimension", "$.Font", "$.Insets", "$.Rectangle", "javax.swing.JComponent", "$.UIManager", "sun.swing.SwingUtilities2"], function () {
...
var fm = sun.swing.SwingUtilities2.getFontMetrics (jc, g);
var fontHeight = fm.getHeight ();
var descent = fm.getDescent ();
var ascent = fm.getAscent ();
var diff;
var stringWidth = sun.swing.SwingUtilities2.stringWidth (jc, fm, this.getTitle ());
var insets;
if (border != null) {
...
sun.swing.SwingUtilities2.drawString (jc, g, this.getTitle (), this.textLoc.x, this.textLoc.y);
g.setFont (font);
g.setColor (color);
...
case 1:
case 6:
minSize.width = Math.max (sun.swing.SwingUtilities2.stringWidth (jc, fm, this.getTitle ()), minSize.width);
break;
case 3:
case 4:
case 2:
...
case 0:
default:
minSize.width += sun.swing.SwingUtilities2.stringWidth (jc, fm, this.getTitle ());
}
return minSize;
}, "java.awt.Component");
