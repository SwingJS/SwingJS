...
function (event) {
if (this.f$.dialog.isVisible () && event.getSource () === this && (event.getPropertyName ().equals ("value") || event.getPropertyName ().equals ("inputValue")) && event.getNewValue () != null && event.getNewValue () !== javax.swing.JOptionPane.UNINITIALIZED_VALUE) {
