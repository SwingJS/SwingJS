...
Clazz.load (["java.awt.event.ComponentAdapter", "javax.swing.JComponent"], "javax.swing.JViewport", ["java.lang.IllegalArgumentException", "java.applet.Applet", "java.awt.Container", "$.Dimension", "$.Point", "$.Rectangle", "$.Window", "javax.swing.CellRendererPane", "$.RepaintManager", "$.SwingUtilities", "$.ViewportLayout", "javax.swing.event.ChangeEvent", "$.ChangeListener"], function () {
...
function () {
return java.awt.Container.NULL_INSETS;
});
Clazz.defineMethod (c$, "getInsets", 
function (insets) {
