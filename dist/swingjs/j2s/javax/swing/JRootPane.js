...
Clazz.load (["java.awt.LayoutManager2", "javax.swing.AbstractAction", "$.JComponent"], "javax.swing.JRootPane", ["java.lang.IllegalArgumentException", "$.NullPointerException", "java.awt.BorderLayout", "$.Dimension", "$.IllegalComponentStateException", "javax.swing.JLayeredPane", "$.JPanel", "$.SwingUtilities", "sun.awt.AppContext"], function () {
...
p.frameViewer = this.frameViewer;
return p;
});
...
c.frameViewer = this.frameViewer;
return c;
});
...
function (v) {
this.frameViewer = this.layeredPane.frameViewer = this.contentPane.frameViewer = v;
if (this.glassPane != null) this.glassPane.frameViewer = v;
