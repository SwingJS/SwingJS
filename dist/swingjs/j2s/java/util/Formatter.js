...
Clazz.load (["java.io.Flushable", "java.util.regex.Pattern"], "java.util.Formatter", ["java.io.BufferedWriter", "$.Closeable", "$.OutputStreamWriter", "$.UnsupportedEncodingException", "java.lang.Boolean", "$.Byte", "$.Character", "$.Double", "$.Float", "$.Long", "$.Short", "$.StringBuilder", "java.util.ArrayList", "$.Date", "java.text.DateFormatSymbols", "$.DecimalFormatSymbols", "$.NumberFormat", "java.util.Calendar", "$.DuplicateFormatFlagsException", "$.FormatFlagsConversionMismatchException", "$.Formattable", "$.FormatterClosedException", "$.IllegalFormatCodePointException", "$.IllegalFormatConversionException", "$.IllegalFormatFlagsException", "$.IllegalFormatPrecisionException", "$.IllegalFormatWidthException", "$.Locale", "$.MissingFormatArgumentException", "$.MissingFormatWidthException", "$.UnknownFormatConversionException", "$.UnknownFormatFlagsException"], function () {
...
Clazz.makeConstructor (c$, 
function (os) {
this.init ( new java.io.BufferedWriter ( new java.io.OutputStreamWriter (os)), java.util.Locale.getDefault ());
...
Clazz.makeConstructor (c$, 
function (os, csn, l) {
this.init ( new java.io.BufferedWriter ( new java.io.OutputStreamWriter (os, csn)), l);
...
Clazz.defineMethod (c$, "printBoolean", 
 function (a) {
var b;
if (a != null) b = ((Clazz.instanceOf (a, Boolean)) ? (a).toString () : Boolean.toString (true));
 else b = Boolean.toString (false);
this.printS (b);
}, "~O");
...
var m = (b == 0.0) ? ['+', '0', '0'] : this.exponent (j, k);
var n = this.$width;
