...
Clazz.load (["java.awt.event.ItemListener", "$.MouseListener", "$.MouseMotionListener", "javax.swing.JApplet", "$.JPanel", "java.awt.Color", "$.Font", "$.Rectangle"], ["org.uwi.TSd3Controls", "$.TanSugd3S", "$.TSd3Canvas"], ["java.awt.BasicStroke", "$.BorderLayout", "$.FlowLayout", "$.Point", "java.lang.Double", "$.StringBuffer", "JU.DebugJS", "javax.swing.ButtonGroup", "$.JFrame", "$.JRadioButton"], function () {
c$ = Clazz.decorateAsClass (function () {
this.canvas = null;
this.controls = null;
Clazz.instantialize (this, arguments);
}, org.uwi, "TanSugd3S", javax.swing.JApplet);
Clazz.makeConstructor (c$, 
function () {
Clazz.superConstructor (this, org.uwi.TanSugd3S, []);
this.setName ("TanSugd3S");
});
Clazz.overrideMethod (c$, "init", 
function () {
this.setLayout ( new java.awt.BorderLayout ());
this.canvas =  new org.uwi.TSd3Canvas ();
this.canvas.setSize (850, 500);
var c = this.getContentPane ();
c.setSize (850, 500);
c.add (this.canvas, "Center");
c.add (this.controls =  new org.uwi.TSd3Controls (this.canvas), "North");
System.out.println ("Hello, world!");
});
Clazz.defineMethod (c$, "setSize", 
function (width, height) {
Clazz.superCall (this, org.uwi.TanSugd3S, "setSize", [width, height]);
this.validate ();
}, "~N,~N");
...
var tanabe =  new org.uwi.TanSugd3S ();
tanabe.init ();
tanabe.start ();
f.add ("Center", tanabe);
f.pack ();
...
x1 = Delta / Bp;
y1 = x1;
y2 = org.uwi.TanSugd3S.CalcF4T1g (x1);
y3 = org.uwi.TanSugd3S.CalcP4T1g (x1);
fE = org.uwi.TanSugd3S.CalcG2Eg (x1);
fT1 = org.uwi.TanSugd3S.CalcG2T1g (x1);
fT2 = org.uwi.TanSugd3S.CalcG2T2g (x1);
fA1 = org.uwi.TanSugd3S.CalcG2A1g (x1);
fT2b = org.uwi.TanSugd3S.CalcD2T2g (x1);
fT2H = org.uwi.TanSugd3S.CalcH2T2g (x1);
fEH = org.uwi.TanSugd3S.CalcH2Eg (x1);
fT1H = org.uwi.TanSugd3S.CalcH2T1g (x1);
...
for (x = 0; x <= 50; x++) {
y1 = x;
y2 = org.uwi.TanSugd3S.CalcF4T1g (x);
temp_ratio21 = y2 / y1;
...
this.outPRec = null;
Clazz.instantialize (this, arguments);
}, org.uwi, "TSd3Canvas", javax.swing.JPanel, [java.awt.event.MouseListener, java.awt.event.MouseMotionListener]);
...
Clazz.makeConstructor (c$, 
function () {
Clazz.superConstructor (this, org.uwi.TSd3Canvas, []);
this.setName ("TSd3Canvas");
...
if (this.end_x < 35) {
yDivisor = org.uwi.TanSugd3S.CalcD2T2g (this.end_x);
} else yDivisor = org.uwi.TanSugd3S.CalcP4T1g (this.end_x);
...
this.x1 = this.deltaB;
this.y1 = this.x1;
this.y2 = org.uwi.TanSugd3S.CalcF4T1g (this.x1);
this.y3 = org.uwi.TanSugd3S.CalcP4T1g (this.x1);
this.fE = org.uwi.TanSugd3S.CalcG2Eg (this.x1);
this.fT1 = org.uwi.TanSugd3S.CalcG2T1g (this.x1);
this.fT2 = org.uwi.TanSugd3S.CalcG2T2g (this.x1);
this.fA1 = org.uwi.TanSugd3S.CalcG2A1g (this.x1);
this.fT2b = org.uwi.TanSugd3S.CalcD2T2g (this.x1);
this.fT2H = org.uwi.TanSugd3S.CalcH2T2g (this.x1);
this.fEH = org.uwi.TanSugd3S.CalcH2Eg (this.x1);
this.fT1H = org.uwi.TanSugd3S.CalcH2T1g (this.x1);
...
this.bg5 = null;
Clazz.instantialize (this, arguments);
}, org.uwi, "TSd3Controls", javax.swing.JPanel, java.awt.event.ItemListener);
Clazz.makeConstructor (c$, 
function (canvas) {
Clazz.superConstructor (this, org.uwi.TSd3Controls, []);
this.setLayout ( new java.awt.FlowLayout ());
this.setName ("T3d3Controls");
this.canvas = canvas;
this.range = 0;
var bg =  new javax.swing.ButtonGroup ();
this.bg0 = this.addButton (bg, "0-50", true);
this.addButton (bg, "0-10", false);
this.addButton (bg, "10-20", false);
this.addButton (bg, "20-30", false);
this.addButton (bg, "30-40", false);
this.bg5 = this.addButton (bg, "40-50", false);
...
c.setFont ( new java.awt.Font ("Arial", 0, 10));
return c;
